...
import { S as StrategySettings } from './StrategySettings-BgCi-ILX.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-BGEofmPy.js';

const {toDisplayString:_toDisplayString$4,createTextVNode:_createTextVNode$4,resolveComponent:_resolveComponent$4,withCtx:_withCtx$4,openBlock:_openBlock$4,createBlock:_createBlock$4,createCommentVNode:_createCommentVNode$4,createElementVNode:_createElementVNode$4,createVNode:_createVNode$4,renderList:_renderList$3,Fragment:_Fragment$4,createElementBlock:_createElementBlock$4,normalizeClass:_normalizeClass$2,vShow:_vShow$1,withDirectives:_withDirectives$1,unref:_unref$2,mergeProps:_mergeProps$2} = await importShared('vue');
              ...
              (_openBlock$4(true), _createElementBlock$4(_Fragment$4, null, _renderList$3(filteredCatalog.value, (item) => {
                return (_openBlock$4(), _createBlock$4(_component_VCard, {
                  ...
                  default: _withCtx$4(() => [
                    ...
                    _createElementVNode$4("div", _hoisted_18$3, [
                      (item.poster)
...
const EpisodeNormalizer = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-71d68051"]]);
...
const _hoisted_80$1 = { class: "d-flex ga-1" };
const _hoisted_81$1 = { class: "min-w-0" };
const _hoisted_82$1 = { class: "font-weight-medium text-truncate" };
const _hoisted_83$1 = { class: "text-caption text-medium-emphasis text-truncate" };
const _hoisted_84$1 = { class: "text-caption" };
const _hoisted_85$1 = { key: 7 };
const _hoisted_86$1 = { key: 0 };
const _hoisted_87$1 = { class: "d-flex align-center flex-wrap ga-3 mb-4" };
const _hoisted_88 = {
  key: 0,
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$2(), _createElementBlock$2("div", null, [
      ...
      (props.mode === 'naming')
        ...
        : (props.mode === 'probe')
          ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_3$2, [...(_cache[101] || (_cache[101] = [
              ...
              _createElementVNode$2("div", { class: "text-body-2 text-medium-emphasis" }, "整理前读取真实媒体流，补齐技术参数并输出可用于命名的 Jinja2 变量。", -1)
            ]))]))
    ...
    _createVNode$2(_component_VAlert, {
      ...
      default: _withCtx$2(() => [
        _createTextVNode$2(_toDisplayString$2(props.mode === 'naming' ? '实际顺序：连接与分隔、制作组编排（在「字段与制作组」页维护）和自定义字段参与 MoviePilot 模板渲染；文本映射最后处理完整相对路径与字幕后缀。' : props.mode === 'probe' ? '扫描发生在命名渲染前，不修改源文件；标准字段可补空、覆盖或追加，probe_* 变量可直接用于命名模板。' : '这里展示当前 MP 实际加载的识别预设；插件覆盖不会修改 MP 或 Rust 文件。'), 1)
      ]),
      _: 1
    }),
    ...
    (props.mode !== 'naming' && section.value === 'rules')
      ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_6$2, [
          ...
          _createElementVNode$2("div", _hoisted_8$2, "当前 MP 共读取 " + _toDisplayString$2(data.value.recognition_rules?.count || 0) + " 条，已覆盖 " + _toDisplayString$2(data.value.recognition_rules?.override_count || 0) + " 条；筛选结果 " + _toDisplayString$2(rules.value.length) + " 条。", 1),
                  ...
                  return (_openBlock$2(), _createElementBlock$2("tr", {
                    ...
                    _createElementVNode$2("td", null, [
                      ...
                      (item.overridden && item.builtin && item.effective?.pattern !== item.pattern)
                        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_12$2, "MP 原正则：" + _toDisplayString$2(item.pattern), 1))
                        : _createCommentVNode$2("", true),
                      _createElementVNode$2("div", _hoisted_13$2, _toDisplayString$2(item.effective?.action === 'clear' ? '命中后清空字段' : `输出：${item.effective?.value ?? item.value}`), 1)
                    ]),
                    _createElementVNode$2("td", null, [
                      _createVNode$2(_component_VChip, {
                        size: "small",
      ...
      : (section.value === 'groups')
        ...
        : (props.mode === 'metadata' && section.value === 'arrange')
                                ...
                                ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_30$1, [
                                    (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(groupArrangementPreview.value.trace.members, (member, index) => {
                                      return (_openBlock$2(), _createBlock$2(_component_VChip, {
                                        ...
                                        default: _withCtx$2(() => [
                                          index
                                            ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_31$1, _toDisplayString$2(member.connector === ' ' ? '空格' : member.connector), 1))
                                            : _createCommentVNode$2("", true),
          ...
          : (props.mode === 'probe' && section.value === 'probe')
                              ...
                              _createElementVNode$2("div", _hoisted_34$1, [
                                (selectedProbeFieldItems.value.length)
                                  ...
                                  : (_openBlock$2(), _createElementBlock$2("div", _hoisted_36$1, [
                                      ...
                                      _cache[128] || (_cache[128] = _createTextVNode$2(" 尚未选择扫描项", -1))
                                    ]))
                              ]),
                                              ...
                                              default: _withCtx$2(() => [
                                                _createElementVNode$2("div", _hoisted_56$1, [
                                                  _createElementVNode$2("div", null, [
                                                    ...
                                                    _createElementVNode$2("div", _hoisted_57$1, _toDisplayString$2(probeDetectedContextItems.value.length) + " 个有值，可直接用于命名模板", 1)
                                                  ]),
                                                  _createVNode$2(_component_VChip, {
                                                    size: "x-small",
                                                    color: "secondary",
                                  ...
                                  _createElementVNode$2("div", _hoisted_72$1, [
                                    _createElementVNode$2("div", null, [
                                      ...
                                      _cache[168] || (_cache[168] = _createElementVNode$2("div", null, [
                                        _createElementVNode$2("strong", null, "路径映射"),
                                        _createElementVNode$2("span", null, "把 MP 整理路径转换成 Emby 中看到的路径")
                                      ], -1))
                                    ]),
                                    _createVNode$2(_component_VBtn, {
                                      size: "small",
                                    ...
                                    default: _withCtx$2(() => [
                                      (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(strmPreview.value.results || {}, (result, name) => {
                                        return (_openBlock$2(), _createElementBlock$2("div", { key: name }, [
                                          ...
                                          (result.mapped_path)
                                            ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_78$1, "（" + _toDisplayString$2(result.mapped_path) + "）", 1))
                                            : _createCommentVNode$2("", true)
                                        ]))
                                      }), 128)),
                                      (!Object.keys(strmPreview.value.results || {}).length)
                                        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_79$1, _toDisplayString$2(strmPreview.value.reason || '没有服务器结果'), 1))
                                        : _createCommentVNode$2("", true)
                                    ]),
                                    _: 1
                                  }, 8, ["type"]))
                                  ...
                                  (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(strmSync.value.jobs, (job) => {
                                    return (_openBlock$2(), _createElementBlock$2("div", {
                                      ...
                                      _createElementVNode$2("div", _hoisted_81$1, [
                                        _createElementVNode$2("div", _hoisted_82$1, _toDisplayString$2(job.title || job.target_path), 1),
                                        _createElementVNode$2("div", _hoisted_83$1, _toDisplayString$2(job.target_path), 1),
                                        _createElementVNode$2("div", _hoisted_84$1, _toDisplayString$2(job.reason) + " · 尝试 " + _toDisplayString$2(job.attempts || 0) + " 次", 1)
                                      ]),
                                      _createVNode$2(_component_VChip, {
                                        size: "small",
            ...
            : (props.mode === 'naming')
              ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_85$1, [
                  _createVNode$2(_component_VTabs, {
                  ...
                  (renameRuleSection.value === 'fields')
                    ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_86$1, [
                        _createElementVNode$2("div", _hoisted_87$1, [
                                        ...
                                        return (_openBlock$2(), _createElementBlock$2("div", {
                                          ...
                                          _createElementVNode$2("div", _hoisted_89, [
                                            ...
                                            (item.dependencies?.length)
                                              ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_93, "依赖：" + _toDisplayString$2(item.dependencies.join('、')), 1))
                                              : _createCommentVNode$2("", true)
                                          ]),
                                          _createVNode$2(_component_VBtn, {
                                  ...
                                  ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_96, [
                                      (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(renamePreview.value.values, (value, key) => {
                                        return (_openBlock$2(), _createElementBlock$2("div", {
                                          ...
                                          _createElementVNode$2("span", _hoisted_97, _toDisplayString$2(value || '（空）'), 1)
                                        ]))
                                      }), 128)),
                            ...
                            _createVNode$2(_component_VCardText, null, {
                              default: _withCtx$2(() => [
                                                ...
                                                (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(group.items, (item) => {
                                                  return (_openBlock$2(), _createElementBlock$2("div", {
                                                    ...
                                                    _createElementVNode$2("div", _hoisted_104, [
                                                      ...
                                                      _createElementVNode$2("span", _hoisted_105, _toDisplayString$2(item.values || '按上下文决定'), 1)
                                                    ]),
                                                    _createElementVNode$2("div", {
                                ...
                                (!renameFieldGroups.value.length)
                                  ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_107, "没有匹配的字段"))
                                  : _createCommentVNode$2("", true)
                              ]),
                              _: 1
                            })
                                      ...
                                      _createVNode$2(_component_VCardText, { class: "d-flex align-start ga-3" }, {
                                        default: _withCtx$2(() => [
                                          ...
                                          _createElementVNode$2("div", _hoisted_113, [
                                            ...
                                            _createElementVNode$2("div", _hoisted_117, "优先级 " + _toDisplayString$2(item.priority), 1)
                                          ]),
                                          _createVNode$2(_component_VBtn, {
                                            icon: "mdi-pencil-outline",
                                            size: "small",
                                  ...
                                  (mappingPreview.value)
                                    ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                                        ...
                                        default: _withCtx$2(() => [
                                          ...
                                          _createElementVNode$2("div", _hoisted_120, "命中 " + _toDisplayString$2(mappingPreview.value.changes?.length || 0) + " 条规则", 1)
                                        ]),
                                        _: 1
                                      }, 8, ["type"]))
                                    : _createCommentVNode$2("", true)
                  ...
                  default: _withCtx$2(() => [
                    ...
                    _createVNode$2(_component_VAlert, {
                      ...
                      default: _withCtx$2(() => [
                        ...
                        _createElementVNode$2("div", _hoisted_127, _toDisplayString$2(fieldDetail.value.template_usage_detail || '可直接复制下方变量写入 MoviePilot 命名模板。'), 1)
                      ]),
                      _: 1
                    }, 8, ["type"]),
                                ...
                                _createVNode$2(_component_VExpansionPanelTitle, null, {
                                  default: _withCtx$2(() => [
                                    _createElementVNode$2("div", null, [
                                      ...
                                      _createElementVNode$2("div", _hoisted_133, _toDisplayString$2(fieldDetailPresetRules.value.length) + " 条；展示当前实例实际生效的内置词、正则和插件覆盖", 1)
                                    ])
                                  ]),
                                  _: 1
                                }),
                                                ...
                                                _createElementVNode$2("td", null, [
                                                  _createVNode$2(_component_VChip, {
                                                    ...
                                                    default: _withCtx$2(() => [
                                                      ...
                                                      (rule.overridden)
                                                        ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_135, " · 已覆盖"))
                                                        : _createCommentVNode$2("", true)
                                                    ]),
                                                    _: 2
                                                  }, 1032, ["color"])
...
const MetadataTools = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-135e01b0"]]);
...
const PerformanceDiagnostics = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-99a75b80"]]);
...
const _hoisted_70 = { class: "d-flex align-center flex-wrap ga-2 mb-4" };
const _hoisted_71 = {
  key: 0,
  class: "history-list"
};
const _hoisted_72 = { class: "d-flex align-start ga-3" };
const _hoisted_73 = { class: "flex-grow-1" };
const _hoisted_74 = { class: "d-flex flex-wrap align-center ga-2" };
const _hoisted_75 = { class: "font-weight-bold" };
const _hoisted_76 = ["title"];
const _hoisted_77 = { class: "text-caption text-medium-emphasis mt-1" };
const _hoisted_78 = {
  key: 1,
...
const _hoisted_81 = { class: "d-flex flex-wrap ga-1 mt-2" };
const _hoisted_82 = {
  key: 1,
  class: "empty-preview"
};
const _hoisted_83 = { class: "text-h6 mt-3" };
const _hoisted_84 = {
  key: 7,
  class: "workspace-panel"
};
const _hoisted_85 = { class: "tab-content" };
const _hoisted_86 = { class: "workspace-panel" };
const _hoisted_87 = { class: "tab-content" };
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_16, [
                                _cache[46] || (_cache[46] = _createElementVNode("span", null, "MP 识别顺序", -1)),
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_19, [
                                _cache[54] || (_cache[54] = _createElementVNode("span", null, "内置规则目录", -1)),
                                _createElementVNode("strong", null, _toDisplayString(modules.value.recognition_rules?.catalog_rules || 0) + " 条", 1)
                              ]),
                              _createElementVNode("div", _hoisted_20, [
                                _cache[55] || (_cache[55] = _createElementVNode("span", null, "已启用覆盖", -1)),
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_21, [
                                _cache[57] || (_cache[57] = _createElementVNode("span", null, "扫描字段", -1)),
                                _createElementVNode("strong", null, _toDisplayString(config.value.media_probe_fields?.length || 0) + " 项", 1)
                              ]),
                              _cache[59] || (_cache[59] = _createElementVNode("div", { class: "status-line" }, [
                                _createElementVNode("span", null, "作用阶段"),
                                _createElementVNode("strong", null, "整理前 / 命名渲染前")
                              ], -1)),
                              _createElementVNode("div", _hoisted_22, [
                                _cache[58] || (_cache[58] = _createElementVNode("span", null, "神医 Pro 联动", -1)),
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_23, [
                                _cache[61] || (_cache[61] = _createElementVNode("span", null, "独立字段", -1)),
                                _createElementVNode("strong", null, _toDisplayString(modules.value.rename_fields?.field_count || 0) + " 个", 1)
                              ]),
                              _cache[62] || (_cache[62] = _createElementVNode("div", { class: "status-line" }, [
                                _createElementVNode("span", null, "作用阶段"),
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_24, [
                                _cache[64] || (_cache[64] = _createElementVNode("span", null, "结构化与文本规则", -1)),
                                _createElementVNode("strong", null, _toDisplayString(modules.value.rename_mapping?.rule_count || 0) + " 条", 1)
                              ]),
                              _cache[65] || (_cache[65] = _createElementVNode("div", { class: "status-line" }, [
                                    ...
                                    _createVNode(_component_VRow, {
                                      ...
                                      default: _withCtx(() => [
                                        _createVNode(_component_VCol, { cols: "6" }, {
                                          default: _withCtx(() => [
                                            _cache[71] || (_cache[71] = _createElementVNode("div", { class: "field-label" }, "年份提示", -1)),
                                        ...
                                        _createVNode(_component_VCol, { cols: "6" }, {
                                          default: _withCtx(() => [
                                            _cache[72] || (_cache[72] = _createElementVNode("div", { class: "field-label" }, "类型提示", -1)),
                                        ...
                                        _createVNode(_component_VCol, { cols: "6" }, {
                                          default: _withCtx(() => [
                                            _cache[73] || (_cache[73] = _createElementVNode("div", { class: "field-label" }, "季提示", -1)),
                                            _createVNode(_component_VTextField, {
                                        ...
                                        _createVNode(_component_VCol, { cols: "6" }, {
                                          default: _withCtx(() => [
                                            _cache[74] || (_cache[74] = _createElementVNode("div", { class: "field-label" }, "集提示", -1)),
                                            _createVNode(_component_VTextField, {
                                                ...
                                                _createVNode(_component_VCardText, null, {
                                                  default: _withCtx(() => [
                                                    _createElementVNode("div", _hoisted_37, [
                                                      ...
                                                      _cache[77] || (_cache[77] = _createElementVNode("strong", null, "最终命名", -1)),
                                                      _createVNode(_component_VChip, {
                                                        size: "x-small",
                                                        variant: "tonal"
                                                      }, {
                                                      ...
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            ...
                                                            (preview.value.release_group_preference.removed_count)
                                                              ? (_openBlock(), _createElementBlock("span", _hoisted_51, "；排除 " + _toDisplayString(preview.value.release_group_preference.removed_count) + " 个题材冲突候选", 1))
                                                              : (_openBlock(), _createElementBlock("span", _hoisted_52, "；本次没有发现明确冲突候选"))
                                                          ]),
                                                          _: 1
                                                        }))
                                                      : _createCommentVNode("", true),
                                                      ...
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            ...
                                                            (preview.value.candidate_sources.shared.tmdb_id)
                                                              ? (_openBlock(), _createElementBlock("span", _hoisted_53, " · TMDB " + _toDisplayString(preview.value.candidate_sources.shared.tmdb_id), 1))
                                                              : _createCommentVNode("", true)
                                                          ]),
                                                          _: 1
                                                        }, 8, ["type"]))
                                                              ...
                                                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(preview.value.candidates, (candidate) => {
                                                                return (_openBlock(), _createElementBlock("tr", {
                                                                  ...
                                                                  _createElementVNode("td", _hoisted_56, [
                                                                    ...
                                                                    (candidate.eligible_rank != null && candidate.tmdb_rank != null && candidate.eligible_rank !== candidate.tmdb_rank)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_59, "原始第 " + _toDisplayString(candidate.tmdb_rank + 1) + " 名 · 过滤后有效第 " + _toDisplayString(candidate.eligible_rank + 1) + " 名", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.release_group_evidence?.component !== null)
                                                                      ...
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.season_coordinate_evidence?.checked)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_61, [
                                                                          _createTextVNode("季集校验：" + _toDisplayString(candidate.season_coordinate_evidence.reason), 1),
                                                                          (candidate.season_coordinate_evidence.matched_group_name)
                                                                            ? (_openBlock(), _createElementBlock("span", _hoisted_62, " · " + _toDisplayString(candidate.season_coordinate_evidence.matched_group_name), 1))
                                                                            : _createCommentVNode("", true)
                                                                        ]))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.seasonal_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_63, "季度目录 " + _toDisplayString(candidate.seasonal_evidence.quarter) + "：" + _toDisplayString(candidate.seasonal_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.memory_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_64, "近期命中 " + _toDisplayString(candidate.memory_evidence.hits) + " 次：" + _toDisplayString(candidate.memory_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.preferred_by_policy)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_65, "命中 TMDB 优先名单"))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.suppressed_by_exclusion)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_66, "已被 TMDB 排除名单剔除"))
                                                                      : _createCommentVNode("", true)
                                                                  ]),
                                                                  _createElementVNode("td", null, [
                                                                    _createVNode(_component_VChip, {
              ...
              ? (_openBlock(), _createElementBlock("section", _hoisted_68, [
                  _createElementVNode("div", _hoisted_69, [
                    _createElementVNode("div", _hoisted_70, [
                      _cache[89] || (_cache[89] = _createElementVNode("div", { class: "flex-grow-1" }, [
                    ...
                    (filteredHistory.value.length)
                                      ...
                                      _createElementVNode("div", _hoisted_72, [
                                        _createElementVNode("div", _hoisted_73, [
                                          _createElementVNode("div", _hoisted_74, [
                                            _createElementVNode("div", _hoisted_75, _toDisplayString(item.title), 1),
                                            _createVNode(_component_VChip, {
                                              size: "x-small",
                                              color: "primary",
                                              variant: "tonal"
                                          ...
                                          (item.original_title)
                                            ? (_openBlock(), _createElementBlock("div", {
                                              ...
                                              }, "原标题：" + _toDisplayString(item.original_title), 9, _hoisted_76))
                                            : _createCommentVNode("", true),
                                          _createElementVNode("div", _hoisted_77, _toDisplayString(item.created_at) + " · " + _toDisplayString(item.reason), 1),
                                          (!item.accepted && item.kind !== 'operation')
                                            ? (_openBlock(), _createElementBlock("div", _hoisted_78, "插件未接管本次候选选择，MoviePilot 仍会继续执行原生识别与整理；这不代表最终整理失败。"))
                                            : _createCommentVNode("", true),
                                          (item.episode_adjustment)
                                            ? (_openBlock(), _createElementBlock("div", _hoisted_79, [
                                                ...
                                                (item.episode_adjustment.season != null)
                                                  ? (_openBlock(), _createElementBlock("span", _hoisted_80, " · S" + _toDisplayString(item.episode_adjustment.season) + "E" + _toDisplayString(item.episode_adjustment.episode), 1))
                                                  : _createCommentVNode("", true)
                                              ]))
                                            : _createCommentVNode("", true),
                      ...
                      : (_openBlock(), _createElementBlock("div", _hoisted_82, [
                          ...
                          _createElementVNode("div", _hoisted_83, _toDisplayString(history.value.length ? '当前筛选没有日志' : '尚无模块日志'), 1)
                        ]))
                  ])
                ]))
              : _createCommentVNode("", true),
            (tab.value === 'diagnostics')
              ? (_openBlock(), _createElementBlock("section", _hoisted_84, [
              ...
              : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("section", _hoisted_86, [
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-bc9ee24b"]]);
