...
import { M as ModuleHeader, S as StrategySettings } from './StrategySettings-DO37eRgW.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-ycXrUbcn.js';

const {toDisplayString:_toDisplayString$5,createTextVNode:_createTextVNode$5,resolveComponent:_resolveComponent$5,withCtx:_withCtx$5,createVNode:_createVNode$5,openBlock:_openBlock$5,createBlock:_createBlock$5,createCommentVNode:_createCommentVNode$5,createElementVNode:_createElementVNode$5,renderList:_renderList$4,Fragment:_Fragment$5,createElementBlock:_createElementBlock$5,normalizeClass:_normalizeClass$3,vShow:_vShow$1,withDirectives:_withDirectives$1,unref:_unref$2,mergeProps:_mergeProps$3} = await importShared('vue');
                        ...
                        default: _withCtx$5(() => [
                          ...
                          (item.tmdb_match?.best)
                            ? (_openBlock$5(), _createElementBlock$5("div", {
                              ...
                              }, " TMDB " + _toDisplayString$5(item.tmdb_match.best.tmdb_id) + " · " + _toDisplayString$5(item.tmdb_match.best.name), 9, _hoisted_21$3))
                            : _createCommentVNode$5("", true)
                        ]),
                        _: 2
                      }, 1024),
...
const EpisodeNormalizer = /*#__PURE__*/_export_sfc(_sfc_main$5, [['__scopeId',"data-v-825f197a"]]);
...
const MetadataTools = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-2b9534e6"]]);
  ...
  return (_openBlock$1(), _createElementBlock$1("div", _hoisted_1$1, [
    ...
    _createElementVNode$1("section", _hoisted_10$1, [
      ...
      _createElementVNode$1("div", _hoisted_12$1, [
        _createVNode$1(_component_VSelect, {
          modelValue: config.value.notification_candidate_channel,
          "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((config.value.notification_candidate_channel) = $event)),
          items: data.value.notification_channels || [],
          label: "候选专用通知频道",
          placeholder: "请选择一个频道",
          density: "comfortable",
          variant: "outlined",
      ...
      _createVNode$1(_component_VAlert, {
        ...
        default: _withCtx$1(() => [...(_cache[37] || (_cache[37] = [
          _createTextVNode$1(" 专用频道只发送集数偏移候选。请先在 MoviePilot 通知设置中配置该频道，并允许接收“插件”类型通知。 ", -1)
        ]))]),
        _: 1
      }),
    ...
    _createElementVNode$1("section", _hoisted_26$1, [
      _createElementVNode$1("button", {
        ...
        _createElementVNode$1("span", null, [
          _cache[47] || (_cache[47] = _createElementVNode$1("strong", null, "通知运行记录", -1)),
          _createElementVNode$1("small", null, "共 " + _toDisplayString$1(data.value.record_counts?.total || 0) + " 条 · 已发送 " + _toDisplayString$1(data.value.record_counts?.notified || 0) + " · 静默 " + _toDisplayString$1(data.value.record_counts?.suppressed || 0) + " · 待摘要 " + _toDisplayString$1(data.value.record_counts?.digest || 0), 1)
        ]),
        _createVNode$1(_component_VIcon, {
            ...
            ? (_openBlock$1(), _createElementBlock$1("div", _hoisted_27$1, [
                ...
                (records.value.length)
                  ? (_openBlock$1(), _createElementBlock$1("div", _hoisted_29$1, [
                      (_openBlock$1(true), _createElementBlock$1(_Fragment$1, null, _renderList$1(records.value, (item) => {
                        return (_openBlock$1(), _createElementBlock$1("article", {
                          ...
                          _createElementVNode$1("div", null, [
                            _createElementVNode$1("strong", null, _toDisplayString$1(item.title), 1),
                            _createElementVNode$1("span", null, _toDisplayString$1(item.created_at) + " · " + _toDisplayString$1(item.category?.label || '入库成功') + " · " + _toDisplayString$1(item.action), 1)
                          ]),
                          _createVNode$1(_component_VChip, {
                            size: "x-small",
                            variant: "tonal"
                  ...
                  : (_openBlock$1(), _createElementBlock$1("div", _hoisted_30$1, [
                      ...
                      _cache[53] || (_cache[53] = _createElementVNode$1("span", null, "尚无符合条件的记录", -1))
                    ]))
              ]))
            : _createCommentVNode$1("", true)
        ]),
...
const NotificationEnhancer = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-20538f3e"]]);
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-923d81b6"]]);
