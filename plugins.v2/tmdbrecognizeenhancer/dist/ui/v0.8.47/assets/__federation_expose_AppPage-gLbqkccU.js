...
import { M as ModuleHeader, S as StrategySettings } from './StrategySettings-VT6c4_y4.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-BzgOx1r8.js';
    ...
    _withDirectives$1(_createElementVNode$1("section", _hoisted_17$1, [
      ...
      _createVNode$1(_component_VAlert, {
        ...
        default: _withCtx$1(() => [...(_cache[53] || (_cache[53] = [
          _createElementVNode$1("strong", null, "策略区别：", -1),
          _createTextVNode$1(" “立即通知”逐条外发；“进入摘要”先进入待摘要队列，点击运行记录中的“发送待处理摘要”后才合并外发； “静默记录”始终不外发，只在插件运行记录中留档。 ", -1)
        ]))]),
        _: 1
      }),
...
const NotificationEnhancer = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-3a98d435"]]);
