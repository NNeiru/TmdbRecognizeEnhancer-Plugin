...
import { S as StrategySettings } from './StrategySettings-D6-K5eIh.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-D_QYC4QY.js';
...
const _hoisted_64 = { class: "d-flex align-center flex-wrap ga-2 mb-4" };
const _hoisted_65 = {
  key: 0,
  class: "history-list"
};
const _hoisted_66 = { class: "d-flex align-start ga-3" };
const _hoisted_67 = { class: "flex-grow-1" };
const _hoisted_68 = { class: "d-flex flex-wrap align-center ga-2" };
const _hoisted_69 = { class: "font-weight-bold" };
const _hoisted_70 = ["title"];
const _hoisted_71 = { class: "text-caption text-medium-emphasis mt-1" };
const _hoisted_72 = {
  key: 1,
...
const _hoisted_75 = { class: "d-flex flex-wrap ga-1 mt-2" };
const _hoisted_76 = {
  key: 1,
  class: "empty-preview"
};
const _hoisted_77 = { class: "text-h6 mt-3" };
const _hoisted_78 = {
  key: 7,
  class: "workspace-panel"
};
const _hoisted_79 = { class: "tab-content" };
const _hoisted_80 = { class: "workspace-panel" };
        ...
        default: _withCtx(() => [
          ...
          _createElementVNode("div", _hoisted_7, [
                                                                ...
                                                                return (_openBlock(), _createElementBlock("tr", {
                                                                  ...
                                                                  _createElementVNode("td", _hoisted_53, [
                                                                    ...
                                                                    (candidate.seasonal_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_57, "季度目录 " + _toDisplayString(candidate.seasonal_evidence.quarter) + "：" + _toDisplayString(candidate.seasonal_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    ...
                                                                    (candidate.preferred_by_policy)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_59, "命中 TMDB 优先名单"))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.suppressed_by_exclusion)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_60, "已被 TMDB 排除名单剔除"))
                                                                      : _createCommentVNode("", true)
                                                                  ]),
                                                                  _createElementVNode("td", null, [
                                                                    _createVNode(_component_VChip, {
                  ...
                  _createElementVNode("div", _hoisted_63, [
                    ...
                    (filteredHistory.value.length)
                                      ...
                                      _createElementVNode("div", _hoisted_66, [
                                        _createElementVNode("div", _hoisted_67, [
                                          _createElementVNode("div", _hoisted_68, [
                                            _createElementVNode("div", _hoisted_69, _toDisplayString(item.title), 1),
                                            _createVNode(_component_VChip, {
                                              size: "x-small",
                                              color: "primary",
                                              variant: "tonal"
                                          ...
                                          (item.original_title)
                                            ? (_openBlock(), _createElementBlock("div", {
                                              ...
                                              }, "原标题：" + _toDisplayString(item.original_title), 9, _hoisted_70))
                                            : _createCommentVNode("", true),
                                          _createElementVNode("div", _hoisted_71, _toDisplayString(item.created_at) + " · " + _toDisplayString(item.reason), 1),
                                          (!item.accepted && item.kind !== 'operation')
                                            ? (_openBlock(), _createElementBlock("div", _hoisted_72, "插件未接管本次候选选择，MoviePilot 仍会继续执行原生识别与整理；这不代表最终整理失败。"))
                                            : _createCommentVNode("", true),
                                          (item.episode_adjustment)
                                            ? (_openBlock(), _createElementBlock("div", _hoisted_73, [
                                                ...
                                                (item.episode_adjustment.season != null)
                                                  ? (_openBlock(), _createElementBlock("span", _hoisted_74, " · S" + _toDisplayString(item.episode_adjustment.season) + "E" + _toDisplayString(item.episode_adjustment.episode), 1))
                                                  : _createCommentVNode("", true)
                                              ]))
                                            : _createCommentVNode("", true),
                      ...
                      : (_openBlock(), _createElementBlock("div", _hoisted_76, [
                          ...
                          _createElementVNode("div", _hoisted_77, _toDisplayString(history.value.length ? '当前筛选没有日志' : '尚无模块日志'), 1)
                        ]))
                  ])
                ]))
              : _createCommentVNode("", true),
            (tab.value === 'diagnostics')
              ...
              : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("section", _hoisted_80, [
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-6e9b6b64"]]);
