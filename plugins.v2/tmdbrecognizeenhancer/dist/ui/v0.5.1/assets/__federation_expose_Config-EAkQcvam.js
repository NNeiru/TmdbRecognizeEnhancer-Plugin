...
import { c as cloneConfig, u as unwrapResponse, e as ensureUiVersion } from './utils-LR8PKKYv.js';
    ...
    _createVNode(_component_VToolbar, {
      ...
      default: _withCtx(() => [
        ...
        _cache[3] || (_cache[3] = _createElementVNode("div", { class: "ms-3" }, [
          _createElementVNode("div", { class: "text-subtitle-1 font-weight-bold" }, "媒体整理增强"),
          _createElementVNode("div", { class: "text-caption text-medium-emphasis" }, "整理链与命名策略")
        ], -1)),
