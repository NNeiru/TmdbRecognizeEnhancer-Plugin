...
import { M as ModuleHeader, S as StrategySettings } from './StrategySettings-CpFZc9I3.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-DRN8wTj9.js';

const {toDisplayString:_toDisplayString$4,createTextVNode:_createTextVNode$4,resolveComponent:_resolveComponent$4,withCtx:_withCtx$4,createVNode:_createVNode$4,openBlock:_openBlock$4,createBlock:_createBlock$4,createCommentVNode:_createCommentVNode$4,createElementVNode:_createElementVNode$4,renderList:_renderList$3,Fragment:_Fragment$4,createElementBlock:_createElementBlock$4,normalizeClass:_normalizeClass$2,vShow:_vShow$1,withDirectives:_withDirectives$1,unref:_unref$2,mergeProps:_mergeProps$3} = await importShared('vue');
      ...
      default: _withCtx$4(() => [
        _createVNode$4(_component_VCardItem, null, {
          ...
          default: _withCtx$4(() => [
            ...
            _createVNode$4(_component_VCardSubtitle, null, {
              default: _withCtx$4(() => [
                _createTextVNode$4("AniList 日漫主目录 · 跨站 ID 优先映射 · 未命中再搜索 TMDB；当前仅显示 " + _toDisplayString$4(quarterKey.value), 1)
              ]),
              _: 1
            })
          ]),
                          ...
                          (!item.maintained && item.rule_eligible !== false)
                            ? (_openBlock$4(), _createBlock$4(_component_VMenu, { key: 0 }, {
                                activator: _withCtx$4(({ props: menuProps }) => [
                                  _createVNode$4(_component_VBtn, _mergeProps$3({ ref_for: true }, menuProps, {
                                    color: "primary",
                                    variant: "tonal",
...
const EpisodeNormalizer = /*#__PURE__*/_export_sfc(_sfc_main$4, [['__scopeId',"data-v-825f197a"]]);

const {resolveComponent:_resolveComponent$3,mergeProps:_mergeProps$2,createVNode:_createVNode$3,withCtx:_withCtx$3,openBlock:_openBlock$3,createBlock:_createBlock$3,createCommentVNode:_createCommentVNode$3,toDisplayString:_toDisplayString$3,createTextVNode:_createTextVNode$3,createElementVNode:_createElementVNode$3,Fragment:_Fragment$3,createElementBlock:_createElementBlock$3} = await importShared('vue');
    ...
    (__props.compact)
      ? (_openBlock$3(), _createBlock$3(_component_VTooltip, {
          ...
          activator: _withCtx$3(({ props: tip }) => [
            _createVNode$3(_component_VBtn, _mergeProps$2(tip, {
      ...
      : (_openBlock$3(), _createBlock$3(_component_VBtn, {
          ...
          default: _withCtx$3(() => [
            _createTextVNode$3(_toDisplayString$3(__props.buttonLabel), 1)
          ]),
          _: 1
        })),
            ...
            _createVNode$3(_component_VCardText, { class: "file-picker-body" }, {
              default: _withCtx$3(() => [
                ...
                _createElementVNode$3("div", _hoisted_2$3, [
                  _cache[7] || (_cache[7] = _createElementVNode$3("span", null, "已选择", -1)),
...
const MediaFilePicker = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-cf5745d2"]]);
...
const _hoisted_4$2 = { class: "rule-filter-actions" };
const _hoisted_5$2 = { class: "text-caption text-medium-emphasis mb-2" };
const _hoisted_6$2 = { class: "font-weight-medium" };
const _hoisted_7$2 = { class: "d-flex align-center ga-2" };
...
const _hoisted_17$2 = { class: "d-flex align-center flex-wrap ga-3 mb-4" };
const _hoisted_18$1 = {
  key: 1,
  class: "group-layout-grid"
};
const _hoisted_19$1 = { class: "group-layout-main" };
const _hoisted_20$1 = { class: "d-flex align-center flex-wrap ga-2" };
const _hoisted_21$1 = { class: "font-weight-bold" };
const _hoisted_22$1 = { class: "mapping-expression" };
const _hoisted_23$1 = { class: "text-caption text-medium-emphasis" };
const _hoisted_24$1 = { class: "d-flex" };
const _hoisted_25$1 = {
  key: 2,
  class: "empty-fields"
};
const _hoisted_26$1 = { class: "group-preview-form" };
const _hoisted_27$1 = { class: "text-caption mt-1" };
const _hoisted_28$1 = {
  key: 0,
  class: "member-trace mt-3"
};
const _hoisted_29$1 = { key: 0 };
const _hoisted_30$1 = { key: 6 };
const _hoisted_31$1 = {
  key: 0,
  class: "probe-workspace mb-4"
};
const _hoisted_32$1 = { class: "probe-selection-summary" };
const _hoisted_33$1 = { class: "probe-chip-policy" };
const _hoisted_34$1 = {
  key: 1,
  class: "probe-selection-empty"
};
const _hoisted_35$1 = { class: "probe-field-list" };
const _hoisted_36$1 = { class: "probe-field-main" };
const _hoisted_37$1 = { class: "font-weight-medium" };
const _hoisted_38$1 = { class: "text-caption text-medium-emphasis" };
const _hoisted_39$1 = { class: "probe-field-controls" };
const _hoisted_40$1 = { class: "subtitle-mapping-box" };
const _hoisted_41$1 = { class: "probe-advanced-grid" };
const _hoisted_42$1 = {
  key: 0,
  class: "mt-3"
};
const _hoisted_43$1 = { class: "font-weight-medium" };
const _hoisted_44$1 = { class: "subtitle-mapping-box iso-probe-box" };
const _hoisted_45$1 = {
  key: 0,
  class: "static-ffprobe-actions"
};
const _hoisted_46$1 = { class: "probe-card-actions" };
const _hoisted_47$1 = { class: "probe-path-row" };
const _hoisted_48$1 = { class: "probe-scan-bar" };
const _hoisted_49$1 = { class: "probe-result-header" };
...
const openStrmJobDetails = ref$2([]);
...
const bulkPriorityDialog = ref$2(false);
const bulkPriority = ref$2(100);
...
const activeStrmJobs = computed$2(() => (
  (strmSync.value.jobs || []).filter(job => job.status !== 'completed')
));
const completedStrmJobs = computed$2(() => (
  (strmSync.value.jobs || []).filter(job => job.status === 'completed')
));
  ...
  return (_openBlock$2(), _createElementBlock$2("div", null, [
    ...
    (props.mode !== 'naming' && section.value === 'rules')
      ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_2$2, [
          ...
          _createElementVNode$2("div", _hoisted_5$2, "当前 MP 共读取 " + _toDisplayString$2(data.value.recognition_rules?.count || 0) + " 条，已覆盖 " + _toDisplayString$2(data.value.recognition_rules?.override_count || 0) + " 条；筛选结果 " + _toDisplayString$2(rules.value.length) + " 条。", 1),
          _createVNode$2(_component_VTable, {
            density: "comfortable",
            class: "tools-table"
          }, {
            default: _withCtx$2(() => [
              _cache[113] || (_cache[113] = _createElementVNode$2("thead", null, [
                ...
                (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(pagedRules.value, (item) => {
                  return (_openBlock$2(), _createElementBlock$2("tr", {
                    ...
                    _createElementVNode$2("td", null, [
                      _createElementVNode$2("div", _hoisted_6$2, _toDisplayString$2(item.field_label), 1),
                    ...
                    _createElementVNode$2("td", null, [
                      ...
                      }, _toDisplayString$2(item.effective?.pattern || item.pattern), 9, _hoisted_8$2),
                      (item.overridden && item.builtin && item.effective?.pattern !== item.pattern)
                        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_9$2, "MP 原正则：" + _toDisplayString$2(item.pattern), 1))
                        : _createCommentVNode$2("", true),
                      _createElementVNode$2("div", _hoisted_10$2, _toDisplayString$2(item.effective?.action === 'clear' ? '命中后清空字段' : `输出：${item.effective?.value ?? item.value}`), 1)
                    ]),
                    _createElementVNode$2("td", null, [
                      _createVNode$2(_component_VChip, {
                        size: "small",
                      ...
                      (item.overridden)
                        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_11$2, "插件优先级 " + _toDisplayString$2(item.effective?.priority ?? 100), 1))
                        : _createCommentVNode$2("", true)
                    ]),
                    _createElementVNode$2("td", null, [
                      _createVNode$2(_component_VBtn, {
      ...
      : (section.value === 'groups')
        ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_12$2, [
            ...
            _createVNode$2(_component_VTable, {
              ...
              default: _withCtx$2(() => [
                _cache[114] || (_cache[114] = _createElementVNode$2("thead", null, [
                  _createElementVNode$2("tr", null, [
        ...
        : (props.mode === 'metadata' && section.value === 'arrange')
          ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_16$2, [
              ...
              (groupArrangementRules.value.length)
                ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_18$1, [
                            ...
                            default: _withCtx$2(() => [
                              _createElementVNode$2("div", _hoisted_19$1, [
                                _createElementVNode$2("div", _hoisted_20$1, [
                                  _createElementVNode$2("span", _hoisted_21$1, _toDisplayString$2(item.label || item.output_name), 1),
                                  _createVNode$2(_component_VChip, {
                                    size: "x-small",
                                    color: "primary",
                                    variant: "tonal"
                ...
                : (_openBlock$2(), _createElementBlock$2("div", _hoisted_25$1, [
                    ...
                    _cache[118] || (_cache[118] = _createElementVNode$2("div", { class: "mt-2" }, "尚未设置制作组编排", -1)),
                    _cache[119] || (_cache[119] = _createElementVNode$2("div", { class: "text-caption mt-1" }, "例如让 VCB-Studio 固定最后并使用 &，让 ADWeb 固定最后并使用 @", -1))
                  ])),
                        ...
                        ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                            ...
                            default: _withCtx$2(() => [
                              _createElementVNode$2("div", null, [
                                _cache[123] || (_cache[123] = _createTextVNode$2("输出：", -1)),
                                _createElementVNode$2("code", null, _toDisplayString$2(groupArrangementPreview.value.output), 1)
                              ]),
                              _createElementVNode$2("div", _hoisted_27$1, _toDisplayString$2(groupArrangementPreview.value.trace?.reason), 1),
                                ...
                                ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_28$1, [
                                    (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(groupArrangementPreview.value.trace.members, (member, index) => {
                                      return (_openBlock$2(), _createBlock$2(_component_VChip, {
                                        ...
                                        default: _withCtx$2(() => [
                                          index
                                            ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_29$1, _toDisplayString$2(member.connector === ' ' ? '空格' : member.connector), 1))
                                            : _createCommentVNode$2("", true),
          ...
          : (props.mode === 'probe' && section.value === 'probe')
            ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_30$1, [
                _createVNode$2(_component_VTabs, {
                  ...
                  default: _withCtx$2(() => [
                    ...
                    _createVNode$2(_component_VTab, {
                      ...
                      default: _withCtx$2(() => [
                        _cache[126] || (_cache[126] = _createTextVNode$2(" 神医联动 ", -1)),
                        _createVNode$2(_component_VChip, {
                          size: "x-small",
                          color: "primary",
                          variant: "tonal",
                            ...
                            default: _withCtx$2(() => [
                              (!mediaProbeBackendSupported.value)
                                ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                                    ...
                                    default: _withCtx$2(() => [
                                      _cache[130] || (_cache[130] = _createTextVNode$2(" 新版页面已加载，但插件后端仍是旧实例，因此字段目录显示为空且能力会被误报为 unavailable。 ", -1))
                                    ]),
                                    _: 1
                                  }))
                              ...
                              _createElementVNode$2("div", _hoisted_32$1, [
                                (selectedProbeFieldItems.value.length)
                                  ? (_openBlock$2(true), _createElementBlock$2(_Fragment$2, { key: 0 }, _renderList$2(selectedProbeFieldItems.value, (item) => {
                                      return (_openBlock$2(), _createBlock$2(_component_VChip, {
                                        ...
                                        default: _withCtx$2(() => [
                                          ...
                                          _createElementVNode$2("span", _hoisted_33$1, _toDisplayString$2(fieldPolicyItems.find(policy => policy.value === probeFieldPolicy(item.key))?.title), 1)
                                        ]),
                                        _: 2
                                      }, 1024))
                                    }), 128))
                                  : (_openBlock$2(), _createElementBlock$2("div", _hoisted_34$1, [
                                      ...
                                      _cache[131] || (_cache[131] = _createTextVNode$2(" 未选择命名输出项；神医联动仍会使用完整扫描结果", -1))
                                    ]))
                              ]),
                                            ...
                                            (_openBlock$2(), _createElementBlock$2(_Fragment$2, null, _renderList$2(mediaProbeFieldItems, (item) => {
                                              return _createElementVNode$2("div", {
                                                ...
                                                _createElementVNode$2("div", _hoisted_36$1, [
                                                  ...
                                                  _createElementVNode$2("div", _hoisted_38$1, _toDisplayString$2(item.detail), 1)
                                                ]),
                                          ...
                                          _createVNode$2(_component_VExpansionPanelText, null, {
                                            default: _withCtx$2(() => [
                                              _createElementVNode$2("div", _hoisted_40$1, [
                                                ...
                                                _cache[135] || (_cache[135] = _createElementVNode$2("div", { class: "text-caption text-medium-emphasis" }, "可扫描 MKV/MP4 中独立存在的内封字幕流；烧录进画面的硬字幕没有字幕轨，ffprobe 无法判断语言。", -1))
                                              ])
                                            ]),
                                            _: 1
                                          })
                                        ...
                                        default: _withCtx$2(() => [
                                          ...
                                          (mediaProbeBackendSupported.value && !data.value.media_probe?.available)
                                            ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_42$1, [
                                                _cache[138] || (_cache[138] = _createElementVNode$2("div", { class: "text-body-2 mb-2" }, [
                                                ...
                                                _cache[139] || (_cache[139] = _createElementVNode$2("ol", { class: "ffprobe-help" }, [
                                        ...
                                        default: _withCtx$2(() => [
                                          _createElementVNode$2("div", null, [
                                            _createElementVNode$2("div", _hoisted_43$1, [
                                              _cache[140] || (_cache[140] = _createTextVNode$2("ISO 原盘探测 ", -1)),
                                              _createVNode$2(_component_VChip, {
                                                size: "x-small",
                                            ...
                                            _cache[141] || (_cache[141] = _createElementVNode$2("div", { class: "text-caption text-medium-emphasis" }, "自动下载带蓝光支持的静态 ffprobe，仅接管 .iso 文件的媒体流提取", -1))
                                          ])
                                        ]),
                                        _: 1
                                      }),
                                        ...
                                        default: _withCtx$2(() => [
                                          _createElementVNode$2("div", _hoisted_44$1, [
                                            ...
                                            _createVNode$2(_component_VAlert, {
                                              ...
                                              default: _withCtx$2(() => [
                                                _cache[142] || (_cache[142] = _createTextVNode$2("容器自带的 ffprobe 没有 libbluray，读不出 ISO 原盘的播放列表。开启后插件从 ", -1)),
                                                _cache[143] || (_cache[143] = _createElementVNode$2("a", {
                                                ...
                                                _cache[144] || (_cache[144] = _createElementVNode$2("strong", null, "只用于 .iso 文件", -1)),
                                                _cache[145] || (_cache[145] = _createTextVNode$2("，普通视频仍走原 ffprobe；卸载插件删除数据目录即可清除。下载走 MP 的 GITHUB_PROXY 与代理设置。", -1))
                                              ]),
                                              _: 1
                                            }),
                              ...
                              _createElementVNode$2("div", _hoisted_46$1, [
                                _cache[147] || (_cache[147] = _createElementVNode$2("span", { class: "text-caption text-medium-emphasis" }, "设置只影响新进入整理流程的文件", -1)),
                                _createVNode$2(_component_VBtn, {
                                  color: "primary",
                                  variant: "tonal",
                                  "prepend-icon": "mdi-content-save",
                            ...
                            default: _withCtx$2(() => [
                              ...
                              (probeResult.value)
                                ? (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 1 }, [
                                    _createElementVNode$2("div", _hoisted_49$1, [
                                      _createElementVNode$2("div", _hoisted_50$1, [
                                        ...
                                        _createElementVNode$2("div", null, [
                                          _cache[151] || (_cache[151] = _createElementVNode$2("span", null, "扫描完成", -1)),
                                          _createElementVNode$2("strong", { title: probePath.value }, _toDisplayString$2(probeFileName.value), 9, _hoisted_51$1)
                                        ])
                                      ]),
                                    ...
                                    (probeStandardPreviewItems.value.length)
                                      ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_53$1, [
                                          _cache[153] || (_cache[153] = _createElementVNode$2("div", { class: "probe-section-heading" }, [
                                            _createElementVNode$2("div", null, [
                                            ...
                                            _createVNode$2(_component_VExpansionPanelTitle, null, {
                                              default: _withCtx$2(() => [
                                                _createElementVNode$2("div", _hoisted_55$1, [
                                                  _createElementVNode$2("div", null, [
                                                    _cache[154] || (_cache[154] = _createElementVNode$2("div", { class: "font-weight-medium" }, "Jinja2 扫描变量", -1)),
                                                    _createElementVNode$2("div", _hoisted_56$1, _toDisplayString$2(probeDetectedContextItems.value.length) + " 个有值，可直接用于命名模板", 1)
                                                  ]),
                                                  _createVNode$2(_component_VChip, {
                                                    size: "x-small",
                                                    color: "secondary",
                                              ...
                                              default: _withCtx$2(() => [
                                                (probeDetectedContextItems.value.length)
                                                  ...
                                                  : (_openBlock$2(), _createElementBlock$2("div", _hoisted_59$1, [
                                                      ...
                                                      _cache[156] || (_cache[156] = _createElementVNode$2("span", null, "该文件没有生成可用的扫描变量", -1))
                                                    ])),
                                ...
                                : (_openBlock$2(), _createElementBlock$2("div", _hoisted_61$1, [
                                    ...
                                    _cache[157] || (_cache[157] = _createElementVNode$2("strong", null, "等待选择媒体文件", -1)),
                                    _cache[158] || (_cache[158] = _createElementVNode$2("span", null, "扫描后将在这里展示写入字段、媒体流数量和 Jinja2 变量。", -1))
                                  ]))
                            ]),
                            _: 1
                          })
                        ...
                        default: _withCtx$2(() => [
                          _createVNode$2(_component_VCardItem, null, {
                            ...
                            default: _withCtx$2(() => [
                              _createVNode$2(_component_VCardTitle, { class: "text-subtitle-1" }, {
                                default: _withCtx$2(() => [
                                  _cache[160] || (_cache[160] = _createTextVNode$2("神医媒体信息联动 ", -1)),
                                  _createVNode$2(_component_VChip, {
                                    size: "x-small",
                                    color: "secondary",
                                    variant: "tonal",
                            ...
                            default: _withCtx$2(() => [
                              _createElementVNode$2("div", _hoisted_64$1, [
                                ...
                                _createElementVNode$2("div", _hoisted_65$1, [
                                  _createElementVNode$2("div", null, [
                                    _cache[162] || (_cache[162] = _createElementVNode$2("span", null, "等待", -1)),
                                    _createElementVNode$2("strong", null, _toDisplayString$2(strmSync.value.counts?.pending || 0), 1)
                                  ]),
                                  _createElementVNode$2("div", null, [
                                    _cache[163] || (_cache[163] = _createElementVNode$2("span", null, "完成", -1)),
                                    _createElementVNode$2("strong", null, _toDisplayString$2(strmSync.value.counts?.completed || 0), 1)
                                  ]),
                                  _createElementVNode$2("div", null, [
                                    _cache[164] || (_cache[164] = _createElementVNode$2("span", null, "需处理", -1)),
                              ...
                              _createVNode$2(_component_VAlert, {
                                ...
                                default: _withCtx$2(() => [
                                  (!config.value.media_probe_enabled)
                                    ...
                                    : (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 1 }, [
                                        _cache[165] || (_cache[165] = _createTextVNode$2("使用 StrmAssistant Pro 的 ", -1)),
                                        _cache[166] || (_cache[166] = _createElementVNode$2("code", null, "POST /Items/SyncMediaInfo", -1)),
                                        _cache[167] || (_cache[167] = _createTextVNode$2("；不生成 sidecar JSON，也不调用 ffmpeg。", -1))
                                      ], 64))
                                ]),
                                _: 1
                              }, 8, ["type"])
                          ...
                          _createVNode$2(_component_VCardText, { class: "strm-card-body" }, {
                            default: _withCtx$2(() => [
                              _createElementVNode$2("div", _hoisted_66$1, [
                                _createElementVNode$2("section", _hoisted_67$1, [
                                  _createElementVNode$2("div", _hoisted_68$1, [
                                    _createElementVNode$2("div", null, [
                                      ...
                                      _cache[170] || (_cache[170] = _createElementVNode$2("div", null, [
                                ...
                                _createElementVNode$2("section", _hoisted_70$1, [
                                  _createElementVNode$2("div", _hoisted_71$1, [
                                    _createElementVNode$2("div", null, [
                                      ...
                                      _cache[171] || (_cache[171] = _createElementVNode$2("div", null, [
                                        _createElementVNode$2("strong", null, "Emby 条目路径映射"),
                                        _createElementVNode$2("span", null, "右侧填写 Emby 条目的路径前缀；STRM 库使用 .strm 文件所在目录，不填写 .strm 内记录的真实媒体地址")
                                      ], -1))
                                    ]),
                                    _createVNode$2(_component_VBtn, {
                                      size: "small",
                                  ...
                                  (strmSync.value.config.path_mappings?.length)
                                    ...
                                    : (_openBlock$2(), _createElementBlock$2("div", _hoisted_75$1, [
                                        ...
                                        _cache[173] || (_cache[173] = _createElementVNode$2("span", null, "MP 与 Emby 路径相同时无需配置", -1))
                                      ]))
                                ])
                              ]),
                              _createElementVNode$2("div", _hoisted_76$1, [
                                _cache[175] || (_cache[175] = _createElementVNode$2("span", { class: "text-caption text-medium-emphasis" }, "启用状态、服务器、重试和路径映射会一起保存", -1)),
                                _createVNode$2(_component_VBtn, {
                                  color: "secondary",
                                  "prepend-icon": "mdi-content-save",
                          ...
                          _createVNode$2(_component_VCardText, { class: "strm-card-body" }, {
                            default: _withCtx$2(() => [
                              _createElementVNode$2("div", _hoisted_77$1, [
                                _createElementVNode$2("div", _hoisted_78$1, [
                                  _createElementVNode$2("div", _hoisted_79$1, [
                                    _createElementVNode$2("div", _hoisted_80$1, [
                                      ...
                                      _cache[178] || (_cache[178] = _createElementVNode$2("div", null, [
                                        _createElementVNode$2("strong", null, "源媒体文件"),
                                        _createElementVNode$2("span", null, "MP 容器内可以直接读取的真实文件")
                                      ], -1))
                                    ]),
                                  ...
                                  _createElementVNode$2("div", _hoisted_83$1, [
                                    _createElementVNode$2("div", _hoisted_84$1, [
                                      _createVNode$2(_component_VIcon, {
                                      ...
                                      _cache[179] || (_cache[179] = _createElementVNode$2("div", null, [
                                        _createElementVNode$2("strong", null, "整理后目标文件"),
                                        _createElementVNode$2("span", null, "MP 实际生成、并用于映射 Emby 条目的路径")
                                      ], -1))
                                    ]),
                                    _createElementVNode$2("div", _hoisted_85$1, [
                                      _createVNode$2(_component_VTextField, {
                                ...
                                _createElementVNode$2("div", _hoisted_86$1, [
                                  _createElementVNode$2("span", null, [
                                    _createVNode$2(_component_VIcon, {
                                      icon: "mdi-information-outline",
                                      size: "16"
                                    }),
                                    _cache[180] || (_cache[180] = _createTextVNode$2(" 将重新扫描源文件，并向匹配到的 Emby 条目真实写入媒体信息", -1))
                                  ]),
                                  _createVNode$2(_component_VBtn, {
                                    color: "secondary",
                              ...
                              (!probePath.value)
                                ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                                    ...
                                    default: _withCtx$2(() => [...(_cache[182] || (_cache[182] = [
                                      _createTextVNode$2("请输入或浏览选择 MP 容器内可读取的源文件。", -1)
                                    ]))]),
                                    _: 1
                                  }))
                                : _createCommentVNode$2("", true),
                              (strmSync.value.worker_error)
                                ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                                    ...
                                    default: _withCtx$2(() => [
                                      _createTextVNode$2("后台工作器最近一次异常：" + _toDisplayString$2(strmSync.value.worker_error) + "。刷新状态会自动尝试恢复。", 1)
                                    ]),
                                    _: 1
                                  }))
                                : _createCommentVNode$2("", true),
                                    ...
                                    default: _withCtx$2(() => [
                                      (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(strmPreview.value.results || {}, (result, name) => {
                                        return (_openBlock$2(), _createElementBlock$2("div", { key: name }, [
                                          ...
                                          (result.mapped_path)
                                            ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_87$1, "（" + _toDisplayString$2(result.mapped_path) + "）", 1))
                                            : _createCommentVNode$2("", true)
                                        ]))
                                      }), 128)),
                                      (!Object.keys(strmPreview.value.results || {}).length)
                                        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_88$1, _toDisplayString$2(strmPreview.value.reason || '没有服务器结果'), 1))
                                        : _createCommentVNode$2("", true)
                                    ]),
                                    _: 1
                                  }, 8, ["type"]))
                        ...
                        default: _withCtx$2(() => [
                          _createVNode$2(_component_VCardItem, null, {
                            ...
                            append: _withCtx$2(() => [
                              _createVNode$2(_component_VChip, {
                                ...
                                default: _withCtx$2(() => [
                                  _createTextVNode$2(_toDisplayString$2(strmSync.value.jobs?.length || 0) + " 条", 1)
                                ]),
                                _: 1
                              })
                            ]),
                            default: _withCtx$2(() => [
                              ...
                              _createVNode$2(_component_VCardSubtitle, null, {
                                default: _withCtx$2(() => [...(_cache[184] || (_cache[184] = [
                                  _createTextVNode$2("未结束任务优先展示；已完成记录默认折叠，最多保留 80 条。", -1)
                                ]))]),
                                _: 1
                              })
                            ]),
                          ...
                          (strmSync.value.jobs?.length)
                            ? (_openBlock$2(), _createBlock$2(_component_VCardText, {
                                ...
                                default: _withCtx$2(() => [
                                  _createElementVNode$2("div", _hoisted_89$1, [
                                    _createElementVNode$2("div", _hoisted_90$1, [
                                      (activeStrmJobs.value.length)
                                        ? (_openBlock$2(), _createBlock$2(_component_VChip, {
                                            ...
                                            default: _withCtx$2(() => [
                                              _createTextVNode$2(_toDisplayString$2(activeStrmJobs.value.length) + " 条待处理", 1)
                                            ]),
                                            _: 1
                                          }))
                                        : _createCommentVNode$2("", true),
                                      _createVNode$2(_component_VChip, {
                                        ...
                                        default: _withCtx$2(() => [
                                          _createTextVNode$2(_toDisplayString$2(completedStrmJobs.value.length) + " 条已完成", 1)
                                        ]),
                                        _: 1
                                      })
                                    ]),
                                    _createElementVNode$2("div", _hoisted_91$1, [
                                      _createVNode$2(_component_VBtn, {
                                        size: "small",
                                        variant: "text",
                                        "prepend-icon": "mdi-replay",
                                  ...
                                  (activeStrmJobs.value.length)
                                    ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_92$1, [
                                        _createElementVNode$2("div", _hoisted_93$1, [
                                          _createVNode$2(_component_VIcon, {
                                            icon: "mdi-progress-clock",
                                            size: "17",
                                            color: "warning"
                                          }),
                                          _cache[187] || (_cache[187] = _createElementVNode$2("span", null, "进行中与需要处理", -1))
                                        ]),
                                        _createElementVNode$2("div", _hoisted_94$1, [
                                          (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(activeStrmJobs.value, (job) => {
                                            return (_openBlock$2(), _createElementBlock$2("div", {
                                              key: job.id,
                                              class: "strm-job-row"
                                            }, [
                                              ...
                                              _createElementVNode$2("button", {
                                                ...
                                                _createElementVNode$2("strong", null, _toDisplayString$2(job.title || job.target_path), 1),
                                                _createElementVNode$2("span", null, _toDisplayString$2(strmJobSummary(job) || '等待后台处理'), 1)
                                              ], 8, _hoisted_95$1),
                                              _createVNode$2(_component_VChip, {
                                                size: "small",
                                                color: strmJobStatusPresentation(job.status).color,
                                                ...
                                                default: _withCtx$2(() => [
                                                  _createTextVNode$2(_toDisplayString$2(strmJobStatusPresentation(job.status).label), 1)
                                                ]),
                                                _: 2
                                              }, 1032, ["color"]),
                                              _createElementVNode$2("div", _hoisted_96$1, [
                                                _createVNode$2(_component_VBtn, {
                                              ...
                                              _createVNode$2(_component_VExpandTransition, null, {
                                                default: _withCtx$2(() => [
                                                  (strmJobDetailOpen(job.id))
                                                    ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_97$1, [
                                                        _createElementVNode$2("div", null, [
                                                          _cache[188] || (_cache[188] = _createElementVNode$2("span", null, "目标路径", -1)),
                                                          _createElementVNode$2("code", null, _toDisplayString$2(job.target_path || '未记录'), 1)
                                                        ]),
                                                        _createElementVNode$2("div", null, [
                                                          _cache[189] || (_cache[189] = _createElementVNode$2("span", null, "处理说明", -1)),
                                                          _createElementVNode$2("strong", null, _toDisplayString$2(strmJobSummary(job)), 1)
                                                        ]),
                                                        _createElementVNode$2("div", null, [
                                                          _cache[190] || (_cache[190] = _createElementVNode$2("span", null, "尝试次数", -1)),
                                                          _createElementVNode$2("strong", null, _toDisplayString$2(job.attempts || 0) + " 次", 1)
                                                        ]),
                                                        (strmServerResults(job).length)
                                                          ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_98$1, [
                                                              _cache[191] || (_cache[191] = _createElementVNode$2("span", null, "服务器结果", -1)),
                                                              (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(strmServerResults(job), (result) => {
                                                                return (_openBlock$2(), _createElementBlock$2("div", {
                                                                  key: result.name,
                                                                  ...
                                                                  _createElementVNode$2("div", null, [
                                                                    _createElementVNode$2("div", null, [
                                                                      _createElementVNode$2("strong", null, _toDisplayString$2(result.name), 1),
                                                                      _createVNode$2(_component_VChip, {
                                                                        size: "x-small",
                                                                        color: result.presentation.color,
                                                                        variant: "tonal"
                                                                        ...
                                                                        default: _withCtx$2(() => [
                                                                          _createTextVNode$2(_toDisplayString$2(result.presentation.label), 1)
                                                                        ]),
                                                                        _: 2
                                                                      }, 1032, ["color"])
                                                                    ]),
                                                                    _createElementVNode$2("small", null, _toDisplayString$2(result.reason), 1),
                                                                    (result.mapped_path)
                                                                      ? (_openBlock$2(), _createElementBlock$2("code", _hoisted_99, _toDisplayString$2(result.mapped_path), 1))
                                                                      : _createCommentVNode$2("", true)
                                                                  ])
                                                                ]))
                                                              }), 128))
                                                ...
                                                default: _withCtx$2(() => [
                                                  _createElementVNode$2("div", _hoisted_100, [
                                                    _createElementVNode$2("div", null, [
                                                      ...
                                                      _cache[192] || (_cache[192] = _createElementVNode$2("span", null, "已完成记录", -1))
                                                    ]),
                                                    _createVNode$2(_component_VChip, {
                                                      size: "x-small",
                                                      color: "success",
                                                      ...
                                                      default: _withCtx$2(() => [
                                                        _createTextVNode$2(_toDisplayString$2(completedStrmJobs.value.length), 1)
                                                      ]),
                                                      _: 1
                                                    })
                                                  ])
                                              ...
                                              _createVNode$2(_component_VExpansionPanelText, null, {
                                                default: _withCtx$2(() => [
                                                  _createElementVNode$2("div", _hoisted_101, [
                                                    (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(completedStrmJobs.value, (job) => {
                                                      return (_openBlock$2(), _createElementBlock$2("div", {
                                                        key: job.id,
                                                        ...
                                                        _createElementVNode$2("button", {
                                                          ...
                                                          _createElementVNode$2("strong", null, _toDisplayString$2(job.title || job.target_path), 1),
                                                          _createElementVNode$2("span", null, _toDisplayString$2(strmJobSummary(job)), 1)
                                                        ], 8, _hoisted_102),
                                                        _createVNode$2(_component_VChip, {
                                                          size: "small",
                                                          color: "success",
                                                        ...
                                                        _createVNode$2(_component_VExpandTransition, null, {
                                                          default: _withCtx$2(() => [
                                                            (strmJobDetailOpen(job.id))
                                                              ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_104, [
                                                                  _createElementVNode$2("div", null, [
                                                                    _cache[194] || (_cache[194] = _createElementVNode$2("span", null, "目标路径", -1)),
                                                                    _createElementVNode$2("code", null, _toDisplayString$2(job.target_path || '未记录'), 1)
                                                                  ]),
                                                                  _createElementVNode$2("div", null, [
                                                                    _cache[195] || (_cache[195] = _createElementVNode$2("span", null, "处理说明", -1)),
                                                                    _createElementVNode$2("strong", null, _toDisplayString$2(strmJobSummary(job)), 1)
                                                                  ]),
                                                                  _createElementVNode$2("div", null, [
                                                                    _cache[196] || (_cache[196] = _createElementVNode$2("span", null, "尝试次数", -1)),
                                                                    _createElementVNode$2("strong", null, _toDisplayString$2(job.attempts || 0) + " 次", 1)
                                                                  ]),
                                                                  (strmServerResults(job).length)
                                                                    ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_105, [
                                                                        _cache[197] || (_cache[197] = _createElementVNode$2("span", null, "服务器结果", -1)),
                                                                        (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(strmServerResults(job), (result) => {
                                                                          return (_openBlock$2(), _createElementBlock$2("div", {
                                                                            key: result.name,
                                                                            class: "strm-server-result"
                                                                            ...
                                                                            _createElementVNode$2("div", null, [
                                                                              ...
                                                                              _createElementVNode$2("small", null, _toDisplayString$2(result.reason), 1),
                                                                              (result.mapped_path)
                                                                                ? (_openBlock$2(), _createElementBlock$2("code", _hoisted_106, _toDisplayString$2(result.mapped_path), 1))
                                                                                : _createCommentVNode$2("", true)
                                                                            ])
                                                                          ]))
                                                                        }), 128))
                            ...
                            : (_openBlock$2(), _createBlock$2(_component_VCardText, {
                                ...
                                default: _withCtx$2(() => [
                                  ...
                                  _cache[198] || (_cache[198] = _createElementVNode$2("span", null, "暂无推送任务", -1))
                                ]),
                                _: 1
                              }))
                        ]),
            ...
            : (props.mode === 'naming')
              ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_107, [
                  _createVNode$2(_component_VTabs, {
                  ...
                  (renameRuleSection.value === 'fields')
                    ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_108, [
                        _createElementVNode$2("div", _hoisted_109, [
                          _cache[203] || (_cache[203] = _createElementVNode$2("div", { class: "flex-grow-1" }, [
                            ...
                            _createVNode$2(_component_VCardText, null, {
                              default: _withCtx$2(() => [
                                (customFields.value.length)
                                      ...
                                      (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(customFields.value, (item) => {
                                        return (_openBlock$2(), _createElementBlock$2("div", {
                                          ...
                                          _createElementVNode$2("div", _hoisted_111, [
                                            ...
                                            _createElementVNode$2("div", _hoisted_113, _toDisplayString$2(item.label || item.key), 1),
                                            _createElementVNode$2("div", {
                                              class: "rule-pattern text-truncate",
                                              title: item.expression
                                            }, _toDisplayString$2(item.expression), 9, _hoisted_114),
                                            (item.dependencies?.length)
                                              ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_115, "依赖：" + _toDisplayString$2(item.dependencies.join('、')), 1))
                                              : _createCommentVNode$2("", true)
                                          ]),
                                          _createVNode$2(_component_VBtn, {
                                  ...
                                  : (_openBlock$2(), _createElementBlock$2("div", _hoisted_116, [
                                      _createVNode$2(_component_VIcon, {
                                        icon: "mdi-code-braces",
                                        size: "34"
                                      }),
                                      _cache[206] || (_cache[206] = _createElementVNode$2("div", { class: "mt-2" }, "尚未定义自定义字段", -1)),
                                      _cache[207] || (_cache[207] = _createElementVNode$2("div", { class: "text-caption mt-1" }, "需要时点击右上角“新增字段”", -1))
                                    ]))
                              ]),
                              _: 1
                            })
                        ...
                        _createVNode$2(_component_VCard, {
                          ...
                          default: _withCtx$2(() => [
                            ...
                            _createVNode$2(_component_VCardText, null, {
                              default: _withCtx$2(() => [
                                _createElementVNode$2("div", _hoisted_117, [
                                  _createVNode$2(_component_VTextarea, {
                                  ...
                                  ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_118, [
                                      (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(renamePreview.value.values, (value, key) => {
                                        return (_openBlock$2(), _createElementBlock$2("div", {
                                          ...
                                          _createElementVNode$2("span", _hoisted_119, _toDisplayString$2(value || '（空）'), 1)
                                        ]))
                                      }), 128)),
                            ...
                            _createVNode$2(_component_VCardText, null, {
                              default: _withCtx$2(() => [
                                          ...
                                          _createVNode$2(_component_VExpansionPanelTitle, null, {
                                            default: _withCtx$2(() => [
                                              _createElementVNode$2("div", _hoisted_120, [
                                                _createElementVNode$2("span", _hoisted_121, _toDisplayString$2(group.category), 1),
                                                _createVNode$2(_component_VChip, {
                                                  size: "x-small",
                                                  variant: "tonal"
                                                }, {
                                              ...
                                              _createElementVNode$2("div", _hoisted_122, [
                                                (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(group.items, (item) => {
                                                  return (_openBlock$2(), _createElementBlock$2("div", {
                                                    ...
                                                    _createElementVNode$2("div", _hoisted_124, _toDisplayString$2(item.label), 1),
                                                    _createElementVNode$2("div", _hoisted_125, _toDisplayString$2(item.description), 1),
                                                    _createElementVNode$2("div", _hoisted_126, [
                                                      _createElementVNode$2("span", null, _toDisplayString$2(item.type || '文本'), 1),
                                                      _createElementVNode$2("span", _hoisted_127, _toDisplayString$2(item.values || '按上下文决定'), 1)
                                                    ]),
                                                    _createElementVNode$2("div", {
                                ...
                                (!renameFieldGroups.value.length)
                                  ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_129, "没有匹配的字段"))
                                  : _createCommentVNode$2("", true)
                              ]),
                              _: 1
                            })
                  ...
                  (renameRuleSection.value === 'defaults')
                            ...
                            default: _withCtx$2(() => [
                              ...
                              _createElementVNode$2("div", _hoisted_130, [
                                ...
                                _createElementVNode$2("div", _hoisted_131, [
                                  _cache[217] || (_cache[217] = _createElementVNode$2("div", null, [
                    ...
                    : (renameRuleSection.value === 'text')
                      ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_132, [
                          ...
                          (mappingRules.value.length)
                            ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_134, [
                                        ...
                                        default: _withCtx$2(() => [
                                          ...
                                          _createElementVNode$2("div", _hoisted_135, [
                                            _createElementVNode$2("div", _hoisted_136, [
                                              _createElementVNode$2("span", _hoisted_137, _toDisplayString$2(item.label), 1),
                                              _createVNode$2(_component_VChip, {
                                                size: "x-small",
                                                variant: "tonal"
                                              }, {
                                            ...
                                            _createElementVNode$2("div", _hoisted_139, "优先级 " + _toDisplayString$2(item.priority), 1)
                                          ]),
                                          _createVNode$2(_component_VBtn, {
                                            icon: "mdi-pencil-outline",
                                            size: "small",
                            ...
                            : (_openBlock$2(), _createElementBlock$2("div", _hoisted_140, [
                                _createVNode$2(_component_VIcon, {
                                  icon: "mdi-find-replace",
                                  size: "48"
                                }),
                                _cache[223] || (_cache[223] = _createElementVNode$2("div", { class: "mt-2" }, "尚未设置最终命名规则", -1)),
                                _cache[224] || (_cache[224] = _createElementVNode$2("div", { class: "text-caption mt-1" }, "可先添加简繁字幕预设，或按 MP 模板生成的完整路径建立任意文字替换", -1))
                              ])),
                          _createVNode$2(_component_VCard, {
                            variant: "outlined",
                            class: "mt-4"
                            ...
                            default: _withCtx$2(() => [
                              _createVNode$2(_component_VCardItem, null, {
                                default: _withCtx$2(() => [
                                  ...
                                  _createVNode$2(_component_VCardSubtitle, null, {
                                    default: _withCtx$2(() => [...(_cache[226] || (_cache[226] = [
                              ...
                              _createVNode$2(_component_VCardText, null, {
                                default: _withCtx$2(() => [
                                  _createElementVNode$2("div", _hoisted_141, [
                                    _createVNode$2(_component_VTextField, {
                                    ...
                                    _createVNode$2(_component_VBtn, {
                                      ...
                                      default: _withCtx$2(() => [...(_cache[227] || (_cache[227] = [
                                        _createTextVNode$2("开始试算", -1)
                                      ]))]),
                                      _: 1
                                    }, 8, ["loading"])
                                  ...
                                  (mappingPreview.value)
                                    ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                                        ...
                                        default: _withCtx$2(() => [
                                          _createElementVNode$2("div", null, [
                                            _cache[228] || (_cache[228] = _createTextVNode$2("输出：", -1)),
                                            _createElementVNode$2("code", null, _toDisplayString$2(mappingPreview.value.output), 1)
                                          ]),
                                          _createElementVNode$2("div", _hoisted_142, "命中 " + _toDisplayString$2(mappingPreview.value.changes?.length || 0) + " 条规则", 1)
                                        ]),
                                        _: 1
                                      }, 8, ["type"]))
                                    : _createCommentVNode$2("", true)
              ...
              : (_openBlock$2(), _createElementBlock$2("section", _hoisted_143, [
                  _createVNode$2(_component_VCard, { variant: "outlined" }, {
                    default: _withCtx$2(() => [
                      _createVNode$2(_component_VCardItem, null, {
                        default: _withCtx$2(() => [
                      ...
                      _createVNode$2(_component_VCardText, null, {
                        default: _withCtx$2(() => [
                          _createElementVNode$2("div", _hoisted_144, [
                            _createVNode$2(_component_VTextarea, {
                            ...
                            _createElementVNode$2("div", _hoisted_145, [
                              _createVNode$2(_component_VBtn, {
                                color: "primary",
                                "prepend-icon": "mdi-play",
                          ...
                          (preview.value && !preview.value.changes?.length)
                            ...
                            : (preview.value?.changes?.length)
                              ? (_openBlock$2(), _createBlock$2(_component_VTable, {
                                  ...
                                  default: _withCtx$2(() => [
                                    _cache[233] || (_cache[233] = _createElementVNode$2("thead", null, [
                                      _createElementVNode$2("tr", null, [
                  ...
                  default: _withCtx$2(() => [
                    _createVNode$2(_component_VExpansionPanel, null, {
                      default: _withCtx$2(() => [
                        ...
                        _createVNode$2(_component_VExpansionPanelText, null, {
                          default: _withCtx$2(() => [
                            _createElementVNode$2("div", _hoisted_146, [
                    ...
                    (customFields.value.length)
                      ? (_openBlock$2(), _createBlock$2(_component_VExpansionPanel, { key: 0 }, {
                          default: _withCtx$2(() => [
                            ...
                            _createVNode$2(_component_VExpansionPanelText, null, {
                              default: _withCtx$2(() => [
                                _createElementVNode$2("div", _hoisted_147, [
                                  (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(customFields.value, (item) => {
                                ...
                                _cache[237] || (_cache[237] = _createElementVNode$2("div", { class: "text-caption text-medium-emphasis mt-3" }, "这里填的是该制作组对字段的固定补充值；字段本身的 Jinja 表达式仍在“命名规则 → 自定义字段”维护。", -1))
                              ]),
                              _: 1
                            })
                          ]),
          ...
          ? (_openBlock$2(), _createBlock$2(_component_VCard, { key: 0 }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VCardText, { class: "field-detail-body" }, {
                  default: _withCtx$2(() => [
                    _createElementVNode$2("div", _hoisted_148, [
                      _createVNode$2(_component_VChip, {
                        size: "small",
                    ...
                    _createVNode$2(_component_VAlert, {
                      ...
                      default: _withCtx$2(() => [
                        ...
                        _createElementVNode$2("div", _hoisted_149, _toDisplayString$2(fieldDetail.value.template_usage_detail || '可直接复制下方变量写入 MoviePilot 命名模板。'), 1)
                      ]),
                      _: 1
                    }, 8, ["type"]),
                    _createElementVNode$2("div", _hoisted_150, [
                      _cache[240] || (_cache[240] = _createElementVNode$2("div", { class: "field-detail-title" }, "用途", -1)),
                      _createElementVNode$2("div", null, _toDisplayString$2(fieldDetail.value.description), 1)
                    ]),
                    _createElementVNode$2("div", _hoisted_151, [
                      _cache[241] || (_cache[241] = _createElementVNode$2("div", { class: "field-detail-title" }, "可能值与格式", -1)),
                      _createElementVNode$2("div", null, _toDisplayString$2(fieldDetail.value.values || '具体值由当前命名上下文决定。'), 1)
                    ]),
                    _createElementVNode$2("div", _hoisted_152, [
                      _cache[242] || (_cache[242] = _createElementVNode$2("div", { class: "field-detail-title" }, "生成逻辑 / 使用注意", -1)),
                      _createElementVNode$2("div", null, _toDisplayString$2(fieldDetail.value.logic || '使用前建议判断字段是否为空。'), 1)
                    ]),
                    _createElementVNode$2("div", _hoisted_153, [
                      _cache[243] || (_cache[243] = _createElementVNode$2("div", { class: "field-detail-title" }, "Jinja2 写法", -1)),
                      _createElementVNode$2("code", _hoisted_154, _toDisplayString$2(variableSyntax(fieldDetail.value.key)), 1)
                    ]),
                            ...
                            _createVNode$2(_component_VExpansionPanel, null, {
                              default: _withCtx$2(() => [
                                _createVNode$2(_component_VExpansionPanelTitle, null, {
                                  default: _withCtx$2(() => [
                                    _createElementVNode$2("div", null, [
                                      _cache[244] || (_cache[244] = _createElementVNode$2("div", { class: "font-weight-medium" }, "当前 MP 已加载的识别预设", -1)),
                                      _createElementVNode$2("div", _hoisted_155, _toDisplayString$2(fieldDetailPresetRules.value.length) + " 条；展示当前实例实际生效的内置词、正则和插件覆盖", 1)
                                    ])
                                  ]),
                                  _: 1
                                }),
                                _createVNode$2(_component_VExpansionPanelText, null, {
                                  default: _withCtx$2(() => [
                                    _createElementVNode$2("div", _hoisted_156, [
                                      _createVNode$2(_component_VTable, {
                                        density: "compact",
                                        class: "preset-table"
                                      }, {
                                        default: _withCtx$2(() => [
                                          _cache[245] || (_cache[245] = _createElementVNode$2("thead", null, [
                                            _createElementVNode$2("tr", null, [
                                                ...
                                                _createElementVNode$2("td", null, [
                                                  _createVNode$2(_component_VChip, {
                                                    ...
                                                    default: _withCtx$2(() => [
                                                      ...
                                                      (rule.overridden)
                                                        ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_157, " · 已覆盖"))
                                                        : _createCommentVNode$2("", true)
                                                    ]),
                                                    _: 2
                                                  }, 1032, ["color"])
                                    ...
                                    (visibleFieldPresetRules.value.length < fieldDetailPresetRules.value.length)
                                      ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_158, [
                                          _createVNode$2(_component_VBtn, {
                                            variant: "tonal",
                                            size: "small",
                ...
                _createVNode$2(_component_VRow, { align: "center" }, {
                  default: _withCtx$2(() => [
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createElementVNode$2("div", _hoisted_159, [
            ...
            _createVNode$2(_component_VCardItem, { class: "rule-dialog-header" }, {
              prepend: _withCtx$2(() => [
                _createVNode$2(_component_VAvatar, {
                  ...
                  default: _withCtx$2(() => [
                    _createVNode$2(_component_VIcon, { icon: "mdi-format-list-numbered" })
                  ]),
                  _: 1
                })
              ]),
              default: _withCtx$2(() => [
                _createVNode$2(_component_VCardTitle, null, {
                  default: _withCtx$2(() => [...(_cache[252] || (_cache[252] = [
                    _createTextVNode$2("批量修改筛选结果优先级", -1)
                  ]))]),
                  _: 1
                }),
                _createVNode$2(_component_VCardSubtitle, null, {
                  default: _withCtx$2(() => [
                    _createTextVNode$2("只处理当前搜索、字段和来源共同筛选出的 " + _toDisplayString$2(rules.value.length) + " 条规则，不受分页影响。", 1)
                  ]),
                  _: 1
                })
              ]),
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  ...
                  default: _withCtx$2(() => [...(_cache[253] || (_cache[253] = [
                    _createTextVNode$2("取消", -1)
                  ]))]),
                  _: 1
                }),
                _createVNode$2(_component_VBtn, {
                  ...
                  default: _withCtx$2(() => [
                    _createTextVNode$2("应用到 " + _toDisplayString$2(rules.value.length) + " 条", 1)
                  ]),
                  _: 1
                }, 8, ["loading"])
              ]),
          ...
          default: _withCtx$2(() => [
            _createVNode$2(_component_VCardItem, null, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VCardSubtitle, null, {
                  default: _withCtx$2(() => [...(_cache[254] || (_cache[254] = [
            ...
            _createVNode$2(_component_VCardText, { class: "rule-dialog-body" }, {
              default: _withCtx$2(() => [
                ...
                _createElementVNode$2("div", _hoisted_160, [
                  _cache[255] || (_cache[255] = _createElementVNode$2("div", null, [
                ...
                _createVNode$2(_component_VAlert, {
                  ...
                  default: _withCtx$2(() => [...(_cache[256] || (_cache[256] = [
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  ...
                  default: _withCtx$2(() => [...(_cache[257] || (_cache[257] = [
                    _createTextVNode$2("取消", -1)
                  ]))]),
                  _: 1
                }),
                _createVNode$2(_component_VBtn, {
                  ...
                  default: _withCtx$2(() => [...(_cache[258] || (_cache[258] = [
          ...
          default: _withCtx$2(() => [
            _createVNode$2(_component_VCardItem, null, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VCardSubtitle, null, {
                  default: _withCtx$2(() => [...(_cache[259] || (_cache[259] = [
            ...
            _createVNode$2(_component_VCardText, { class: "rule-dialog-body" }, {
              default: _withCtx$2(() => [
                ...
                _createElementVNode$2("div", _hoisted_161, [
                  _cache[260] || (_cache[260] = _createElementVNode$2("div", null, [
                    _createElementVNode$2("div", { class: "font-weight-medium" }, "启用规则"),
                ...
                _createVNode$2(_component_VAlert, {
                  ...
                  default: _withCtx$2(() => [...(_cache[261] || (_cache[261] = [
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  ...
                  default: _withCtx$2(() => [...(_cache[262] || (_cache[262] = [
                    _createTextVNode$2("取消", -1)
                  ]))]),
                  _: 1
                }),
                _createVNode$2(_component_VBtn, {
                  ...
                  default: _withCtx$2(() => [...(_cache[263] || (_cache[263] = [
          ...
          default: _withCtx$2(() => [
            _createVNode$2(_component_VCardItem, null, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VCardSubtitle, null, {
                  default: _withCtx$2(() => [...(_cache[264] || (_cache[264] = [
            ...
            _createVNode$2(_component_VCardText, { class: "rule-dialog-body" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VRow, { align: "center" }, {
                  default: _withCtx$2(() => [
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createElementVNode$2("div", _hoisted_162, [
                          _cache[265] || (_cache[265] = _createElementVNode$2("div", null, [
                            _createElementVNode$2("div", { class: "font-weight-medium" }, "启用规则"),
                ...
                _createVNode$2(_component_VAlert, {
                  ...
                  default: _withCtx$2(() => [...(_cache[266] || (_cache[266] = [
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  ...
                  default: _withCtx$2(() => [...(_cache[267] || (_cache[267] = [
                    _createTextVNode$2("取消", -1)
                  ]))]),
                  _: 1
                }),
                _createVNode$2(_component_VBtn, {
                  ...
                  default: _withCtx$2(() => [...(_cache[268] || (_cache[268] = [
...
const MetadataTools = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-2b9534e6"]]);
...
const _hoisted_38 = { class: "best-result-visual" };
const _hoisted_39 = {
  key: 1,
  class: "best-result-poster-placeholder"
};
const _hoisted_40 = { class: "best-result-copy" };
const _hoisted_41 = { class: "best-result-heading" };
const _hoisted_42 = { class: "text-h6" };
const _hoisted_43 = {
  key: 0,
  class: "best-result-original"
};
const _hoisted_44 = { class: "best-result-meta" };
const _hoisted_45 = {
  key: 0,
...
const _hoisted_49 = { class: "pipeline-stage-rail" };
const _hoisted_50 = { class: "pipeline-stage-marker" };
const _hoisted_51 = { class: "pipeline-stage-card" };
const _hoisted_52 = { class: "pipeline-stage-header" };
const _hoisted_53 = { class: "pipeline-stage-index" };
const _hoisted_54 = {
  key: 0,
...
const _hoisted_66 = { class: "d-flex flex-wrap ga-2 mb-4" };
const _hoisted_67 = { class: "d-flex flex-wrap ga-2 mb-4" };
const _hoisted_68 = { class: "text-caption text-medium-emphasis" };
const _hoisted_69 = { class: "text-caption" };
const _hoisted_70 = { class: "text-medium-emphasis" };
...
const _hoisted_82 = { class: "history-card-content" };
const _hoisted_83 = { class: "d-flex align-start ga-3" };
const _hoisted_84 = { class: "flex-grow-1" };
const _hoisted_85 = { class: "d-flex flex-wrap align-center ga-2" };
const _hoisted_86 = { class: "font-weight-bold" };
const _hoisted_87 = ["title"];
const _hoisted_88 = { class: "text-caption text-medium-emphasis mt-1" };
const _hoisted_89 = {
  key: 1,
...
const _hoisted_92 = { class: "d-flex flex-wrap ga-1 mt-2" };
const _hoisted_93 = {
  key: 1,
  class: "empty-preview"
};
const _hoisted_94 = { class: "text-h6 mt-3" };
const _hoisted_95 = {
  key: 7,
  class: "workspace-panel"
};
const _hoisted_96 = { class: "tab-content" };
const _hoisted_97 = { class: "workspace-panel" };
        ...
        default: _withCtx(() => [
          ...
          _createElementVNode("div", _hoisted_7, [
                          ...
                          default: _withCtx(() => [
                            (preview.value)
                                      ...
                                      default: _withCtx(() => [
                                          ...
                                          ? (_openBlock(), _createElementBlock("div", {
                                              ...
                                              _createElementVNode("div", _hoisted_40, [
                                                _createElementVNode("div", _hoisted_41, [
                                                  _createElementVNode("div", null, [
                                                    _createElementVNode("div", _hoisted_42, _toDisplayString(preview.value.best.name), 1),
                                                    (preview.value.best.original_name && preview.value.best.original_name !== preview.value.best.name)
                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_43, _toDisplayString(preview.value.best.original_name), 1))
                                                      : _createCommentVNode("", true)
                                                  ]),
                                                ...
                                                (preview.value.best.overview)
                                                  ? (_openBlock(), _createElementBlock("p", _hoisted_46, _toDisplayString(preview.value.best.overview), 1))
                                                  : _createCommentVNode("", true)
                                              ]),
                                        ...
                                        (preview.value.episode_adjustment)
                                          ? (_openBlock(), _createBlock(_component_VAlert, {
                                              ...
                                              default: _withCtx(() => [
                                                _cache[78] || (_cache[78] = _createElementVNode("strong", null, "集数偏移：", -1)),
                                                ...
                                                (preview.value.episode_adjustment.coordinates_authoritative !== false && preview.value.episode_adjustment.season != null && preview.value.episode_adjustment.episode != null)
                                                  ? (_openBlock(), _createElementBlock("span", _hoisted_47, " · 最终 S" + _toDisplayString(String(preview.value.episode_adjustment.season).padStart(2, '0')) + "E" + _toDisplayString(String(preview.value.episode_adjustment.episode).padStart(2, '0')), 1))
                                                  : _createCommentVNode("", true)
                                              ]),
                                              _: 1
                                            }, 8, ["type"]))
                                                  ...
                                                  default: _withCtx(() => [
                                                    (previewPipelineGroups.value.length)
                                                            ...
                                                            return (_openBlock(), _createElementBlock("section", {
                                                              ...
                                                              _createElementVNode("div", _hoisted_51, [
                                                                _createElementVNode("header", _hoisted_52, [
                                                                  _createElementVNode("div", null, [
                                                                    _createElementVNode("span", _hoisted_53, _toDisplayString(String(stage.index).padStart(2, '0')), 1),
                                                                        ...
                                                                        return (_openBlock(), _createElementBlock("div", {
                                                                          ...
                                                                          _createElementVNode("div", null, [
                                                                            ...
                                                                            _createElementVNode("span", {
                                                                              title: step.summary
                                                                            }, _toDisplayString(pipelineStepSummary(step)), 9, _hoisted_55)
                                                                          ])
                                                                        ]))
                                                                      }), 128))
                                                                    ]))
                                                                ...
                                                                (stage.key === 'naming' && preview.value.release_group_arrangement?.input && preview.value.release_group_arrangement?.applied)
                                                                  ? (_openBlock(), _createElementBlock("div", _hoisted_57, [
                                                                      _cache[80] || (_cache[80] = _createElementVNode("span", null, "制作组", -1)),
                                                      ...
                                                      : (_openBlock(), _createElementBlock("div", _hoisted_59, [
                                                          ...
                                                          _cache[81] || (_cache[81] = _createElementVNode("span", null, "本次试跑没有返回处理阶段", -1))
                                                        ]))
                                                  ]),
                                                  _: 1
                                                })
                                                  ...
                                                  default: _withCtx(() => [
                                                    ...
                                                    (preview.value.recognition_rule_changes?.length)
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            _cache[83] || (_cache[83] = _createTextVNode("识别字段覆盖：", -1)),
                                                      ...
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            ...
                                                            (preview.value.type_constraint.removed_count)
                                                              ? (_openBlock(), _createElementBlock("span", _hoisted_61, "；排除 " + _toDisplayString(preview.value.type_constraint.removed_count) + " 个冲突候选", 1))
                                                              : _createCommentVNode("", true)
                                                          ]),
                                                          _: 1
                                                        }))
                                                      ...
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            ...
                                                            (preview.value.release_group_preference.removed_count)
                                                              ? (_openBlock(), _createElementBlock("span", _hoisted_62, "；排除 " + _toDisplayString(preview.value.release_group_preference.removed_count) + " 个题材冲突候选", 1))
                                                              : (_openBlock(), _createElementBlock("span", _hoisted_63, "；本次没有发现明确冲突候选"))
                                                          ]),
                                                          _: 1
                                                        }))
                                                      : _createCommentVNode("", true),
                                                      ...
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            ...
                                                            (preview.value.candidate_sources.shared.tmdb_id)
                                                              ? (_openBlock(), _createElementBlock("span", _hoisted_64, " · TMDB " + _toDisplayString(preview.value.candidate_sources.shared.tmdb_id), 1))
                                                              : _createCommentVNode("", true)
                                                          ]),
                                                          _: 1
                                                        }, 8, ["type"]))
                                                      ...
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            ...
                                                            (preview.value.best.season_coordinate_evidence.matched_group_name)
                                                              ? (_openBlock(), _createElementBlock("span", _hoisted_65, " · " + _toDisplayString(preview.value.best.season_coordinate_evidence.matched_group_name), 1))
                                                              : _createCommentVNode("", true)
                                                          ]),
                                                          _: 1
                                                        }))
                                                    ...
                                                    (preview.value.selection_mode === 'cross_id')
                                                      ? (_openBlock(), _createElementBlock(_Fragment, { key: 11 }, [
                                                          _cache[85] || (_cache[85] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-2" }, "跨站身份", -1)),
                                                      ...
                                                      : (_openBlock(), _createElementBlock(_Fragment, { key: 12 }, [
                                                          _cache[86] || (_cache[86] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-2" }, "实际搜索词", -1)),
                                                    ...
                                                    (preview.value.candidates?.length)
                                                      ? (_openBlock(), _createBlock(_component_VTable, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            _cache[87] || (_cache[87] = _createElementVNode("thead", null, [
                                                              ...
                                                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(preview.value.candidates, (candidate) => {
                                                                return (_openBlock(), _createElementBlock("tr", {
                                                                  ...
                                                                  _createElementVNode("td", null, [
                                                                    ...
                                                                    _createElementVNode("div", _hoisted_68, _toDisplayString(candidate.year || '—') + " · #" + _toDisplayString(candidate.tmdb_id), 1)
                                                                  ]),
                                                                  _createElementVNode("td", _hoisted_69, [
                                                                    ...
                                                                    _createElementVNode("div", _hoisted_70, [
                                                                      ...
                                                                      (candidate.web_evidence)
                                                                        ? (_openBlock(), _createElementBlock("span", _hoisted_71, " · 外部证据 " + _toDisplayString(candidate.web_evidence), 1))
                                                                        : _createCommentVNode("", true)
                                                                    ]),
                                                                    (candidate.release_group_evidence?.component !== null)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_72, "制作组 " + _toDisplayString(candidate.release_group_evidence.label) + "：" + _toDisplayString(candidate.release_group_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.seasonal_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_73, "季度目录 " + _toDisplayString(candidate.seasonal_evidence.quarter) + "：" + _toDisplayString(candidate.seasonal_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.memory_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_74, "近期命中 " + _toDisplayString(candidate.memory_evidence.hits) + " 次：" + _toDisplayString(candidate.memory_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.preferred_by_policy)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_75, "命中 TMDB 优先名单"))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.suppressed_by_exclusion)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_76, "已被 TMDB 排除名单剔除"))
                                                                      : _createCommentVNode("", true)
                                                                  ]),
                                                                  _createElementVNode("td", null, [
                                                                    _createVNode(_component_VChip, {
                              ...
                              : (_openBlock(), _createElementBlock("div", _hoisted_77, [
                                  ...
                                  _cache[88] || (_cache[88] = _createElementVNode("div", { class: "text-h6 mt-3" }, "等待一次综合试跑", -1)),
                                  _cache[89] || (_cache[89] = _createElementVNode("div", { class: "text-body-2 text-medium-emphasis" }, "结果会解释从标题解析到最终命名的完整插件链路", -1))
                                ]))
                          ]),
                          _: 1
                        })
                  ...
                  _createElementVNode("div", _hoisted_79, [
                    ...
                    (filteredHistory.value.length)
                                    ...
                                    _createElementVNode("div", _hoisted_84, [
                                      ...
                                      (item.original_title)
                                        ? (_openBlock(), _createElementBlock("div", {
                                          ...
                                          }, "原标题：" + _toDisplayString(item.original_title), 9, _hoisted_87))
                                        : _createCommentVNode("", true),
                                      _createElementVNode("div", _hoisted_88, _toDisplayString(item.created_at) + " · " + _toDisplayString(item.reason), 1),
                                      (!item.accepted && item.kind !== 'operation')
                                        ? (_openBlock(), _createElementBlock("div", _hoisted_89, "插件未接管本次候选选择，MoviePilot 仍会继续执行原生识别与整理；这不代表最终整理失败。"))
                                        : _createCommentVNode("", true),
                                      (item.episode_adjustment)
                                        ? (_openBlock(), _createElementBlock("div", _hoisted_90, [
                                            ...
                                            (item.episode_adjustment.season != null)
                                              ? (_openBlock(), _createElementBlock("span", _hoisted_91, " · S" + _toDisplayString(item.episode_adjustment.season) + "E" + _toDisplayString(item.episode_adjustment.episode), 1))
                                              : _createCommentVNode("", true)
                                          ]))
                                        : _createCommentVNode("", true),
                      ...
                      : (_openBlock(), _createElementBlock("div", _hoisted_93, [
                          ...
                          _createElementVNode("div", _hoisted_94, _toDisplayString(history.value.length ? '当前筛选没有日志' : '尚无模块日志'), 1)
                        ]))
                  ])
                ]))
              : _createCommentVNode("", true),
            (tab.value === 'diagnostics')
              ...
              : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("section", _hoisted_97, [
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-ccd9ccc2"]]);
