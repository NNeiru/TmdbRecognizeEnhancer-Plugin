...
const {computed: computed$3,onActivated,onBeforeUnmount: onBeforeUnmount$1,onDeactivated,onMounted: onMounted$3,ref: ref$3,watch: watch$2} = await importShared('vue');
...
const snackbarColor = ref$3('success');
const subModule = ref$3('rules');
const rules = ref$3([]);
...
const embyLoading = ref$3(false);
const embySaving = ref$3(false);
const embyPreviewing = ref$3(false);
const embyApplyingAll = ref$3('');
const embyPreview = ref$3(null);
const embyPreviewRule = ref$3('');
const embyPreviewPath = ref$3('');
let scanTimer = null;
...
const embyServerItems = computed$3(() => (embySync.value.servers || []).map(item => ({
  title: `${item.name}${item.connected ? '' : '（未连接）'}`,
  value: item.name,
})));
const embyGroupRuleItems = computed$3(() => rules.value
...
const embyStatusText = computed$3(() => {
...
restoreUiState();
watch$2(() => [board.value.year, board.value.quarter], () => {
  if (subModule.value === 'catalog') loadQuarter(false);
});
watch$2(subModule, value => {
  ...
  return (_openBlock$3(), _createElementBlock$3("div", _hoisted_1$3, [
    ...
    (!__props.runtimeStatus.runtime_compatible || !__props.runtimeStatus.plugin_first)
      ? (_openBlock$3(), _createBlock$3(_component_VAlert, {
          ...
          default: _withCtx$3(() => [
            _cache[50] || (_cache[50] = _createElementVNode$3("div", { class: "font-weight-bold" }, "集数偏移暂不能接管实际整理", -1)),
          ...
          default: _withCtx$3(() => [
            ...
            _createVNode$3(_component_VTab, {
              ...
              default: _withCtx$3(() => [...(_cache[53] || (_cache[53] = [
                _createTextVNode$3("Emby 剧集组联动", -1)
              ]))]),
              _: 1
            })
          ]),
    ...
    _withDirectives$1(_createVNode$3(_component_VCard, {
      variant: "outlined",
        ...
        _createVNode$3(_component_VCardItem, null, {
          ...
          default: _withCtx$3(() => [
            ...
            _createVNode$3(_component_VCardSubtitle, null, {
              default: _withCtx$3(() => [
                _createTextVNode$3(_toDisplayString$3(rules.value.length) + " 个 TMDB 条目；定义来源集数到目标编集的映射", 1)
              ]),
              _: 1
            })
          ]),
            ...
            (rulesOpen.value)
              ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_4$3, [
                  ...
                  (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(groupedRules.value, (group) => {
                    return (_openBlock$3(), _createElementBlock$3("div", {
                      ...
                      _createElementVNode$3("div", _hoisted_6$3, [
                        ...
                        _createElementVNode$3("span", _hoisted_7$3, _toDisplayString$3(group.items.length) + " 条", 1)
                      ]),
                              ...
                              _createVNode$3(_component_VCardText, { class: "d-flex align-center ga-3" }, {
                                default: _withCtx$3(() => [
                                  ...
                                  _createElementVNode$3("div", _hoisted_8$3, [
                                    _createElementVNode$3("div", _hoisted_9$3, _toDisplayString$3(rule.title), 1),
                                    _createElementVNode$3("div", _hoisted_10$3, "TMDB " + _toDisplayString$3(rule.tmdb_id) + " · " + _toDisplayString$3(rule.target_type === 'group' ? '剧集组' : '默认编集') + " · " + _toDisplayString$3(rule.installments?.length || 0) + " 个季度片段", 1),
                                    (rule.installments?.some(item => item.quarter))
                                      ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_11$3, [
                  ...
                  (!filteredRules.value.length)
                    ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_12$3, "当前季度或搜索条件下没有维护规则。"))
                    : _createCommentVNode$3("", true)
                ]))
              : _createCommentVNode$3("", true)
          ]),
      ...
      default: _withCtx$3(() => [
        ...
        _createVNode$3(_component_VCardText, null, {
          default: _withCtx$3(() => [
            ...
            _createElementVNode$3("div", _hoisted_15$3, [
            ...
            _createElementVNode$3("div", _hoisted_16$3, [
              ...
              (catalogMeta.value.scanning_count)
                ? (_openBlock$3(), _createElementBlock$3("span", _hoisted_17$3, " · " + _toDisplayString$3(catalogMeta.value.scanning_count) + " 条正在扫描", 1))
                : _createCommentVNode$3("", true),
              (catalogMeta.value.updated_at)
                ? (_openBlock$3(), _createElementBlock$3("span", _hoisted_18$3, " · 更新于 " + _toDisplayString$3(catalogMeta.value.updated_at), 1))
                : _createCommentVNode$3("", true)
            ]),
            _createElementVNode$3("div", {
                ...
                return (_openBlock$3(), _createBlock$3(_component_VCard, {
                  ...
                  default: _withCtx$3(() => [
                    ...
                    _createElementVNode$3("div", _hoisted_20$2, [
                      ...
                      _createVNode$3(_component_VCardItem, { class: "catalog-summary" }, {
                        default: _withCtx$3(() => [
                      ...
                      _createVNode$3(_component_VCardText, { class: "catalog-details" }, {
                        default: _withCtx$3(() => [
                            ...
                            (item.scan_status === 'scanning')
                              ? (_openBlock$3(), _createBlock$3(_component_VChip, {
                                  ...
                                  default: _withCtx$3(() => [
                                    ...
                                    _cache[58] || (_cache[58] = _createTextVNode$3("正在扫描 ", -1))
                                  ]),
                                  _: 1
                                }))
                          ...
                          (item.tmdb_match?.best)
                            ? (_openBlock$3(), _createElementBlock$3("div", {
                              ...
                              }, " TMDB " + _toDisplayString$3(item.tmdb_match.best.tmdb_id) + " · " + _toDisplayString$3(item.tmdb_match.best.name), 9, _hoisted_23$2))
                            : _createCommentVNode$3("", true)
                        ]),
                        _: 2
                      }, 1024),
                      _createVNode$3(_component_VCardActions, { class: "catalog-actions" }, {
                        default: _withCtx$3(() => [
              ...
              (!catalogLoading.value && !filteredCatalog.value.length)
                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_24$2, [
                    _createVNode$3(_component_VIcon, {
                      icon: "mdi-calendar-search",
                      size: "48"
                    }),
                    _cache[64] || (_cache[64] = _createElementVNode$3("div", null, "当前筛选条件没有番剧", -1))
                  ]))
                : _createCommentVNode$3("", true)
            ], 2)
          ]),
    ...
    _withDirectives$1(_createElementVNode$3("div", _hoisted_25$2, [
      _createVNode$3(_component_VAlert, {
        ...
        default: _withCtx$3(() => [...(_cache[65] || (_cache[65] = [
          _createTextVNode$3(" 仅当实际整理采用剧集组规则时才会排队；插件通过 TMDBID 与最终路径定位 Emby Series，写入神医使用的 ", -1),
          _createElementVNode$3("code", null, "TmdbEg", -1),
          _createTextVNode$3("。已正确配置的条目会自动跳过。 ", -1)
        ]))]),
        _: 1
      }),
      (!embySync.value.available)
        ? (_openBlock$3(), _createBlock$3(_component_VAlert, {
            ...
            default: _withCtx$3(() => [...(_cache[66] || (_cache[66] = [
              _createTextVNode$3(" 当前 MoviePilot 缺少媒体服务器服务目录，无法复用已配置的 Emby。此限制不会影响集数偏移本身。 ", -1)
            ]))]),
            _: 1
          }))
        : _createCommentVNode$3("", true),
          ...
          _createVNode$3(_component_VCardItem, null, {
            prepend: _withCtx$3(() => [
              _createVNode$3(_component_VAvatar, {
                ...
                default: _withCtx$3(() => [
                  _createVNode$3(_component_VIcon, { icon: "mdi-server-network" })
                ]),
                _: 1
              })
            ]),
            ...
            default: _withCtx$3(() => [
              _createVNode$3(_component_VCardTitle, null, {
                default: _withCtx$3(() => [...(_cache[67] || (_cache[67] = [
                  _createTextVNode$3("入库联动设置", -1)
                ]))]),
                _: 1
              }),
              _createVNode$3(_component_VCardSubtitle, null, {
                default: _withCtx$3(() => [
                  _createTextVNode$3(_toDisplayString$3(embyStatusText.value), 1)
                ]),
                _: 1
              })
            ]),
            ...
            default: _withCtx$3(() => [
              _createElementVNode$3("div", _hoisted_26$2, [
                _createElementVNode$3("div", null, [
                  _cache[68] || (_cache[68] = _createElementVNode$3("span", null, "等待处理", -1)),
                  _createElementVNode$3("strong", null, _toDisplayString$3(embySync.value.counts?.pending || 0), 1)
                ]),
                _createElementVNode$3("div", null, [
                  _cache[69] || (_cache[69] = _createElementVNode$3("span", null, "已完成", -1)),
                  _createElementVNode$3("strong", null, _toDisplayString$3(embySync.value.counts?.completed || 0), 1)
                ]),
                _createElementVNode$3("div", null, [
                  _cache[70] || (_cache[70] = _createElementVNode$3("span", null, "需要处理", -1)),
                  _createElementVNode$3("strong", null, _toDisplayString$3(embySync.value.counts?.attention || 0), 1)
                ])
              ]),
              ...
              _createElementVNode$3("div", _hoisted_28$2, [
                _cache[72] || (_cache[72] = _createElementVNode$3("div", { class: "flex-grow-1" }, [
                  _createElementVNode$3("div", { class: "font-weight-bold" }, "容器路径映射"),
                  _createElementVNode$3("div", { class: "text-caption text-medium-emphasis" }, "MP 与 Emby 看到的媒体路径相同时无需配置；不同时按最长前缀转换。")
                ], -1)),
                _createVNode$3(_component_VBtn, {
                  variant: "tonal",
                  "prepend-icon": "mdi-plus",
              ...
              (embySync.value.config.path_mappings?.length)
                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_29$2, [
                    (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(embySync.value.config.path_mappings, (mapping, index) => {
                      return (_openBlock$3(), _createElementBlock$3("div", {
                        key: index,
                ...
                : (_openBlock$3(), _createElementBlock$3("div", _hoisted_30$2, "未设置路径映射，将直接比较 MP 最终路径与 Emby Series 路径。"))
            ]),
            _: 1
          }),
      ...
      _createVNode$3(_component_VCard, {
        ...
        default: _withCtx$3(() => [
          _createVNode$3(_component_VCardItem, null, {
            prepend: _withCtx$3(() => [
              _createVNode$3(_component_VAvatar, {
                ...
                default: _withCtx$3(() => [
                  _createVNode$3(_component_VIcon, { icon: "mdi-flask-outline" })
                ]),
                _: 1
              })
            ]),
            default: _withCtx$3(() => [
              _createVNode$3(_component_VCardTitle, null, {
                default: _withCtx$3(() => [...(_cache[75] || (_cache[75] = [
                  _createTextVNode$3("Series 定位试跑", -1)
                ]))]),
                _: 1
              }),
              _createVNode$3(_component_VCardSubtitle, null, {
                default: _withCtx$3(() => [...(_cache[76] || (_cache[76] = [
                  _createTextVNode$3("定位本身只读；出现同 TMDBID 歧义时，可确认将剧集组应用到全部候选", -1)
                ]))]),
                _: 1
              })
            ]),
          ...
          _createVNode$3(_component_VCardText, null, {
            default: _withCtx$3(() => [
              _createElementVNode$3("div", _hoisted_31$2, [
                _createVNode$3(_component_VSelect, {
                ...
                _createVNode$3(_component_VBtn, {
                  ...
                  default: _withCtx$3(() => [...(_cache[77] || (_cache[77] = [
                    _createTextVNode$3("开始定位", -1)
                  ]))]),
                  _: 1
                }, 8, ["loading", "disabled"])
              ]),
              (embyPreview.value?.results)
                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_32$2, [
                    (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(embyPreview.value.results, (result, server) => {
                      return (_openBlock$3(), _createBlock$3(_component_VCard, {
                        key: server,
                        variant: "outlined",
                        class: _normalizeClass$1(["sync-result-card", `sync-result-${embyResultColor(result.status)}`])
                      }, {
                        default: _withCtx$3(() => [
                          _createVNode$3(_component_VCardText, null, {
                            default: _withCtx$3(() => [
                              _createElementVNode$3("div", _hoisted_33$2, [
                                ...
                                _createElementVNode$3("strong", null, _toDisplayString$3(server), 1),
                                _createVNode$3(_component_VChip, {
                                  ...
                                  default: _withCtx$3(() => [
                                    _createTextVNode$3(_toDisplayString$3(embyResultText(result.status)), 1)
                                  ]),
                                  _: 2
                                }, 1032, ["color"]),
                                _createVNode$3(_component_VSpacer),
                                (result.status === 'ambiguous' && Number(result.candidate_count || result.candidates?.length || 0) > 1)
                                  ? (_openBlock$3(), _createBlock$3(_component_VBtn, {
                                      ...
                                      default: _withCtx$3(() => [...(_cache[78] || (_cache[78] = [
                                        _createTextVNode$3("修改全部候选", -1)
                                      ]))]),
                                      _: 1
                                    }, 8, ["loading", "disabled", "onClick"]))
                                  : _createCommentVNode$3("", true)
                              ]),
                              _createElementVNode$3("div", _hoisted_34$2, _toDisplayString$3(result.reason), 1),
                              (result.mapped_target_path)
                                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_35$2, [
                                    _cache[79] || (_cache[79] = _createElementVNode$3("span", null, "实际比较路径", -1)),
                                    _createElementVNode$3("code", null, _toDisplayString$3(result.mapped_target_path), 1)
                                  ]))
                                : _createCommentVNode$3("", true),
                              (result.item_name)
                                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_36$2, _toDisplayString$3(result.item_name) + " · " + _toDisplayString$3(result.item_path || '路径未知'), 1))
                                : _createCommentVNode$3("", true),
                              (result.existing_group_id)
                                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_37$2, "当前 TmdbEg：" + _toDisplayString$3(result.existing_group_id), 1))
                                : _createCommentVNode$3("", true),
                              (result.candidates?.length)
                                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_38$2, [
                                    (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(result.candidates, (item) => {
                                      return (_openBlock$3(), _createElementBlock$3("div", {
                                        key: item.item_id
                                      }, [
                                        _createElementVNode$3("span", null, _toDisplayString$3(item.name), 1),
                                        _createElementVNode$3("code", null, _toDisplayString$3(item.path || '无路径'), 1)
                                      ]))
                                    }), 128))
                                  ]))
                                : _createCommentVNode$3("", true),
                              (Number(result.candidate_count || 0) > Number(result.candidates?.length || 0))
                                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_39$2, " 共 " + _toDisplayString$3(result.candidate_count) + " 个候选，此处仅展示前 " + _toDisplayString$3(result.candidates?.length || 0) + " 个 ", 1))
                                : _createCommentVNode$3("", true),
                              (result.items?.length)
                                ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_40$2, [
                                    (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(result.items, (item) => {
                                      return (_openBlock$3(), _createElementBlock$3("div", {
                                        key: item.item_id
                                      }, [
                                        _createElementVNode$3("span", null, _toDisplayString$3(item.item_name) + " · " + _toDisplayString$3(embyResultText(item.status)), 1),
                                        _createElementVNode$3("code", null, _toDisplayString$3(item.item_path || '无路径'), 1)
                                      ]))
                                    }), 128))
                                  ]))
                                : _createCommentVNode$3("", true)
        ...
        default: _withCtx$3(() => [
          _createVNode$3(_component_VCardItem, null, {
            prepend: _withCtx$3(() => [
              _createVNode$3(_component_VAvatar, {
                ...
                default: _withCtx$3(() => [
                  _createVNode$3(_component_VIcon, { icon: "mdi-progress-clock" })
                ]),
                _: 1
              })
            ]),
            ...
            default: _withCtx$3(() => [
              _createVNode$3(_component_VCardTitle, null, {
                default: _withCtx$3(() => [...(_cache[80] || (_cache[80] = [
                  _createTextVNode$3("联动任务", -1)
                ]))]),
                _: 1
              }),
              _createVNode$3(_component_VCardSubtitle, null, {
                default: _withCtx$3(() => [...(_cache[81] || (_cache[81] = [
                  _createTextVNode$3("任务持久保存，MoviePilot 重启后仍可继续重试", -1)
                ]))]),
                _: 1
              })
            ]),
          ...
          (embySync.value.jobs?.length)
            ? (_openBlock$3(), _createBlock$3(_component_VCardText, {
                ...
                default: _withCtx$3(() => [
                  (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(embySync.value.jobs, (job) => {
                    return (_openBlock$3(), _createBlock$3(_component_VCard, {
                      key: job.id,
                      variant: "tonal",
                      class: "sync-job-card"
                            ...
                            _createElementVNode$3("div", _hoisted_42$2, [
                              ...
                              _createElementVNode$3("div", _hoisted_43$2, [
                                _createElementVNode$3("div", _hoisted_44$2, [
                                  _createElementVNode$3("strong", null, _toDisplayString$3(job.title), 1),
                                  _createVNode$3(_component_VChip, {
                                    size: "x-small",
                                    color: embyResultColor(job.status)
                                  }, {
                                    default: _withCtx$3(() => [
                                      _createTextVNode$3(_toDisplayString$3(embyResultText(job.status)), 1)
                                    ]),
                                    _: 2
                                  }, 1032, ["color"])
                                ]),
                                _createElementVNode$3("div", _hoisted_45$2, "TMDB " + _toDisplayString$3(job.tmdb_id) + " · TmdbEg " + _toDisplayString$3(job.episode_group_id) + " · 已尝试 " + _toDisplayString$3(job.attempts || 0) + " 次", 1),
                                _createElementVNode$3("div", _hoisted_46$2, _toDisplayString$3(job.reason), 1),
                                _createElementVNode$3("div", {
                                  class: "text-caption text-medium-emphasis text-truncate mt-1",
                                  title: job.target_path
                                }, _toDisplayString$3(job.target_path), 9, _hoisted_47$2),
                                (Object.keys(job.server_results || {}).length)
                                  ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_48$2, [
                                      (_openBlock$3(true), _createElementBlock$3(_Fragment$3, null, _renderList$3(job.server_results, (result, server) => {
                                        return (_openBlock$3(), _createBlock$3(_component_VChip, {
                                          key: server,
                                          size: "x-small",
                                          color: embyResultColor(result.status),
                                          ...
                                          default: _withCtx$3(() => [
                                            _createTextVNode$3(_toDisplayString$3(server) + " · " + _toDisplayString$3(embyResultText(result.status)), 1)
                                          ]),
                                          _: 2
                                        }, 1032, ["color", "title"]))
                                      }), 128))
            ...
            : (_openBlock$3(), _createElementBlock$3("div", _hoisted_50$2, [
                _createVNode$3(_component_VIcon, {
                  icon: "mdi-server-network-off",
                  size: "48"
                }),
                _cache[84] || (_cache[84] = _createElementVNode$3("div", null, "尚无剧集组联动任务", -1)),
                _cache[85] || (_cache[85] = _createElementVNode$3("div", { class: "text-caption" }, "启用后，下一次实际使用剧集组规则整理时会自动建立任务。", -1))
              ]))
        ]),
        _: 1
      })
          ...
          default: _withCtx$3(() => [
            _createVNode$3(_component_VCardItem, null, {
              ...
              default: _withCtx$3(() => [
                ...
                _createVNode$3(_component_VCardSubtitle, null, {
                  default: _withCtx$3(() => [...(_cache[87] || (_cache[87] = [
            ...
            _createVNode$3(_component_VCardText, { class: "manual-rule-form" }, {
              default: _withCtx$3(() => [
                ...
                (manualForm.value.specify_quarter)
                  ...
                  : _createCommentVNode$3("", true),
                _cache[88] || (_cache[88] = _createElementVNode$3("div", { class: "text-caption text-medium-emphasis" }, " 不指定时会根据 TMDB 最新有效季的首播日期自动归类；TMDB 缺少日期时会提示补充。 ", -1))
              ]),
              _: 1
            }),
            _createVNode$3(_component_VDivider),
          ...
          ? (_openBlock$3(), _createBlock$3(_component_VCard, { key: 0 }, {
              default: _withCtx$3(() => [
                _createVNode$3(_component_VCardItem, null, {
                  ...
                  default: _withCtx$3(() => [
                    _createVNode$3(_component_VCardTitle, null, {
                      default: _withCtx$3(() => [...(_cache[95] || (_cache[95] = [
                ...
                _createVNode$3(_component_VCardText, null, {
                  default: _withCtx$3(() => [
                    _createElementVNode$3("div", _hoisted_51$2, [
                      _createVNode$3(_component_VSwitch, {
                      ...
                      _createVNode$3(_component_VBtn, {
                        ...
                        default: _withCtx$3(() => [...(_cache[96] || (_cache[96] = [
                    ...
                    (inspection.value?.recommendation)
                      ? (_openBlock$3(), _createBlock$3(_component_VAlert, {
                          ...
                          default: _withCtx$3(() => [
                            _createElementVNode$3("div", _hoisted_53$2, [
                              _createElementVNode$3("span", _hoisted_54$2, [
                    ...
                    (editForm.value.target_type === 'group')
                      ...
                      : _createCommentVNode$3("", true),
                    (selectedGroup.value)
                      ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_55$2, [
                          _createElementVNode$3("div", _hoisted_56$2, [
                            _cache[100] || (_cache[100] = _createElementVNode$3("strong", null, "分季预览", -1)),
                            _createVNode$3(_component_VChip, {
                              size: "x-small",
                              variant: "tonal"
                            }, {
                            ...
                            (selectedGroup.value.seasons?.some(item => item.is_special))
                              ? (_openBlock$3(), _createBlock$3(_component_VChip, {
                                  ...
                                  default: _withCtx$3(() => [...(_cache[99] || (_cache[99] = [
                          ...
                          _createElementVNode$3("div", _hoisted_57$2, [
                                ...
                                _createElementVNode$3("div", _hoisted_58$2, [
                                  ...
                                  (season.is_special)
                                    ? (_openBlock$3(), _createBlock$3(_component_VChip, {
                                        ...
                                        default: _withCtx$3(() => [...(_cache[101] || (_cache[101] = [
                                          _createTextVNode$3("Special", -1)
                                        ]))]),
                                        _: 1
                                      }))
                                    : _createCommentVNode$3("", true),
                                  _createElementVNode$3("span", _hoisted_59$2, _toDisplayString$3(season.name), 1)
                                ]),
                                _createElementVNode$3("div", _hoisted_60$2, _toDisplayString$3(season.episode_count) + " 集 · E" + _toDisplayString$3(String(season.first_episode || 1).padStart(2, '0')) + "–E" + _toDisplayString$3(String(season.last_episode || season.episode_count).padStart(2, '0')), 1),
                                (season.first_air_date || season.last_air_date)
                                  ? (_openBlock$3(), _createElementBlock$3("div", _hoisted_61$2, [
                                      ...
                                      (season.last_air_date && season.last_air_date !== season.first_air_date)
                                        ? (_openBlock$3(), _createElementBlock$3("span", _hoisted_62$2, " → " + _toDisplayString$3(season.last_air_date), 1))
                                        : _createCommentVNode$3("", true)
                                    ]))
                                  : _createCommentVNode$3("", true)
                              ], 2))
                      ...
                      : _createCommentVNode$3("", true),
                    _createElementVNode$3("div", _hoisted_63$2, [
                      _cache[103] || (_cache[103] = _createElementVNode$3("strong", null, "季度片段", -1)),
                      _createVNode$3(_component_VSpacer),
                      _createVNode$3(_component_VBtn, {
                        size: "small",
                        variant: "tonal",
                        ...
                        default: _withCtx$3(() => [...(_cache[102] || (_cache[102] = [
                              ...
                              _createVNode$3(_component_VExpansionPanelText, null, {
                                default: _withCtx$3(() => [
                                  ...
                                  _createVNode$3(_component_VBtn, {
                                    ...
                                    default: _withCtx$3(() => [...(_cache[104] || (_cache[104] = [
...
const EpisodeNormalizer = /*#__PURE__*/_export_sfc(_sfc_main$3, [['__scopeId',"data-v-e3e306f7"]]);
...
const _hoisted_5$2 = { class: "filter-row mb-3" };
const _hoisted_6$2 = { class: "text-caption text-medium-emphasis mb-2" };
const _hoisted_7$2 = { class: "font-weight-medium" };
const _hoisted_8$2 = { class: "d-flex align-center ga-2" };
const _hoisted_9$2 = ["title"];
const _hoisted_10$2 = {
  key: 0,
  class: "text-caption text-medium-emphasis"
};
const _hoisted_11$2 = { class: "text-caption text-medium-emphasis" };
const _hoisted_12$2 = { key: 4 };
const _hoisted_13$2 = { class: "filter-row mb-3" };
const _hoisted_14$2 = { class: "font-weight-medium" };
const _hoisted_15$2 = { class: "rule-pattern" };
const _hoisted_16$2 = { key: 5 };
const _hoisted_17$2 = { class: "probe-settings-grid mb-4" };
const _hoisted_18$2 = { class: "probe-enable-row" };
const _hoisted_19$1 = { class: "d-flex flex-wrap ga-1" };
const _hoisted_20$1 = {
  key: 0,
  class: "text-caption text-medium-emphasis"
};
const _hoisted_21$1 = { class: "text-caption text-medium-emphasis" };
const _hoisted_22$1 = { class: "probe-field-list" };
const _hoisted_23$1 = { class: "probe-field-main" };
const _hoisted_24$1 = { class: "font-weight-medium" };
const _hoisted_25$1 = { class: "text-caption text-medium-emphasis" };
const _hoisted_26$1 = { class: "subtitle-mapping-box" };
const _hoisted_27$1 = { class: "probe-advanced-grid" };
const _hoisted_28$1 = {
  key: 0,
  class: "mt-3"
};
const _hoisted_29$1 = { class: "d-flex justify-end" };
const _hoisted_30$1 = { class: "d-flex flex-wrap ga-2" };
const _hoisted_31$1 = { class: "probe-result-grid" };
const _hoisted_32$1 = { class: "text-caption text-medium-emphasis" };
const _hoisted_33$1 = { class: "text-caption text-medium-emphasis" };
const _hoisted_34$1 = { class: "probe-result-grid" };
const _hoisted_35$1 = { class: "text-caption text-medium-emphasis" };
const _hoisted_36$1 = { key: 6 };
...
const _hoisted_40$1 = { class: "flex-grow-1 min-w-0" };
const _hoisted_41$1 = { class: "d-flex align-center ga-2" };
const _hoisted_42$1 = { class: "font-weight-medium mt-1" };
...
const _hoisted_46$1 = { class: "rename-preview-form" };
const _hoisted_47$1 = {
  key: 0,
  class: "preview-output mt-4"
};
const _hoisted_48$1 = { class: "text-right text-break" };
const _hoisted_49$1 = { class: "d-flex align-center ga-3" };
const _hoisted_50$1 = { class: "font-weight-medium" };
const _hoisted_51$1 = { class: "field-description-grid" };
const _hoisted_52$1 = { class: "field-description-head" };
const _hoisted_53$1 = { class: "field-description-label" };
const _hoisted_54$1 = { class: "field-description-text" };
const _hoisted_55$1 = { class: "field-value-summary" };
const _hoisted_56$1 = { class: "text-truncate" };
const _hoisted_57$1 = { class: "field-card-actions" };
const _hoisted_58$1 = {
  key: 0,
  class: "empty-fields compact-empty"
};
const _hoisted_59$1 = { class: "naming-default-grid" };
const _hoisted_60$1 = { class: "separator-scope rule-enabled-box" };
const _hoisted_61$1 = { key: 2 };
const _hoisted_62$1 = { class: "d-flex align-center flex-wrap ga-3 mb-4" };
const _hoisted_63$1 = {
  key: 1,
  class: "group-layout-grid"
};
const _hoisted_64$1 = { class: "group-layout-main" };
const _hoisted_65$1 = { class: "d-flex align-center flex-wrap ga-2" };
const _hoisted_66$1 = { class: "font-weight-bold" };
const _hoisted_67$1 = { class: "mapping-expression" };
const _hoisted_68$1 = { class: "text-caption text-medium-emphasis" };
const _hoisted_69$1 = { class: "d-flex" };
const _hoisted_70$1 = {
  key: 2,
  class: "empty-fields"
};
const _hoisted_71$1 = { class: "group-preview-form" };
const _hoisted_72$1 = { class: "text-caption mt-1" };
const _hoisted_73$1 = {
  key: 0,
  class: "member-trace mt-3"
};
const _hoisted_74$1 = { key: 0 };
const _hoisted_75$1 = { key: 3 };
const _hoisted_76 = { class: "d-flex align-center flex-wrap ga-3 mb-4" };
const _hoisted_77 = {
  key: 1,
  class: "mapping-list"
};
const _hoisted_78 = { class: "flex-grow-1 min-w-0" };
const _hoisted_79 = { class: "d-flex align-center flex-wrap ga-2" };
const _hoisted_80 = { class: "font-weight-bold" };
const _hoisted_81 = { class: "mapping-expression" };
const _hoisted_82 = { class: "text-caption text-medium-emphasis" };
const _hoisted_83 = {
  key: 2,
  class: "empty-fields"
};
const _hoisted_84 = { class: "mapping-preview-form final-mapping-preview" };
const _hoisted_85 = { class: "text-caption mt-1" };
const _hoisted_86 = { key: 7 };
const _hoisted_87 = { class: "overlay-preview-form" };
const _hoisted_88 = { class: "overlay-preview-actions" };
const _hoisted_89 = { class: "supplement-field-grid" };
const _hoisted_90 = { class: "supplement-field-grid" };
const _hoisted_91 = { class: "field-detail-meta" };
const _hoisted_92 = { class: "field-detail-section" };
const _hoisted_93 = { class: "field-detail-section" };
const _hoisted_94 = { class: "field-detail-section" };
const _hoisted_95 = { class: "field-detail-section" };
const _hoisted_96 = { class: "field-syntax-block" };
const _hoisted_97 = { class: "rule-enabled-box" };
const _hoisted_98 = { class: "rule-enabled-box" };
const _hoisted_99 = { class: "rule-enabled-box" };
const _hoisted_100 = { class: "rule-enabled-box" };
...
const section = ref$2(props.mode === 'naming' ? 'mapping' : 'rules');
const search = ref$2('');
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$2(), _createElementBlock$2("div", null, [
    ...
    _createElementVNode$2("div", _hoisted_1$2, [
      (props.mode === 'naming')
        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_2$2, [...(_cache[85] || (_cache[85] = [
        ...
        : (_openBlock$2(), _createElementBlock$2("div", _hoisted_3$2, [...(_cache[86] || (_cache[86] = [
            ...
            (props.mode === 'naming')
              ...
              : (_openBlock$2(), _createElementBlock$2(_Fragment$2, { key: 1 }, [
                  _createVNode$2(_component_VSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[3] || (_cache[3] = $event => ((config.value.recognition_rule_overrides_enabled) = $event)),
                    color: "primary",
                    label: "启用识别字段覆盖",
                    "hide-details": ""
                  }, null, 8, ["modelValue"]),
                  _createVNode$2(_component_VSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[4] || (_cache[4] = $event => ((config.value.release_group_assist_enabled) = $event)),
                    color: "success",
                    label: "制作组辅助 TMDB 判断",
                    "hide-details": ""
                  }, null, 8, ["modelValue"]),
                  _createVNode$2(_component_VSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[5] || (_cache[5] = $event => ((config.value.release_group_field_supplements_enabled) = $event)),
                    color: "secondary",
                    label: "制作组补充命名字段",
                    "hide-details": ""
                  }, null, 8, ["modelValue"]),
                  _createVNode$2(_component_VSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[6] || (_cache[6] = $event => ((config.value.media_probe_enabled) = $event)),
                    color: "orange",
                    label: "整理前扫描媒体流",
                    "hide-details": ""
                  }, null, 8, ["modelValue"])
    ...
    _createVNode$2(_component_VAlert, {
      ...
      default: _withCtx$2(() => [
        _createTextVNode$2(_toDisplayString$2(props.mode === 'naming' ? '实际顺序：连接与分隔、制作组编排和自定义字段参与 MoviePilot 模板渲染；文本映射最后处理完整相对路径与字幕后缀。' : '字段补充与媒体扫描都发生在命名渲染前，不修改源文件；默认只填补 MP 尚未识别出的空字段。'), 1)
      ]),
      _: 1
    }),
    ...
    (props.mode !== 'naming' && section.value === 'rules')
      ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_4$2, [
          ...
          _createElementVNode$2("div", _hoisted_6$2, "当前 MP 共读取 " + _toDisplayString$2(data.value.recognition_rules?.count || 0) + " 条，已覆盖 " + _toDisplayString$2(data.value.recognition_rules?.override_count || 0) + " 条；筛选结果 " + _toDisplayString$2(rules.value.length) + " 条。", 1),
          _createVNode$2(_component_VTable, {
            density: "comfortable",
            class: "tools-table"
          }, {
            default: _withCtx$2(() => [
              _cache[96] || (_cache[96] = _createElementVNode$2("thead", null, [
                ...
                (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(pagedRules.value, (item) => {
                  return (_openBlock$2(), _createElementBlock$2("tr", {
                    ...
                    _createElementVNode$2("td", null, [
                      _createElementVNode$2("div", _hoisted_7$2, _toDisplayString$2(item.field_label), 1),
                    ...
                    _createElementVNode$2("td", null, [
                      ...
                      }, _toDisplayString$2(item.effective?.pattern || item.pattern), 9, _hoisted_9$2),
                      (item.overridden && item.builtin && item.effective?.pattern !== item.pattern)
                        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_10$2, "MP 原正则：" + _toDisplayString$2(item.pattern), 1))
                        : _createCommentVNode$2("", true),
                      _createElementVNode$2("div", _hoisted_11$2, _toDisplayString$2(item.effective?.action === 'clear' ? '命中后清空字段' : `输出：${item.effective?.value ?? item.value}`), 1)
                    ]),
                    _createElementVNode$2("td", null, [
      ...
      : (section.value === 'groups')
        ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_12$2, [
            ...
            _createVNode$2(_component_VTable, {
              ...
              default: _withCtx$2(() => [
                _cache[97] || (_cache[97] = _createElementVNode$2("thead", null, [
                  _createElementVNode$2("tr", null, [
                ...
                _createElementVNode$2("tbody", null, [
                  (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(pagedGroups.value, (item) => {
                    return (_openBlock$2(), _createElementBlock$2("tr", {
                      ...
                      _createElementVNode$2("td", null, [
                        _createElementVNode$2("div", _hoisted_14$2, _toDisplayString$2(item.display_name), 1),
                        _createElementVNode$2("div", _hoisted_15$2, _toDisplayString$2(item.pattern), 1)
                      ]),
                      _createElementVNode$2("td", null, [
                        _createVNode$2(_component_VChip, {
                          size: "small",
        ...
        : (props.mode !== 'naming' && section.value === 'probe')
          ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_16$2, [
                        ...
                        (!mediaProbeBackendSupported.value)
                          ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                              ...
                              default: _withCtx$2(() => [...(_cache[100] || (_cache[100] = [
                                _createTextVNode$2("新版页面已加载，但插件后端仍是旧实例，因此字段目录显示为空且能力会被误报为 unavailable。请在 MP 插件页重载插件；没有重载入口时重启一次 MP 容器。", -1)
                              ]))]),
                              _: 1
                            }))
                          : (_openBlock$2(), _createBlock$2(_component_VAlert, {
                        ...
                        _createElementVNode$2("div", _hoisted_18$2, [
                          ...
                          _createElementVNode$2("div", _hoisted_19$1, [
                            ...
                            (!selectedProbeFieldItems.value.length)
                              ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_20$1, "尚未选择扫描项"))
                              : _createCommentVNode$2("", true)
                          ])
                        ]),
                                ...
                                _createVNode$2(_component_VExpansionPanelTitle, null, {
                                  default: _withCtx$2(() => [
                                    _createElementVNode$2("div", null, [
                                      _cache[101] || (_cache[101] = _createElementVNode$2("div", { class: "font-weight-medium" }, "扫描字段与写入策略", -1)),
                                      _createElementVNode$2("div", _hoisted_21$1, "已选择 " + _toDisplayString$2(selectedProbeFieldItems.value.length) + " / " + _toDisplayString$2(mediaProbeFieldItems.length) + " 项；每项可补空、覆盖或追加", 1)
                                    ])
                                  ]),
                                  _: 1
                                }),
                                      ...
                                      (_openBlock$2(), _createElementBlock$2(_Fragment$2, null, _renderList$2(mediaProbeFieldItems, (item) => {
                                        return _createElementVNode$2("div", {
                                          ...
                                          _createElementVNode$2("div", _hoisted_23$1, [
                                            ...
                                            _createElementVNode$2("div", _hoisted_25$1, _toDisplayString$2(item.detail), 1)
                                          ]),
                                          _createVNode$2(_component_VSelect, {
                                      ...
                                      default: _withCtx$2(() => [
                                        _createElementVNode$2("div", _hoisted_26$1, [
                                          ...
                                          _createVNode$2(_component_VTextarea, {
                                            ...
                                            rows: "4",
                                            "auto-grow": "",
                                            placeholder: "简体+繁体 => 简繁内封",
                                            hint: "精确匹配容器内字幕语言集合；支持简体、繁体、日语、英语、韩语。",
                                            "persistent-hint": ""
                                          }, null, 8, ["modelValue"]),
                                          _cache[104] || (_cache[104] = _createElementVNode$2("div", { class: "text-caption text-medium-emphasis" }, "可扫描 MKV/MP4 中独立存在的内封字幕流；烧录进画面的硬字幕没有字幕轨，ffprobe 无法判断语言。", -1))
                                        ])
                                      ]),
                                      _: 1
                                    })
                                  ...
                                  default: _withCtx$2(() => [
                                    ...
                                    (mediaProbeBackendSupported.value && !data.value.media_probe?.available)
                                      ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_28$1, [
                                          _cache[107] || (_cache[107] = _createElementVNode$2("div", { class: "text-body-2 mb-2" }, [
                                          ...
                                          _cache[108] || (_cache[108] = _createElementVNode$2("ol", { class: "ffprobe-help" }, [
                              ...
                              _createElementVNode$2("div", _hoisted_31$1, [
                                (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(probeStandardPreviewItems.value, (item) => {
                                  return (_openBlock$2(), _createElementBlock$2("div", {
                                    key: item.key,
                                    class: "probe-result-item"
                                  }, [
                                    _createElementVNode$2("div", null, [
                                      _createElementVNode$2("div", _hoisted_32$1, _toDisplayString$2(item.label), 1),
                                      _createElementVNode$2("code", null, _toDisplayString$2(item.key), 1)
                                    ]),
                                    _createElementVNode$2("span", null, _toDisplayString$2(item.value ?? '—'), 1)
                                  ]))
                                }), 128))
                              ]),
                                  ...
                                  _createVNode$2(_component_VExpansionPanel, null, {
                                    default: _withCtx$2(() => [
                                      _createVNode$2(_component_VExpansionPanelTitle, null, {
                                        default: _withCtx$2(() => [
                                          _createElementVNode$2("div", null, [
                                            _cache[116] || (_cache[116] = _createElementVNode$2("div", { class: "font-weight-medium" }, "查看全部 Jinja2 扫描变量", -1)),
                                            _createElementVNode$2("div", _hoisted_33$1, [
                                              _createTextVNode$2(_toDisplayString$2(probeContextPreviewItems.value.length) + " 个 ", 1),
                                              _cache[114] || (_cache[114] = _createElementVNode$2("code", null, "probe_*", -1)),
                                              _cache[115] || (_cache[115] = _createTextVNode$2(" 字段；0 是有效结果，— 表示文件未提供相应信息", -1))
                                            ])
                                          ])
                                        ]),
                                        _: 1
                                        ...
                                        default: _withCtx$2(() => [
                                          _createElementVNode$2("div", _hoisted_34$1, [
                                            (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(probeContextPreviewItems.value, (item) => {
                                              return (_openBlock$2(), _createElementBlock$2("div", {
                                                key: item.key,
                                                class: "probe-result-item probe-context-result"
                                              }, [
                                                _createElementVNode$2("div", null, [
                                                  _createElementVNode$2("div", _hoisted_35$1, _toDisplayString$2(item.label), 1),
                                                  _createElementVNode$2("code", null, _toDisplayString$2(item.key), 1)
                                                ]),
                                                _createElementVNode$2("span", null, _toDisplayString$2(item.value === '' || item.value == null ? '—' : item.value), 1)
                                              ]))
                                            }), 128))
                                          ])
                                        ]),
          ...
          : (props.mode === 'naming')
            ? (_openBlock$2(), _createElementBlock$2("section", _hoisted_36$1, [
                _createVNode$2(_component_VTabs, {
                  modelValue: renameRuleSection.value,
                  "onUpdate:modelValue": _cache[23] || (_cache[23] = $event => ((renameRuleSection).value = $event)),
                  color: "secondary",
                  class: "sub-tabs mb-4"
                }, {
                  default: _withCtx$2(() => [
                ...
                (renameRuleSection.value === 'fields')
                  ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_37$1, [
                      _createElementVNode$2("div", _hoisted_38$1, [
                        _cache[122] || (_cache[122] = _createElementVNode$2("div", { class: "flex-grow-1" }, [
                        ...
                        _createVNode$2(_component_VBtn, {
                          color: "primary",
                          "prepend-icon": "mdi-plus",
                          onClick: _cache[24] || (_cache[24] = $event => (openRenameField()))
                        }, {
                            ...
                            default: _withCtx$2(() => [
                              (customFields.value.length)
                                    ...
                                    (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(customFields.value, (item) => {
                                      return (_openBlock$2(), _createElementBlock$2("div", {
                                        ...
                                        _createElementVNode$2("div", _hoisted_40$1, [
                                          ...
                                          _createElementVNode$2("div", _hoisted_42$1, _toDisplayString$2(item.label || item.key), 1),
                                          _createElementVNode$2("div", {
                                            class: "rule-pattern text-truncate",
                                            title: item.expression
                                          }, _toDisplayString$2(item.expression), 9, _hoisted_43$1),
                                          (item.dependencies?.length)
                                            ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_44$1, "依赖：" + _toDisplayString$2(item.dependencies.join('、')), 1))
                                            : _createCommentVNode$2("", true)
                                        ]),
                                        _createVNode$2(_component_VBtn, {
                                ...
                                : (_openBlock$2(), _createElementBlock$2("div", _hoisted_45$1, [
                                    ...
                                    _cache[125] || (_cache[125] = _createElementVNode$2("div", { class: "mt-2" }, "尚未定义自定义字段", -1)),
                                    _cache[126] || (_cache[126] = _createElementVNode$2("div", { class: "text-caption mt-1" }, "需要时点击右上角“新增字段”", -1))
                                  ]))
                            ]),
                            _: 1
                          })
                            ...
                            default: _withCtx$2(() => [
                              _createElementVNode$2("div", _hoisted_46$1, [
                                _createVNode$2(_component_VTextarea, {
                                  ...
                                  "onUpdate:modelValue": _cache[25] || (_cache[25] = $event => ((renamePreviewInput.value.original_name) = $event)),
                                ...
                                _createVNode$2(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[26] || (_cache[26] = $event => ((renamePreviewInput.value.type) = $event)),
                                  label: "媒体类型 type",
                                  "hide-details": ""
                                }, null, 8, ["modelValue"]),
                                _createVNode$2(_component_VTextField, {
                                  modelValue: renamePreviewInput.value.category,
                                  "onUpdate:modelValue": _cache[27] || (_cache[27] = $event => ((renamePreviewInput.value.category) = $event)),
                                  label: "二级分类 category",
                                  "hide-details": ""
                                }, null, 8, ["modelValue"]),
                                _createVNode$2(_component_VTextField, {
                                  modelValue: renamePreviewInput.value.source_path,
                                  "onUpdate:modelValue": _cache[28] || (_cache[28] = $event => ((renamePreviewInput.value.source_path) = $event)),
                                  label: "真实源路径 source_path",
                                  "hide-details": ""
                                }, null, 8, ["modelValue"]),
                                _createVNode$2(_component_VTextField, {
                                  modelValue: renamePreviewInput.value.target_dir,
                                  "onUpdate:modelValue": _cache[29] || (_cache[29] = $event => ((renamePreviewInput.value.target_dir) = $event)),
                                ...
                                ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_47$1, [
                                    (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(renamePreview.value.values, (value, key) => {
                                      return (_openBlock$2(), _createElementBlock$2("div", {
                                        ...
                                        _createElementVNode$2("span", _hoisted_48$1, _toDisplayString$2(value || '（空）'), 1)
                                      ]))
                                    }), 128)),
                          ...
                          _createVNode$2(_component_VCardText, null, {
                            default: _withCtx$2(() => [
                              ...
                              _createVNode$2(_component_VTextField, {
                                ...
                                "onUpdate:modelValue": _cache[30] || (_cache[30] = $event => ((renameFieldSearch).value = $event)),
                                label: "搜索字段名称、变量或用途",
                                "prepend-inner-icon": "mdi-magnify",
                                clearable: "",
                                "hide-details": "",
                              ...
                              _createVNode$2(_component_VExpansionPanels, {
                                ...
                                "onUpdate:modelValue": _cache[31] || (_cache[31] = $event => ((openRenameFieldGroups).value = $event)),
                                multiple: "",
                                variant: "accordion",
                                class: "field-panels"
                              }, {
                                        ...
                                        _createVNode$2(_component_VExpansionPanelTitle, null, {
                                          default: _withCtx$2(() => [
                                            _createElementVNode$2("div", _hoisted_49$1, [
                                              _createElementVNode$2("span", _hoisted_50$1, _toDisplayString$2(group.category), 1),
                                              _createVNode$2(_component_VChip, {
                                                size: "x-small",
                                                variant: "tonal"
                                              }, {
                                            ...
                                            _createElementVNode$2("div", _hoisted_51$1, [
                                              (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(group.items, (item) => {
                                                return (_openBlock$2(), _createElementBlock$2("div", {
                                                  ...
                                                  _createElementVNode$2("div", _hoisted_53$1, _toDisplayString$2(item.label), 1),
                                                  _createElementVNode$2("div", _hoisted_54$1, _toDisplayString$2(item.description), 1),
                                                  _createElementVNode$2("div", _hoisted_55$1, [
                                                    _createElementVNode$2("span", null, _toDisplayString$2(item.type || '文本'), 1),
                                                    _createElementVNode$2("span", _hoisted_56$1, _toDisplayString$2(item.values || '按上下文决定'), 1)
                                                  ]),
                              ...
                              (!renameFieldGroups.value.length)
                                ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_58$1, "没有匹配的字段"))
                                : _createCommentVNode$2("", true)
                            ]),
                            _: 1
                          })
                          ...
                          default: _withCtx$2(() => [
                            ...
                            _createElementVNode$2("div", _hoisted_59$1, [
                              _createVNode$2(_component_VCombobox, {
                                ...
                                "onUpdate:modelValue": _cache[32] || (_cache[32] = $event => ((config.value.rename_default_separator) = $event)),
                                label: "字段空白分隔符",
                              ...
                              _createVNode$2(_component_VCombobox, {
                                ...
                                "onUpdate:modelValue": _cache[33] || (_cache[33] = $event => ((config.value.customization_separator) = $event)),
                                label: "自定义占位符连接符",
                                items: separatorOptions,
                                "item-title": "title",
                                "item-value": "value",
                              ...
                              _createVNode$2(_component_VCombobox, {
                                ...
                                "onUpdate:modelValue": _cache[34] || (_cache[34] = $event => ((config.value.release_group_default_connector) = $event)),
                                label: "制作组默认连接符",
                                items: separatorOptions,
                                "item-title": "title",
                                "item-value": "value",
                              ...
                              _createVNode$2(_component_VSelect, {
                                ...
                                "onUpdate:modelValue": _cache[35] || (_cache[35] = $event => ((config.value.rename_separator_fields) = $event)),
                              ...
                              _createElementVNode$2("div", _hoisted_60$1, [
                                _cache[136] || (_cache[136] = _createElementVNode$2("div", null, [
                                ...
                                _createVNode$2(_component_VSwitch, {
                                  ...
                                  "onUpdate:modelValue": _cache[36] || (_cache[36] = $event => ((config.value.release_group_normalize_unknown_connectors) = $event)),
                                  color: "success",
                                  "hide-details": ""
                                }, null, 8, ["modelValue"])
                              ])
                        ...
                        _createVNode$2(_component_VCardActions, null, {
                          default: _withCtx$2(() => [
                            ...
                            _createVNode$2(_component_VBtn, {
                              ...
                              "prepend-icon": "mdi-content-save",
                              loading: __props.savingConfig,
                              onClick: _cache[37] || (_cache[37] = $event => (emit('save-config')))
                            }, {
                ...
                (renameRuleSection.value === 'groups')
                  ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_61$1, [
                      _createElementVNode$2("div", _hoisted_62$1, [
                        ...
                        _createVNode$2(_component_VBtn, {
                          color: "primary",
                          "prepend-icon": "mdi-plus",
                          onClick: _cache[38] || (_cache[38] = $event => (openGroupArrangement()))
                        }, {
                      ...
                      (groupArrangementRules.value.length)
                        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_63$1, [
                                    ...
                                    default: _withCtx$2(() => [
                                      _createElementVNode$2("div", _hoisted_64$1, [
                                        _createElementVNode$2("div", _hoisted_65$1, [
                                          _createElementVNode$2("span", _hoisted_66$1, _toDisplayString$2(item.label || item.output_name), 1),
                                          _createVNode$2(_component_VChip, {
                                            size: "x-small",
                                            color: "primary",
                                            variant: "tonal"
                        ...
                        : (_openBlock$2(), _createElementBlock$2("div", _hoisted_70$1, [
                            ...
                            _cache[141] || (_cache[141] = _createElementVNode$2("div", { class: "mt-2" }, "尚未设置制作组编排", -1)),
                            _cache[142] || (_cache[142] = _createElementVNode$2("div", { class: "text-caption mt-1" }, "例如让 VCB-Studio 固定最后并使用 &，让 ADWeb 固定最后并使用 @", -1))
                          ])),
                      _createVNode$2(_component_VCard, {
                        variant: "outlined",
                        class: "mt-4"
                            ...
                            default: _withCtx$2(() => [
                              _createElementVNode$2("div", _hoisted_71$1, [
                                _createVNode$2(_component_VTextField, {
                                  ...
                                  "onUpdate:modelValue": _cache[39] || (_cache[39] = $event => ((groupArrangementPreviewInput).value = $event)),
                                  label: "输入制作组",
                              ...
                              (groupArrangementPreview.value)
                                ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                                    ...
                                    default: _withCtx$2(() => [
                                      _createElementVNode$2("div", null, [
                                        _cache[146] || (_cache[146] = _createTextVNode$2("输出：", -1)),
                                        _createElementVNode$2("code", null, _toDisplayString$2(groupArrangementPreview.value.output), 1)
                                      ]),
                                      _createElementVNode$2("div", _hoisted_72$1, _toDisplayString$2(groupArrangementPreview.value.trace?.reason), 1),
                                        ...
                                        ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_73$1, [
                                            (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(groupArrangementPreview.value.trace.members, (member, index) => {
                                              return (_openBlock$2(), _createBlock$2(_component_VChip, {
                                                ...
                                                default: _withCtx$2(() => [
                                                  index
                                                    ? (_openBlock$2(), _createElementBlock$2("span", _hoisted_74$1, _toDisplayString$2(member.connector === ' ' ? '空格' : member.connector), 1))
                                                    : _createCommentVNode$2("", true),
                  ...
                  : (renameRuleSection.value === 'text')
                    ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_75$1, [
                        _createElementVNode$2("div", _hoisted_76, [
                          _createVNode$2(_component_VAlert, {
                            type: "info",
                            variant: "tonal",
                            density: "compact",
                          ...
                          _createVNode$2(_component_VBtn, {
                            color: "primary",
                            "prepend-icon": "mdi-plus",
                            onClick: _cache[40] || (_cache[40] = $event => (openMappingRule()))
                          }, {
                        ...
                        (mappingRules.value.length)
                          ? (_openBlock$2(), _createElementBlock$2("div", _hoisted_77, [
                                  ...
                                  default: _withCtx$2(() => [
                                    _createVNode$2(_component_VCardText, { class: "d-flex align-start ga-3" }, {
                                      default: _withCtx$2(() => [
                                        ...
                                        _createElementVNode$2("div", _hoisted_78, [
                                          _createElementVNode$2("div", _hoisted_79, [
                                            _createElementVNode$2("span", _hoisted_80, _toDisplayString$2(item.label), 1),
                                            _createVNode$2(_component_VChip, {
                                              size: "x-small",
                                              variant: "tonal"
                                            }, {
                                          ...
                                          _createElementVNode$2("div", _hoisted_82, "优先级 " + _toDisplayString$2(item.priority), 1)
                                        ]),
                                        _createVNode$2(_component_VBtn, {
                                          icon: "mdi-pencil-outline",
                                          size: "small",
                          ...
                          : (_openBlock$2(), _createElementBlock$2("div", _hoisted_83, [
                              ...
                              _cache[151] || (_cache[151] = _createElementVNode$2("div", { class: "mt-2" }, "尚未设置最终命名规则", -1)),
                              _cache[152] || (_cache[152] = _createElementVNode$2("div", { class: "text-caption mt-1" }, "可先添加简繁字幕预设，或按 MP 模板生成的完整路径建立任意文字替换", -1))
                            ])),
                        _createVNode$2(_component_VCard, {
                          variant: "outlined",
                          class: "mt-4"
                              ...
                              default: _withCtx$2(() => [
                                _createElementVNode$2("div", _hoisted_84, [
                                  _createVNode$2(_component_VTextField, {
                                    ...
                                    "onUpdate:modelValue": _cache[41] || (_cache[41] = $event => ((mappingPreviewInput.value.value) = $event)),
                                    label: "模板生成的完整路径",
                                ...
                                (mappingPreview.value)
                                  ? (_openBlock$2(), _createBlock$2(_component_VAlert, {
                                      ...
                                      default: _withCtx$2(() => [
                                        _createElementVNode$2("div", null, [
                                          _cache[156] || (_cache[156] = _createTextVNode$2("输出：", -1)),
                                          _createElementVNode$2("code", null, _toDisplayString$2(mappingPreview.value.output), 1)
                                        ]),
                                        _createElementVNode$2("div", _hoisted_85, "命中 " + _toDisplayString$2(mappingPreview.value.changes?.length || 0) + " 条规则", 1)
                                      ]),
                                      _: 1
                                    }, 8, ["type"]))
                                  : _createCommentVNode$2("", true)
            ...
            : (_openBlock$2(), _createElementBlock$2("section", _hoisted_86, [
                _createVNode$2(_component_VCard, { variant: "outlined" }, {
                  default: _withCtx$2(() => [
                    _createVNode$2(_component_VCardItem, null, {
                      default: _withCtx$2(() => [
                      ...
                      default: _withCtx$2(() => [
                        _createElementVNode$2("div", _hoisted_87, [
                          _createVNode$2(_component_VTextarea, {
                            ...
                            "onUpdate:modelValue": _cache[42] || (_cache[42] = $event => ((previewTitle).value = $event)),
                            label: "原标题",
                            rows: "3",
                            "auto-grow": "",
                            "hide-details": ""
                        ...
                        (preview.value && !preview.value.changes?.length)
                          ...
                          : (preview.value?.changes?.length)
                            ? (_openBlock$2(), _createBlock$2(_component_VTable, {
                                ...
                                default: _withCtx$2(() => [
                                  _cache[161] || (_cache[161] = _createElementVNode$2("thead", null, [
                                    _createElementVNode$2("tr", null, [
    ...
    _createVNode$2(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[46] || (_cache[46] = $event => ((groupProfileDialog).value = $event)),
      "max-width": "900"
    }, {
      default: _withCtx$2(() => [
          ...
          default: _withCtx$2(() => [
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VSelect, {
                          ...
                          "onUpdate:modelValue": _cache[43] || (_cache[43] = $event => ((groupProfileForm.value.kind) = $event)),
                          label: "内容类型",
                          items: kindItems,
                          "hide-details": ""
                        }, null, 8, ["modelValue"])
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VSelect, {
                          ...
                          "onUpdate:modelValue": _cache[44] || (_cache[44] = $event => ((groupProfileForm.value.field_policy) = $event)),
                          label: "字段写入策略",
                          items: fieldPolicyItems,
                          "hide-details": ""
                        }, null, 8, ["modelValue"])
                          ...
                          default: _withCtx$2(() => [
                            ...
                            _createVNode$2(_component_VExpansionPanelText, null, {
                              default: _withCtx$2(() => [
                                ...
                                _cache[165] || (_cache[165] = _createElementVNode$2("div", { class: "text-caption text-medium-emphasis mt-3" }, "这里填的是该制作组对字段的固定补充值；字段本身的 Jinja 表达式仍在“命名规则 → 自定义字段”维护。", -1))
                              ]),
                              _: 1
                            })
                          ]),
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[45] || (_cache[45] = $event => (groupProfileDialog.value = false))
                }, {
    ...
    _createVNode$2(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[49] || (_cache[49] = $event => ((fieldDetailDialog).value = $event)),
      "max-width": "720"
    }, {
      default: _withCtx$2(() => [
        (fieldDetail.value)
          ? (_openBlock$2(), _createBlock$2(_component_VCard, { key: 0 }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VCardText, { class: "field-detail-body" }, {
                  default: _withCtx$2(() => [
                    _createElementVNode$2("div", _hoisted_91, [
                      _createVNode$2(_component_VChip, {
                        size: "small",
                    ...
                    _createElementVNode$2("div", _hoisted_92, [
                      _cache[168] || (_cache[168] = _createElementVNode$2("div", { class: "field-detail-title" }, "用途", -1)),
                      _createElementVNode$2("div", null, _toDisplayString$2(fieldDetail.value.description), 1)
                    ]),
                    _createElementVNode$2("div", _hoisted_93, [
                      _cache[169] || (_cache[169] = _createElementVNode$2("div", { class: "field-detail-title" }, "可能值与格式", -1)),
                    ...
                    _createElementVNode$2("div", _hoisted_94, [
                      _cache[170] || (_cache[170] = _createElementVNode$2("div", { class: "field-detail-title" }, "生成逻辑 / 使用注意", -1)),
                    ...
                    _createElementVNode$2("div", _hoisted_95, [
                      _cache[171] || (_cache[171] = _createElementVNode$2("div", { class: "field-detail-title" }, "Jinja2 写法", -1)),
                      _createElementVNode$2("code", _hoisted_96, _toDisplayString$2(variableSyntax(fieldDetail.value.key)), 1)
                    ])
                  ]),
                  _: 1
                }),
                ...
                _createVNode$2(_component_VCardActions, null, {
                  default: _withCtx$2(() => [
                    _createVNode$2(_component_VBtn, {
                      ...
                      onClick: _cache[47] || (_cache[47] = $event => (copyVariable(fieldDetail.value.key)))
                    }, {
                    ...
                    _createVNode$2(_component_VBtn, {
                      variant: "text",
                      onClick: _cache[48] || (_cache[48] = $event => (fieldDetailDialog.value = false))
                    }, {
    ...
    _createVNode$2(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[58] || (_cache[58] = $event => ((dialog).value = $event)),
      "max-width": "780"
    }, {
      default: _withCtx$2(() => [
          ...
          default: _withCtx$2(() => [
            ...
            _createVNode$2(_component_VCardText, { class: "rule-dialog-body" }, {
              default: _withCtx$2(() => [
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VSelect, {
                          ...
                          "onUpdate:modelValue": _cache[50] || (_cache[50] = $event => ((form.value.field) = $event)),
                          label: "目标字段",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VSelect, {
                          ...
                          "onUpdate:modelValue": _cache[51] || (_cache[51] = $event => ((form.value.action) = $event)),
                          label: "动作",
                ...
                _createVNode$2(_component_VTextField, {
                  ...
                  "onUpdate:modelValue": _cache[52] || (_cache[52] = $event => ((form.value.label) = $event)),
                  label: "规则名称",
                  "hide-details": ""
                }, null, 8, ["modelValue"]),
                _createVNode$2(_component_VTextarea, {
                  modelValue: form.value.pattern,
                  "onUpdate:modelValue": _cache[53] || (_cache[53] = $event => ((form.value.pattern) = $event)),
                  label: "匹配正则",
                  rows: "4",
                  "auto-grow": "",
                  "hide-details": ""
                ...
                (form.value.action === 'override')
                  ? (_openBlock$2(), _createBlock$2(_component_VTextField, {
                      ...
                      "onUpdate:modelValue": _cache[54] || (_cache[54] = $event => ((form.value.value) = $event)),
                      label: "输出值",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[55] || (_cache[55] = $event => ((form.value.priority) = $event)),
                          type: "number",
                          label: "优先级",
                          hint: "数值越高越先执行",
                          "persistent-hint": ""
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createElementVNode$2("div", _hoisted_97, [
                          _cache[175] || (_cache[175] = _createElementVNode$2("div", null, [
                          ...
                          _createVNode$2(_component_VSwitch, {
                            ...
                            "onUpdate:modelValue": _cache[56] || (_cache[56] = $event => ((form.value.enabled) = $event)),
                            color: "success",
                            "hide-details": ""
                          }, null, 8, ["modelValue"])
                        ])
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[57] || (_cache[57] = $event => (dialog.value = false))
                }, {
    ...
    _createVNode$2(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[65] || (_cache[65] = $event => ((renameDialog).value = $event)),
      "max-width": "820"
    }, {
      default: _withCtx$2(() => [
        _createVNode$2(_component_VCard, null, {
          default: _withCtx$2(() => [
            ...
            _createVNode$2(_component_VCardText, { class: "rule-dialog-body" }, {
              default: _withCtx$2(() => [
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[59] || (_cache[59] = $event => ((renameForm.value.key) = $event)),
                          label: "字段名",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[60] || (_cache[60] = $event => ((renameForm.value.label) = $event)),
                          label: "显示名称"
                        }, null, 8, ["modelValue"])
                      ]),
                      _: 1
                ...
                _createVNode$2(_component_VTextarea, {
                  ...
                  "onUpdate:modelValue": _cache[61] || (_cache[61] = $event => ((renameForm.value.expression) = $event)),
                ...
                _createVNode$2(_component_VTextField, {
                  ...
                  "onUpdate:modelValue": _cache[62] || (_cache[62] = $event => ((renameForm.value.fallback) = $event)),
                  label: "计算失败时的回退值",
                  clearable: ""
                }, null, 8, ["modelValue"]),
                _createElementVNode$2("div", _hoisted_98, [
                  _cache[179] || (_cache[179] = _createElementVNode$2("div", null, [
                  ...
                  _createVNode$2(_component_VSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[63] || (_cache[63] = $event => ((renameForm.value.enabled) = $event)),
                    color: "success",
                    "hide-details": ""
                  }, null, 8, ["modelValue"])
                ]),
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[64] || (_cache[64] = $event => (renameDialog.value = false))
                }, {
                  default: _withCtx$2(() => [...(_cache[181] || (_cache[181] = [
                    _createTextVNode$2("取消", -1)
                  ]))]),
                  _: 1
                }),
    ...
    _createVNode$2(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[75] || (_cache[75] = $event => ((groupArrangementDialog).value = $event)),
      "max-width": "820"
    }, {
      default: _withCtx$2(() => [
        _createVNode$2(_component_VCard, null, {
          default: _withCtx$2(() => [
            ...
            _createVNode$2(_component_VCardText, { class: "rule-dialog-body" }, {
              default: _withCtx$2(() => [
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[66] || (_cache[66] = $event => ((groupArrangementForm.value.match_name) = $event)),
                          label: "识别名称",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[67] || (_cache[67] = $event => ((groupArrangementForm.value.output_name) = $event)),
                          label: "最终显示名称",
                          placeholder: "VCB-Studio",
                          hint: "留空时与识别名称相同",
                          "persistent-hint": ""
                ...
                _createVNode$2(_component_VTextField, {
                  ...
                  "onUpdate:modelValue": _cache[68] || (_cache[68] = $event => ((groupArrangementForm.value.label) = $event)),
                  label: "规则名称",
                  placeholder: "例如：VCB 固定最后"
                }, null, 8, ["modelValue"]),
                _createVNode$2(_component_VTextarea, {
                  modelValue: groupArrangementForm.value.aliases,
                  "onUpdate:modelValue": _cache[69] || (_cache[69] = $event => ((groupArrangementForm.value.aliases) = $event)),
                  label: "其它别名（每行一个）",
                  rows: "3",
                  "auto-grow": "",
                  placeholder: "VCB\nVCB Studio",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VSelect, {
                          ...
                          "onUpdate:modelValue": _cache[70] || (_cache[70] = $event => ((groupArrangementForm.value.position) = $event)),
                          label: "所在位置",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VCombobox, {
                          ...
                          "onUpdate:modelValue": _cache[71] || (_cache[71] = $event => ((groupArrangementForm.value.connector) = $event)),
                          label: "前置连接符",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[72] || (_cache[72] = $event => ((groupArrangementForm.value.order) = $event)),
                          type: "number",
                          label: "同位置排序值",
                          hint: "数值越小越靠前",
                          "persistent-hint": ""
                ...
                _createElementVNode$2("div", _hoisted_99, [
                  _cache[184] || (_cache[184] = _createElementVNode$2("div", null, [
                    _createElementVNode$2("div", { class: "font-weight-medium" }, "启用规则"),
                  ...
                  _createVNode$2(_component_VSwitch, {
                    ...
                    "onUpdate:modelValue": _cache[73] || (_cache[73] = $event => ((groupArrangementForm.value.enabled) = $event)),
                    color: "success",
                    "hide-details": ""
                  }, null, 8, ["modelValue"])
                ]),
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[74] || (_cache[74] = $event => (groupArrangementDialog.value = false))
                }, {
    ...
    _createVNode$2(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[84] || (_cache[84] = $event => ((mappingDialog).value = $event)),
      "max-width": "820"
    }, {
      default: _withCtx$2(() => [
        _createVNode$2(_component_VCard, null, {
          default: _withCtx$2(() => [
            ...
            _createVNode$2(_component_VCardText, { class: "rule-dialog-body" }, {
              default: _withCtx$2(() => [
                _createVNode$2(_component_VSelect, {
                  ...
                  "onUpdate:modelValue": _cache[76] || (_cache[76] = $event => ((mappingForm.value.mode) = $event)),
                  label: "匹配模式",
                  items: [{title:'字面替换',value:'literal'},{title:'正则替换',value:'regex'}]
                }, null, 8, ["modelValue"]),
                _createVNode$2(_component_VTextField, {
                  modelValue: mappingForm.value.label,
                  "onUpdate:modelValue": _cache[77] || (_cache[77] = $event => ((mappingForm.value.label) = $event)),
                  label: "规则名称",
                  placeholder: "例如：统一合作字幕组顺序"
                }, null, 8, ["modelValue"]),
                _createVNode$2(_component_VTextarea, {
                  modelValue: mappingForm.value.pattern,
                  "onUpdate:modelValue": _cache[78] || (_cache[78] = $event => ((mappingForm.value.pattern) = $event)),
                ...
                _createVNode$2(_component_VTextField, {
                  ...
                  "onUpdate:modelValue": _cache[79] || (_cache[79] = $event => ((mappingForm.value.replacement) = $event)),
                  label: "替换为",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createVNode$2(_component_VTextField, {
                          ...
                          "onUpdate:modelValue": _cache[80] || (_cache[80] = $event => ((mappingForm.value.priority) = $event)),
                          type: "number",
                          label: "优先级",
                    ...
                    _createVNode$2(_component_VCol, {
                      ...
                      default: _withCtx$2(() => [
                        _createElementVNode$2("div", _hoisted_100, [
                          _cache[189] || (_cache[189] = _createElementVNode$2("div", null, [
                            _createElementVNode$2("div", { class: "font-weight-medium" }, "启用规则"),
                            _createElementVNode$2("div", { class: "text-caption text-medium-emphasis" }, "停用后保留配置但不执行")
                          ], -1)),
                          _createVNode$2(_component_VSwitch, {
                            modelValue: mappingForm.value.enabled,
                            "onUpdate:modelValue": _cache[81] || (_cache[81] = $event => ((mappingForm.value.enabled) = $event)),
                            color: "success",
                            "hide-details": ""
                          }, null, 8, ["modelValue"])
                        ])
                ...
                _createVNode$2(_component_VAlert, {
                  ...
                  default: _withCtx$2(() => [...(_cache[190] || (_cache[190] = [
            ...
            _createVNode$2(_component_VCardActions, { class: "rule-dialog-actions" }, {
              default: _withCtx$2(() => [
                ...
                _createVNode$2(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[82] || (_cache[82] = $event => (mappingDialog.value = false))
                }, {
                ...
                _createVNode$2(_component_VBtn, {
                  ...
                  onClick: _cache[83] || (_cache[83] = $event => (saveMappingRule()))
                }, {
...
const MetadataTools = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-bff4f074"]]);
...
const _hoisted_25 = { class: "sticky-actions" };
const _hoisted_26 = { class: "text-caption text-medium-emphasis mr-auto" };
const _hoisted_27 = {
  key: 2,
  class: "workspace-panel"
};
...
const _hoisted_33 = { class: "d-flex align-center ga-2" };
const _hoisted_34 = { class: "final-name-output" };
const _hoisted_35 = {
  key: 3,
  class: "best-result"
};
...
const _hoisted_44 = { class: "custom-preview-values mt-2" };
const _hoisted_45 = { key: 0 };
const _hoisted_46 = { key: 0 };
const _hoisted_47 = { class: "d-flex flex-wrap ga-2 mb-4" };
const _hoisted_48 = { class: "text-caption text-medium-emphasis" };
const _hoisted_49 = { class: "text-caption" };
const _hoisted_50 = { class: "text-medium-emphasis" };
...
const _hoisted_57 = { class: "tab-content" };
const _hoisted_58 = { class: "d-flex align-center flex-wrap ga-2 mb-4" };
const _hoisted_59 = {
  key: 0,
  class: "history-list"
};
const _hoisted_60 = { class: "d-flex align-start ga-3" };
const _hoisted_61 = { class: "flex-grow-1" };
const _hoisted_62 = { class: "d-flex flex-wrap align-center ga-2" };
const _hoisted_63 = { class: "font-weight-bold" };
const _hoisted_64 = ["title"];
const _hoisted_65 = { class: "text-caption text-medium-emphasis mt-1" };
const _hoisted_66 = {
  key: 1,
...
const _hoisted_69 = { class: "d-flex flex-wrap ga-1 mt-2" };
const _hoisted_70 = {
  key: 1,
  class: "empty-preview"
};
const _hoisted_71 = { class: "text-h6 mt-3" };
const _hoisted_72 = {
  key: 6,
  class: "workspace-panel"
};
const _hoisted_73 = { class: "tab-content" };
const _hoisted_74 = { class: "workspace-panel" };
const _hoisted_75 = { class: "tab-content" };
  ...
  return (_openBlock(), _createElementBlock("div", _hoisted_1, [
    (!__props.hideTitle)
      ? (_openBlock(), _createElementBlock("div", _hoisted_2, [
          _cache[20] || (_cache[20] = _createElementVNode("div", { class: "hero-glow hero-glow-a" }, null, -1)),
          _cache[21] || (_cache[21] = _createElementVNode("div", { class: "hero-glow hero-glow-b" }, null, -1)),
        ...
        default: _withCtx(() => [
          ...
          _createElementVNode("div", _hoisted_7, [
                      ...
                      default: _withCtx(() => [
                        _createVNode(_component_VCardText, { class: "d-flex align-center flex-wrap ga-4" }, {
                          default: _withCtx(() => [
                            ...
                            _cache[33] || (_cache[33] = _createElementVNode("div", { class: "flex-grow-1" }, [
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_18, [
                                _cache[42] || (_cache[42] = _createElementVNode("span", null, "Emby 剧集组联动", -1)),
                        ...
                        default: _withCtx(() => [
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _cache[44] || (_cache[44] = _createElementVNode("div", { class: "status-line" }, [
                                _createElementVNode("span", null, "分类范围"),
                                _createElementVNode("strong", null, "动漫 / 真人电视剧")
                              ], -1)),
                              _cache[45] || (_cache[45] = _createElementVNode("div", { class: "status-line" }, [
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_19, [
                                _cache[47] || (_cache[47] = _createElementVNode("span", null, "内置规则目录", -1)),
                                _createElementVNode("strong", null, _toDisplayString(modules.value.recognition_rules?.catalog_rules || 0) + " 条", 1)
                              ]),
                              _createElementVNode("div", _hoisted_20, [
                                _cache[48] || (_cache[48] = _createElementVNode("span", null, "已启用覆盖", -1)),
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_21, [
                                _cache[50] || (_cache[50] = _createElementVNode("span", null, "独立字段", -1)),
                          ...
                          _createVNode(_component_VCardText, null, {
                            default: _withCtx(() => [
                              ...
                              _createElementVNode("div", _hoisted_22, [
                                _cache[53] || (_cache[53] = _createElementVNode("span", null, "结构化与文本规则", -1)),
                                _createElementVNode("strong", null, _toDisplayString(modules.value.rename_mapping?.rule_count || 0) + " 条", 1)
                              ]),
                              _cache[54] || (_cache[54] = _createElementVNode("div", { class: "status-line" }, [
              ...
              ? (_openBlock(), _createElementBlock("section", _hoisted_23, [
                  _createElementVNode("div", _hoisted_24, [
                    ...
                    _createElementVNode("div", _hoisted_25, [
                      _createElementVNode("div", _hoisted_26, "近期记忆：" + _toDisplayString(summary.value.recognition_memory?.active_targets || 0) + " 个已生效目标 / " + _toDisplayString(summary.value.recognition_memory?.sample_count || 0) + " 个不同文件", 1),
                      _createVNode(_component_VBtn, {
                        variant: "text",
            ...
            (tab.value === 'naming')
              ? (_openBlock(), _createElementBlock("section", _hoisted_29, [
                  _createElementVNode("div", _hoisted_30, [
                    _createVNode(MetadataTools, {
                      modelValue: config.value,
                      "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((config).value = $event)),
                      mode: "naming",
                      api: __props.api,
                      "plugin-id": __props.pluginId,
                      "saving-config": saving.value,
                                ...
                                _createVNode(_component_VCardText, null, {
                                  default: _withCtx(() => [
                                    ...
                                    _createVNode(_component_VTextarea, {
                                      ...
                                      "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((previewInput.value.title) = $event)),
                                      label: "原标题或已提取标题",
                                      rows: "4",
                                      "auto-grow": "",
                                      variant: "outlined",
                                    ...
                                    _createVNode(_component_VRow, {
                                      ...
                                      default: _withCtx(() => [
                                        _createVNode(_component_VCol, { cols: "6" }, {
                                          default: _withCtx(() => [
                                            _cache[60] || (_cache[60] = _createElementVNode("div", { class: "field-label" }, "年份提示", -1)),
                                            _createVNode(_component_VTextField, {
                                              modelValue: previewInput.value.year,
                                              "onUpdate:modelValue": _cache[14] || (_cache[14] = $event => ((previewInput.value.year) = $event)),
                                              "aria-label": "年份提示",
                                              placeholder: "可选",
                                              variant: "outlined",
                                              density: "comfortable",
                                        ...
                                        _createVNode(_component_VCol, { cols: "6" }, {
                                          default: _withCtx(() => [
                                            _cache[61] || (_cache[61] = _createElementVNode("div", { class: "field-label" }, "类型提示", -1)),
                                            _createVNode(_component_VSelect, {
                                              modelValue: previewInput.value.media_type,
                                              "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((previewInput.value.media_type) = $event)),
                                              "aria-label": "类型提示",
                                        ...
                                        _createVNode(_component_VCol, { cols: "6" }, {
                                          default: _withCtx(() => [
                                            _cache[62] || (_cache[62] = _createElementVNode("div", { class: "field-label" }, "季提示", -1)),
                                            _createVNode(_component_VTextField, {
                                              modelValue: previewInput.value.season,
                                              "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((previewInput.value.season) = $event)),
                                              "aria-label": "季提示",
                                              type: "number",
                                              placeholder: "可选",
                                              variant: "outlined",
                                        ...
                                        _createVNode(_component_VCol, { cols: "6" }, {
                                          default: _withCtx(() => [
                                            _cache[63] || (_cache[63] = _createElementVNode("div", { class: "field-label" }, "集提示", -1)),
                                            _createVNode(_component_VTextField, {
                                              modelValue: previewInput.value.episode,
                                              "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((previewInput.value.episode) = $event)),
                                              "aria-label": "集提示",
                                              type: "number",
                                              placeholder: "可选",
                                              variant: "outlined",
                          ...
                          default: _withCtx(() => [
                            (preview.value)
                                      ...
                                      default: _withCtx(() => [
                                                ...
                                                _createVNode(_component_VCardText, null, {
                                                  default: _withCtx(() => [
                                                    _createElementVNode("div", _hoisted_33, [
                                                      ...
                                                      _cache[66] || (_cache[66] = _createElementVNode("strong", null, "最终命名", -1)),
                                                      _createVNode(_component_VChip, {
                                                        size: "x-small",
                                                        variant: "tonal"
                                                      }, {
                                                    ...
                                                    _createElementVNode("code", _hoisted_34, _toDisplayString(preview.value.final_naming.output), 1)
                                                  ]),
                                                  _: 1
                                                })
                                              ]),
                                        ...
                                        (preview.value.episode_adjustment)
                                          ? (_openBlock(), _createBlock(_component_VAlert, {
                                              ...
                                              default: _withCtx(() => [
                                                _cache[67] || (_cache[67] = _createElementVNode("strong", null, "集数偏移：", -1)),
                                                  ...
                                                  default: _withCtx(() => [
                                                          ...
                                                          (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(preview.value.pipeline, (step) => {
                                                            return (_openBlock(), _createElementBlock("div", {
                                                              ...
                                                              _createElementVNode("div", null, [
                                                                ...
                                                                _createElementVNode("div", _hoisted_40, _toDisplayString(step.summary), 1)
                                                              ])
                                                            ]))
                                                          }), 128))
                                                        ]))
                                                    ...
                                                    (preview.value.release_group_arrangement?.input)
                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_41, [
                                                          _cache[69] || (_cache[69] = _createElementVNode("strong", null, "制作组编排", -1)),
                                                    ...
                                                    (Object.keys(preview.value.custom_rename_fields?.values || {}).length)
                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_43, [
                                                          _cache[70] || (_cache[70] = _createElementVNode("strong", null, "自定义命名字段", -1)),
                                                  ...
                                                  default: _withCtx(() => [
                                                    ...
                                                    (preview.value.recognition_rule_changes?.length)
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            _cache[72] || (_cache[72] = _createTextVNode("识别字段覆盖：", -1)),
                                                      ...
                                                      ? (_openBlock(), _createBlock(_component_VAlert, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            ...
                                                            (preview.value.type_constraint.removed_count)
                                                              ? (_openBlock(), _createElementBlock("span", _hoisted_46, "；排除 " + _toDisplayString(preview.value.type_constraint.removed_count) + " 个冲突候选", 1))
                                                              : _createCommentVNode("", true)
                                                          ]),
                                                          _: 1
                                                        }))
                                                    ...
                                                    (preview.value.web_search?.attempted)
                                                      ...
                                                      : _createCommentVNode("", true),
                                                    _cache[74] || (_cache[74] = _createElementVNode("div", { class: "text-caption text-medium-emphasis mb-2" }, "实际搜索词", -1)),
                                                    ...
                                                    (preview.value.candidates?.length)
                                                      ? (_openBlock(), _createBlock(_component_VTable, {
                                                          ...
                                                          default: _withCtx(() => [
                                                            _cache[73] || (_cache[73] = _createElementVNode("thead", null, [
                                                              ...
                                                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(preview.value.candidates, (candidate) => {
                                                                return (_openBlock(), _createElementBlock("tr", {
                                                                  ...
                                                                  _createElementVNode("td", null, [
                                                                    ...
                                                                    _createElementVNode("div", _hoisted_48, _toDisplayString(candidate.year || '—') + " · #" + _toDisplayString(candidate.tmdb_id), 1)
                                                                  ]),
                                                                  _createElementVNode("td", _hoisted_49, [
                                                                    ...
                                                                    _createElementVNode("div", _hoisted_50, [
                                                                      ...
                                                                      (candidate.web_evidence)
                                                                        ? (_openBlock(), _createElementBlock("span", _hoisted_51, " · 外部证据 " + _toDisplayString(candidate.web_evidence), 1))
                                                                        : _createCommentVNode("", true)
                                                                    ]),
                                                                    (candidate.release_group_evidence?.component !== null)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_52, "制作组 " + _toDisplayString(candidate.release_group_evidence.label) + "：" + _toDisplayString(candidate.release_group_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.seasonal_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_53, "当季 " + _toDisplayString(candidate.seasonal_evidence.quarter) + "：" + _toDisplayString(candidate.seasonal_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.memory_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_54, "近期命中 " + _toDisplayString(candidate.memory_evidence.hits) + " 次：" + _toDisplayString(candidate.memory_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true)
                                                                  ]),
                                                                  _createElementVNode("td", null, [
                                                                    _createVNode(_component_VChip, {
                              ...
                              : (_openBlock(), _createElementBlock("div", _hoisted_55, [
                                  ...
                                  _cache[75] || (_cache[75] = _createElementVNode("div", { class: "text-h6 mt-3" }, "等待一次综合试跑", -1)),
                                  _cache[76] || (_cache[76] = _createElementVNode("div", { class: "text-body-2 text-medium-emphasis" }, "结果会解释从标题解析到最终命名的完整插件链路", -1))
                                ]))
                          ]),
                          _: 1
                        })
              ...
              ? (_openBlock(), _createElementBlock("section", _hoisted_56, [
                  _createElementVNode("div", _hoisted_57, [
                    _createElementVNode("div", _hoisted_58, [
                      _cache[78] || (_cache[78] = _createElementVNode("div", { class: "flex-grow-1" }, [
                      ...
                      _createVNode(_component_VSelect, {
                        ...
                        "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((historyFilter).value = $event)),
                    ...
                    (filteredHistory.value.length)
                                      ...
                                      _createElementVNode("div", _hoisted_60, [
                                        _createElementVNode("div", _hoisted_61, [
                                          _createElementVNode("div", _hoisted_62, [
                                            _createElementVNode("div", _hoisted_63, _toDisplayString(item.title), 1),
                                            _createVNode(_component_VChip, {
                                              size: "x-small",
                                              color: "primary",
                                              variant: "tonal"
                                          ...
                                          (item.original_title)
                                            ? (_openBlock(), _createElementBlock("div", {
                                              ...
                                              }, "原标题：" + _toDisplayString(item.original_title), 9, _hoisted_64))
                                            : _createCommentVNode("", true),
                                          _createElementVNode("div", _hoisted_65, _toDisplayString(item.created_at) + " · " + _toDisplayString(item.reason), 1),
                                          (!item.accepted && item.kind !== 'operation')
                                            ? (_openBlock(), _createElementBlock("div", _hoisted_66, "插件未接管本次候选选择，MoviePilot 仍会继续执行原生识别与整理；这不代表最终整理失败。"))
                                            : _createCommentVNode("", true),
                                          (item.episode_adjustment)
                                            ? (_openBlock(), _createElementBlock("div", _hoisted_67, [
                                                ...
                                                (item.episode_adjustment.season != null)
                                                  ? (_openBlock(), _createElementBlock("span", _hoisted_68, " · S" + _toDisplayString(item.episode_adjustment.season) + "E" + _toDisplayString(item.episode_adjustment.episode), 1))
                                                  : _createCommentVNode("", true)
                                              ]))
                                            : _createCommentVNode("", true),
                      ...
                      : (_openBlock(), _createElementBlock("div", _hoisted_70, [
                          ...
                          _createElementVNode("div", _hoisted_71, _toDisplayString(history.value.length ? '当前筛选没有日志' : '尚无模块日志'), 1)
                        ]))
                  ])
                ]))
              : _createCommentVNode("", true),
            (tab.value === 'diagnostics')
              ...
              : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("section", _hoisted_74, [
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-90cf7fea"]]);
