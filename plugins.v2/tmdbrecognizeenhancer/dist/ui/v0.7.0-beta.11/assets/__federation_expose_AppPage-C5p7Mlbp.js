...
import { S as StrategySettings } from './StrategySettings-BLon_FL8.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-CaKGwCee.js';
                                      ...
                                      default: _withCtx$2(() => [
                                        _createElementVNode$2("div", _hoisted_27$1, [
                                          ...
                                          _createVNode$2(_component_VTextarea, {
                                            ...
                                            label: "字幕组合映射（每行一条，首条命中生效）",
                                            rows: "4",
                                            "auto-grow": "",
                                            placeholder: "简日+繁日 => 简繁日内封",
                                            hint: "双语轨显示为组合标签（简日、繁日）；「简体+繁体+日语」与「简日+繁日」写法可互相命中。「包含:简体+日语 => 简日内封」为子集匹配；「>=4 => 多国字幕」按语言数量。",
                                            "persistent-hint": ""
                                          }, null, 8, ["modelValue"]),
...
const MetadataTools = /*#__PURE__*/_export_sfc(_sfc_main$2, [['__scopeId',"data-v-91f40364"]]);
