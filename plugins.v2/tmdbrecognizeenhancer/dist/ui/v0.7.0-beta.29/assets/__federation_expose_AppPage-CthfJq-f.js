...
import { S as StrategySettings } from './StrategySettings-MC1jtFT5.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-DMTYznfp.js';
                                  ...
                                  (_openBlock$2(true), _createElementBlock$2(_Fragment$2, null, _renderList$2(strmSync.value.jobs, (job) => {
                                    return (_openBlock$2(), _createElementBlock$2("div", {
                                      ...
                                      _createElementVNode$2("div", _hoisted_81$1, [
                                        ...
                                        _createElementVNode$2("div", _hoisted_84, _toDisplayString$2(job.reason) + " · 尝试 " + _toDisplayString$2(job.attempts || 0) + " 次", 1)
                                      ]),
                                      _createVNode$2(_component_VChip, {
                                        size: "small",
...
const _hoisted_53 = { class: "d-flex flex-wrap ga-2 mb-4" };
const _hoisted_54 = { class: "text-caption text-medium-emphasis" };
const _hoisted_55 = { class: "text-caption" };
const _hoisted_56 = { class: "text-medium-emphasis" };
...
const _hoisted_65 = { class: "tab-content" };
const _hoisted_66 = { class: "d-flex align-center flex-wrap ga-2 mb-4" };
const _hoisted_67 = {
  key: 0,
  class: "history-list"
};
                                                              ...
                                                              (_openBlock(true), _createElementBlock(_Fragment, null, _renderList(preview.value.candidates, (candidate) => {
                                                                return (_openBlock(), _createElementBlock("tr", {
                                                                  ...
                                                                  _createElementVNode("td", null, [
                                                                    ...
                                                                    _createElementVNode("div", _hoisted_54, _toDisplayString(candidate.year || '—') + " · #" + _toDisplayString(candidate.tmdb_id), 1)
                                                                  ]),
                                                                  _createElementVNode("td", _hoisted_55, [
                                                                    ...
                                                                    _createElementVNode("div", _hoisted_56, [
                                                                      ...
                                                                      (candidate.web_evidence)
                                                                        ? (_openBlock(), _createElementBlock("span", _hoisted_57, " · 外部证据 " + _toDisplayString(candidate.web_evidence), 1))
                                                                        : _createCommentVNode("", true)
                                                                    ]),
                                                                    (candidate.release_group_evidence?.component !== null)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_58, "制作组 " + _toDisplayString(candidate.release_group_evidence.label) + "：" + _toDisplayString(candidate.release_group_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.seasonal_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_59, "季度目录 " + _toDisplayString(candidate.seasonal_evidence.quarter) + "：" + _toDisplayString(candidate.seasonal_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.memory_evidence?.active)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_60, "近期命中 " + _toDisplayString(candidate.memory_evidence.hits) + " 次：" + _toDisplayString(candidate.memory_evidence.component) + " 分", 1))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.preferred_by_policy)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_61, "命中 TMDB 优先名单"))
                                                                      : _createCommentVNode("", true),
                                                                    (candidate.suppressed_by_exclusion)
                                                                      ? (_openBlock(), _createElementBlock("div", _hoisted_62, "已被 TMDB 排除名单剔除"))
                                                                      : _createCommentVNode("", true)
                                                                  ]),
                                                                  _createElementVNode("td", null, [
                                                                    _createVNode(_component_VChip, {
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-6cd9e223"]]);
