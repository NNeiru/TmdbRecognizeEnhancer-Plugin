...
import { S as StrategySettings } from './StrategySettings-Dvbh_ak4.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-CEQ_V-bn.js';
...
const _hoisted_67 = { class: "d-flex align-center flex-wrap ga-2 mb-4" };
const _hoisted_68 = {
  key: 0,
  class: "history-list"
};
const _hoisted_69 = { class: "d-flex align-start ga-3" };
const _hoisted_70 = { class: "flex-grow-1" };
const _hoisted_71 = { class: "d-flex flex-wrap align-center ga-2" };
const _hoisted_72 = { class: "font-weight-bold" };
const _hoisted_73 = ["title"];
const _hoisted_74 = { class: "text-caption text-medium-emphasis mt-1" };
const _hoisted_75 = {
  key: 1,
...
const _hoisted_78 = { class: "d-flex flex-wrap ga-1 mt-2" };
const _hoisted_79 = {
  key: 1,
  class: "empty-preview"
};
const _hoisted_80 = { class: "text-h6 mt-3" };
const _hoisted_81 = {
  key: 7,
  class: "workspace-panel"
};
const _hoisted_82 = { class: "tab-content" };
const _hoisted_83 = { class: "workspace-panel" };
                  ...
                  _createElementVNode("div", _hoisted_66, [
                    ...
                    (filteredHistory.value.length)
                                      ...
                                      _createElementVNode("div", _hoisted_69, [
                                        _createElementVNode("div", _hoisted_70, [
                                          _createElementVNode("div", _hoisted_71, [
                                            _createElementVNode("div", _hoisted_72, _toDisplayString(item.title), 1),
                                            _createVNode(_component_VChip, {
                                              size: "x-small",
                                              color: "primary",
                                              variant: "tonal"
                                          ...
                                          (item.original_title)
                                            ? (_openBlock(), _createElementBlock("div", {
                                              ...
                                              }, "原标题：" + _toDisplayString(item.original_title), 9, _hoisted_73))
                                            : _createCommentVNode("", true),
                                          _createElementVNode("div", _hoisted_74, _toDisplayString(item.created_at) + " · " + _toDisplayString(item.reason), 1),
                                          (!item.accepted && item.kind !== 'operation')
                                            ? (_openBlock(), _createElementBlock("div", _hoisted_75, "插件未接管本次候选选择，MoviePilot 仍会继续执行原生识别与整理；这不代表最终整理失败。"))
                                            : _createCommentVNode("", true),
                                          (item.episode_adjustment)
                                            ? (_openBlock(), _createElementBlock("div", _hoisted_76, [
                                                ...
                                                (item.episode_adjustment.season != null)
                                                  ? (_openBlock(), _createElementBlock("span", _hoisted_77, " · S" + _toDisplayString(item.episode_adjustment.season) + "E" + _toDisplayString(item.episode_adjustment.episode), 1))
                                                  : _createCommentVNode("", true)
                                              ]))
                                            : _createCommentVNode("", true),
                      ...
                      : (_openBlock(), _createElementBlock("div", _hoisted_79, [
                          ...
                          _createElementVNode("div", _hoisted_80, _toDisplayString(history.value.length ? '当前筛选没有日志' : '尚无模块日志'), 1)
                        ]))
                  ])
                ]))
              : _createCommentVNode("", true),
            (tab.value === 'diagnostics')
              ? (_openBlock(), _createElementBlock("section", _hoisted_81, [
              ...
              : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("section", _hoisted_83, [
...
const AppPage = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-babc689f"]]);
