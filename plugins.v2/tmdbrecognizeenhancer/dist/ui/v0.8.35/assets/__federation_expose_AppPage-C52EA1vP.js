...
import { M as ModuleHeader, S as StrategySettings } from './StrategySettings-BvEseBO4.js';
import { _ as _export_sfc, u as unwrapResponse, c as cloneConfig, U as UI_VERSION, m as mediaTypeText, s as scoreColor, e as ensureUiVersion } from './utils-2dTqbD2c.js';
...
const _hoisted_7$1 = { class: "template-panel-title" };
const _hoisted_8$1 = { class: "notification-template-grid" };
const _hoisted_9$1 = { class: "notification-template-card success" };
const _hoisted_10$1 = { class: "notification-template-card failure" };
const _hoisted_11$1 = { class: "section-shell" };
const _hoisted_12$1 = { class: "section-heading" };
const _hoisted_13$1 = { class: "policy-grid" };
const _hoisted_14$1 = { class: "policy-copy" };
const _hoisted_15$1 = { class: "section-shell" };
const _hoisted_16$1 = { class: "section-heading responsive" };
const _hoisted_17$1 = { class: "delivery-grid" };
const _hoisted_18$1 = { class: "delivery-mode" };
const _hoisted_19$1 = { class: "delivery-mode realtime" };
const _hoisted_20$1 = { class: "candidate-message-style" };
const _hoisted_21$1 = {
  key: 0,
  class: "premium-emoji-help"
};
const _hoisted_22$1 = { class: "candidate-controls" };
const _hoisted_23$1 = { class: "option-row compact" };
const _hoisted_24$1 = {
  key: 2,
  class: "candidate-list"
};
const _hoisted_25$1 = { class: "candidate-toolbar" };
const _hoisted_26$1 = { class: "candidate-actions" };
const _hoisted_27$1 = { class: "candidate-items" };
const _hoisted_28$1 = {
  key: 1,
...
const _hoisted_31$1 = { class: "candidate-toolbar" };
const _hoisted_32$1 = { class: "candidate-actions" };
const _hoisted_33$1 = { class: "candidate-items" };
const _hoisted_34$1 = {
  key: 1,
  class: "candidate-poster candidate-poster-placeholder"
};
const _hoisted_35$1 = { class: "candidate-copy" };
const _hoisted_36$1 = {
  key: 4,
  class: "empty-inline"
};
const _hoisted_37$1 = { class: "section-shell" };
const _hoisted_38$1 = { key: 0 };
const _hoisted_39$1 = { class: "record-toolbar" };
const _hoisted_40$1 = {
  key: 0,
  class: "record-list"
};
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$1(), _createElementBlock$1("div", _hoisted_1$1, [
    ...
    _createElementVNode$1("section", _hoisted_2$1, [
      _cache[48] || (_cache[48] = _createElementVNode$1("div", { class: "section-heading" }, [
      ...
      _createElementVNode$1("div", _hoisted_5$1, [
        ...
        _createVNode$1(_component_VSwitch, {
          ...
          "onUpdate:modelValue": _cache[7] || (_cache[7] = $event => ((config.value.notification_passthrough_manual) = $event)),
          color: "primary",
          "hide-details": "",
          label: "接管时转发其它人工通知"
        }, null, 8, ["modelValue"])
      ...
      _createElementVNode$1("div", _hoisted_6$1, [
        _createVNode$1(_component_VSelect, {
          ...
          "onUpdate:modelValue": _cache[8] || (_cache[8] = $event => ((config.value.notification_success_service) = $event)),
        ...
        _createVNode$1(_component_VSelect, {
          ...
          "onUpdate:modelValue": _cache[9] || (_cache[9] = $event => ((config.value.notification_failure_service) = $event)),
          items: notificationServiceItems.value,
          label: "入库失败通知实例",
          placeholder: "留空则发送到全部插件通知渠道",
          density: "comfortable",
              ...
              _createVNode$1(_component_VExpansionPanelTitle, null, {
                default: _withCtx$1(() => [
                  _createElementVNode$1("div", _hoisted_7$1, [
                    ...
                    _cache[44] || (_cache[44] = _createElementVNode$1("span", null, [
                      _createElementVNode$1("strong", null, "通知样式与 Jinja2 模板"),
                      _createElementVNode$1("small", null, "默认原样使用 MoviePilot 已渲染的通知；只有模板显式引用路径时才会加入路径。")
                    ], -1))
                  ])
                ]),
                _: 1
                  ...
                  _createElementVNode$1("div", _hoisted_8$1, [
                    _createElementVNode$1("div", _hoisted_9$1, [
                      _createElementVNode$1("h4", null, [
                        ...
                        _cache[46] || (_cache[46] = _createTextVNode$1(" 入库成功", -1))
                      ]),
                      _createVNode$1(_component_VTextField, {
                        modelValue: config.value.notification_success_title_template,
                        "onUpdate:modelValue": _cache[10] || (_cache[10] = $event => ((config.value.notification_success_title_template) = $event)),
                        label: "标题模板",
                        variant: "outlined",
                        density: "compact",
                        "hide-details": ""
                      ...
                      _createVNode$1(_component_VTextarea, {
                        ...
                        "onUpdate:modelValue": _cache[11] || (_cache[11] = $event => ((config.value.notification_success_text_template) = $event)),
                        label: "正文模板",
                        variant: "outlined",
                        rows: "4",
                        "auto-grow": "",
                    ...
                    _createElementVNode$1("div", _hoisted_10$1, [
                      _createElementVNode$1("h4", null, [
                        ...
                        _cache[47] || (_cache[47] = _createTextVNode$1(" 入库失败", -1))
                      ]),
                      _createVNode$1(_component_VTextField, {
                        modelValue: config.value.notification_failure_title_template,
                        "onUpdate:modelValue": _cache[12] || (_cache[12] = $event => ((config.value.notification_failure_title_template) = $event)),
                        label: "标题模板",
                        variant: "outlined",
                        density: "compact",
                        "hide-details": ""
                      ...
                      _createVNode$1(_component_VTextarea, {
                        ...
                        "onUpdate:modelValue": _cache[13] || (_cache[13] = $event => ((config.value.notification_failure_text_template) = $event)),
                        label: "正文模板",
                        variant: "outlined",
                        rows: "4",
                        "auto-grow": "",
    ...
    _createElementVNode$1("section", _hoisted_11$1, [
      _createElementVNode$1("div", _hoisted_12$1, [
        _cache[50] || (_cache[50] = _createElementVNode$1("div", null, [
        ...
        _createVNode$1(_component_VBtn, {
          ...
          loading: testing.value,
          onClick: _cache[14] || (_cache[14] = $event => (sendTest('failure')))
        }, {
    ...
    _createElementVNode$1("section", _hoisted_15$1, [
      _createElementVNode$1("div", _hoisted_16$1, [
        ...
        _createVNode$1(_component_VSwitch, {
          ...
          "onUpdate:modelValue": _cache[15] || (_cache[15] = $event => ((config.value.notification_episode_candidates_enabled) = $event)),
          color: "success",
          "hide-details": "",
          label: "启用集数候选通知"
        }, null, 8, ["modelValue"])
      ...
      _createElementVNode$1("div", _hoisted_17$1, [
        _createVNode$1(_component_VSelect, {
          ...
          "onUpdate:modelValue": _cache[16] || (_cache[16] = $event => ((config.value.notification_candidate_service) = $event)),
          items: notificationServiceItems.value,
          label: "集数偏移审批通知实例",
        ...
        _createElementVNode$1("div", _hoisted_18$1, [
          _createVNode$1(_component_VSwitch, {
            ...
            "onUpdate:modelValue": _cache[17] || (_cache[17] = $event => ((config.value.notification_candidate_batch_enabled) = $event)),
            color: "primary",
            "hide-details": "",
            label: "定时批量"
          }, null, 8, ["modelValue"]),
          _createVNode$1(_component_VSelect, {
            ...
            "onUpdate:modelValue": _cache[18] || (_cache[18] = $event => ((config.value.notification_candidate_batch_frequency) = $event)),
            items: [
          ...
          _createVNode$1(_component_VSelect, {
            ...
            "onUpdate:modelValue": _cache[19] || (_cache[19] = $event => ((config.value.notification_candidate_batch_hour) = $event)),
        ...
        _createElementVNode$1("div", _hoisted_19$1, [
          _createVNode$1(_component_VSwitch, {
            ...
            "onUpdate:modelValue": _cache[20] || (_cache[20] = $event => ((config.value.notification_candidate_realtime_enabled) = $event)),
            color: "success",
            "hide-details": "",
            label: "实时监控新增"
          }, null, 8, ["modelValue"]),
          _cache[52] || (_cache[52] = _createElementVNode$1("small", null, "首次开启以当前缓存为基线；之后新增或失败转成功时逐部推送。", -1))
        ])
      ]),
      _createElementVNode$1("div", _hoisted_20$1, [
        _cache[55] || (_cache[55] = _createElementVNode$1("span", null, [
        ...
        _createVNode$1(_component_VBtnToggle, {
          ...
          "onUpdate:modelValue": _cache[21] || (_cache[21] = $event => ((config.value.notification_candidate_message_style) = $event)),
          mandatory: "",
          density: "compact",
          color: "primary",
          variant: "outlined",
        ...
        (config.value.notification_candidate_message_style === 'rich')
          ? (_openBlock$1(), _createBlock$1(_component_VTextField, {
              ...
              "onUpdate:modelValue": _cache[22] || (_cache[22] = $event => ((config.value.notification_candidate_custom_emoji_id) = $event)),
              label: "会员表情 ID（可选）",
      ...
      (config.value.notification_candidate_message_style === 'rich')
        ? (_openBlock$1(), _createElementBlock$1("small", _hoisted_21$1, " 用于总览与详情标题装饰；填写 Telegram custom_emoji_id。Bot 无权限或留空时自动使用普通表情。 "))
        : _createCommentVNode$1("", true),
      _createVNode$1(_component_VAlert, {
        type: "info",
        variant: "tonal",
      ...
      _createElementVNode$1("div", _hoisted_22$1, [
        _createVNode$1(_component_VSelect, {
          ...
          "onUpdate:modelValue": [
            _cache[23] || (_cache[23] = $event => ((selectedQuarter).value = $event)),
        ...
        _createVNode$1(_component_VSelect, {
          ...
          "onUpdate:modelValue": [
            _cache[24] || (_cache[24] = $event => ((config.value.notification_candidate_region) = $event)),
            applyCandidateFilters
          ],
          items: [
        ...
        _createVNode$1(_component_VSelect, {
          ...
          "onUpdate:modelValue": [
            _cache[25] || (_cache[25] = $event => ((config.value.notification_candidate_preference) = $event)),
      ...
      _createElementVNode$1("div", _hoisted_23$1, [
        _createVNode$1(_component_VSwitch, {
          ...
          "onUpdate:modelValue": [
            _cache[26] || (_cache[26] = $event => ((config.value.notification_candidate_sequel_only) = $event)),
            applyCandidateFilters
          ],
          color: "primary",
          "hide-details": "",
        ...
        _createVNode$1(_component_VSelect, {
          ...
          "onUpdate:modelValue": [
            _cache[27] || (_cache[27] = $event => ((config.value.notification_candidate_platforms) = $event)),
            applyCandidateFilters
          ],
      ...
      (readyCandidates.value.length)
        ? (_openBlock$1(), _createElementBlock$1("div", _hoisted_24$1, [
            _createElementVNode$1("div", _hoisted_25$1, [
              ...
              _createElementVNode$1("span", null, [
                _cache[59] || (_cache[59] = _createElementVNode$1("strong", null, "匹配完成", -1)),
              ...
              _createElementVNode$1("div", _hoisted_26$1, [
                _createVNode$1(_component_VBtn, {
                  ...
                  onClick: _cache[28] || (_cache[28] = $event => (candidateAction('ignore')))
                }, {
                ...
                _createVNode$1(_component_VBtn, {
                  ...
                  loading: actionLoading.value,
                  disabled: !selectedReadyIds.value.length,
                  onClick: _cache[29] || (_cache[29] = $event => (candidateAction('add_default')))
                }, {
                ...
                _createVNode$1(_component_VBtn, {
                  ...
                  loading: actionLoading.value,
                  disabled: !selectedReadyIds.value.length,
                  onClick: _cache[30] || (_cache[30] = $event => (candidateAction('add_group')))
                }, {
              ...
              (_openBlock$1(true), _createElementBlock$1(_Fragment$1, null, _renderList$1(readyCandidates.value, (item) => {
                return (_openBlock$1(), _createElementBlock$1("label", {
                  ...
                  _createVNode$1(_component_VCheckboxBtn, {
                    ...
                    "onUpdate:modelValue": _cache[31] || (_cache[31] = $event => ((selectedReadyIds).value = $event)),
                    value: item.id
                  }, null, 8, ["modelValue", "value"]),
                  (item.poster)
      ...
      (failedCandidates.value.length)
        ? (_openBlock$1(), _createElementBlock$1("div", _hoisted_30$1, [
            _createElementVNode$1("div", _hoisted_31$1, [
              ...
              _createElementVNode$1("span", null, [
                _cache[63] || (_cache[63] = _createElementVNode$1("strong", null, "扫描失败", -1)),
              ...
              _createElementVNode$1("div", _hoisted_32$1, [
                _createVNode$1(_component_VBtn, {
                  ...
                  onClick: _cache[32] || (_cache[32] = $event => (candidateAction('ignore', 'failed')))
                }, {
                ...
                _createVNode$1(_component_VBtn, {
                  ...
                  loading: actionLoading.value,
                  disabled: !selectedFailedIds.value.length,
                  onClick: _cache[33] || (_cache[33] = $event => (candidateAction('retry', 'failed')))
                }, {
              ...
              (_openBlock$1(true), _createElementBlock$1(_Fragment$1, null, _renderList$1(failedCandidates.value, (item) => {
                return (_openBlock$1(), _createElementBlock$1("div", {
                  ...
                  _createVNode$1(_component_VCheckboxBtn, {
                    ...
                    "onUpdate:modelValue": _cache[34] || (_cache[34] = $event => ((selectedFailedIds).value = $event)),
                    value: item.id
                  }, null, 8, ["modelValue", "value"]),
                  (item.poster)
                    ? (_openBlock$1(), _createBlock$1(_component_VImg, {
      ...
      (!readyCandidates.value.length && !failedCandidates.value.length)
        ? (_openBlock$1(), _createElementBlock$1("div", _hoisted_36$1, [
    ...
    _createVNode$1(_component_VDialog, {
      ...
      "onUpdate:modelValue": _cache[39] || (_cache[39] = $event => ((manualCandidateDialog).value = $event)),
      "max-width": "560"
    }, {
      default: _withCtx$1(() => [
          ...
          default: _withCtx$1(() => [
            ...
            _createVNode$1(_component_VCardText, null, {
              default: _withCtx$1(() => [
                _createVNode$1(_component_VTextField, {
                  ...
                  "onUpdate:modelValue": _cache[35] || (_cache[35] = $event => ((manualCandidateTmdbId).value = $event)),
                  label: "TMDBID",
                  type: "number",
                  autofocus: "",
                  variant: "outlined",
            ...
            _createVNode$1(_component_VCardActions, { class: "manual-candidate-actions" }, {
              default: _withCtx$1(() => [
                _createVNode$1(_component_VBtn, {
                  variant: "text",
                  onClick: _cache[36] || (_cache[36] = $event => (manualCandidateDialog.value = false))
                }, {
                ...
                _createVNode$1(_component_VBtn, {
                  ...
                  onClick: _cache[37] || (_cache[37] = $event => (addFailedCandidate('add_default')))
                }, {
                ...
                _createVNode$1(_component_VBtn, {
                  ...
                  disabled: !Number(manualCandidateTmdbId.value || 0),
                  loading: manualCandidateBusy.value === manualCandidateItem.value?.id,
                  onClick: _cache[38] || (_cache[38] = $event => (addFailedCandidate('add_group')))
                }, {
    ...
    _createElementVNode$1("section", _hoisted_37$1, [
      _createElementVNode$1("button", {
        ...
        onClick: _cache[40] || (_cache[40] = $event => (showRecords.value = !showRecords.value))
      }, [
        _createElementVNode$1("span", null, [
          _cache[71] || (_cache[71] = _createElementVNode$1("strong", null, "通知运行记录", -1)),
      ...
      _createVNode$1(_component_VExpandTransition, null, {
        default: _withCtx$1(() => [
          (showRecords.value)
            ? (_openBlock$1(), _createElementBlock$1("div", _hoisted_38$1, [
                _createElementVNode$1("div", _hoisted_39$1, [
                  _createVNode$1(_component_VBtnToggle, {
                    modelValue: recordFilter.value,
                    "onUpdate:modelValue": _cache[41] || (_cache[41] = $event => ((recordFilter).value = $event)),
                    mandatory: "",
                    density: "compact",
                    color: "primary",
                    variant: "outlined"
                ...
                (records.value.length)
                        ...
                        return (_openBlock$1(), _createElementBlock$1("article", {
                          ...
                          _createElementVNode$1("div", null, [
                            ...
                            (item.action === 'delivery_failed')
                              ? (_openBlock$1(), _createElementBlock$1("small", _hoisted_41$1, _toDisplayString$1(item.details?.delivery_error || '目标通知实例未返回成功结果'), 1))
                              : _createCommentVNode$1("", true)
                          ]),
                          _createVNode$1(_component_VChip, {
                            size: "x-small",
                  ...
                  : (_openBlock$1(), _createElementBlock$1("div", _hoisted_42$1, [
                      _createVNode$1(_component_VIcon, { icon: "mdi-history" }),
                      _cache[77] || (_cache[77] = _createElementVNode$1("span", null, "尚无符合条件的记录", -1))
                    ]))
              ]))
            : _createCommentVNode$1("", true)
        ]),
...
const NotificationEnhancer = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-7b3a4bf6"]]);
